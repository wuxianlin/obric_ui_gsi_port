...
# direct methods
.method public static synthetic $r8$lambda$Y0o2HBV9B2B3w4dg71qG1th9Qc8(Lcom/android/server/NetworkScoreService;I)[Ljava/lang/String;
    .locals 0
...
.method static bridge synthetic -$$Nest$fgetmContext(Lcom/android/server/NetworkScoreService;)Landroid/content/Context;
    .locals 0
...
.method static bridge synthetic -$$Nest$fgetmNetworkScorerAppManager(Lcom/android/server/NetworkScoreService;)Lcom/android/server/NetworkScorerAppManager;
    .locals 0
...
.method static bridge synthetic -$$Nest$mbindToScoringServiceIfNeeded(Lcom/android/server/NetworkScoreService;Landroid/net/NetworkScorerAppData;)V
    .locals 0
...
.method static bridge synthetic -$$Nest$mrefreshBinding(Lcom/android/server/NetworkScoreService;)V
    .locals 0
...
.method static bridge synthetic -$$Nest$munbindFromScoringServiceIfNeeded(Lcom/android/server/NetworkScoreService;)V
    .locals 0
...
.method private registerPackageMonitorIfNeeded()V
    ...
    invoke-direct {v2, p0, v4, v3}, Lcom/android/server/NetworkScoreService$NetworkScorerPackageMonitor;-><init>(Lcom/android/server/NetworkScoreService;Ljava/lang/String;Lcom/android/server/NetworkScoreService$NetworkScorerPackageMonitor-IA;)V
    ...
    invoke-virtual {v2, v4, v3, v5, v6}, Lcom/android/internal/content/PackageMonitor;->register(Landroid/content/Context;Landroid/os/Looper;Landroid/os/UserHandle;Z)V
...
.method public requestScores([Landroid/net/NetworkKey;)Z
    ...
    .line 874
    .restart local v2    # "provider":Landroid/net/INetworkRecommendationProvider;
    :catch_0
    move-exception v3
...
.method public updateScores([Landroid/net/ScoredNetwork;)Z
    ...
    .line 456
    .restart local v2    # "networksByType":Ljava/util/Map;, "Ljava/util/Map<Ljava/lang/Integer;Ljava/util/List<Landroid/net/ScoredNetwork;>;>;"
    .restart local v6    # "network":Landroid/net/ScoredNetwork;
    .restart local v7    # "networkList":Ljava/util/List;, "Ljava/util/List<Landroid/net/ScoredNetwork;>;"
    :cond_0
    :goto_1
    ...
    .line 466
    .restart local v8    # "callbackList":Landroid/os/RemoteCallbackList;, "Landroid/os/RemoteCallbackList<Landroid/net/INetworkScoreCache;>;"
    :cond_4
    :goto_3
    nop
