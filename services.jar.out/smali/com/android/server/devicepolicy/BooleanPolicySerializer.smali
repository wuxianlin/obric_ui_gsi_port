.class final Lcom/android/server/devicepolicy/BooleanPolicySerializer;
...
.field private static final TAG:Ljava/lang/String; = "BooleanPolicySerializer"
...
# virtual methods
.method readFromXml(Lcom/android/modules/utils/TypedXmlPullParser;)Landroid/app/admin/BooleanPolicyValue;
    .locals 4
    ...
    .line 49
    invoke-interface {p1, v0, v2}, Lcom/android/modules/utils/TypedXmlPullParser;->getAttributeBoolean(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    const-string v2, "BooleanPolicySerializer"

    const-string v3, "Error parsing Boolean policy value"
...
.method saveToXml(Lcom/android/modules/utils/TypedXmlSerializer;Ljava/lang/Boolean;)V
    .locals 3
