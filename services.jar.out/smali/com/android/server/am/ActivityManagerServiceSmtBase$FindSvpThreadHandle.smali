...
.method private clearSvpThreads()V
    ...
    .line 3023
    const-string/jumbo v0, "find svp thread: clearSvpThreads, No threads found."
    ...
    const-string/jumbo v4, "find svp thread: clearSvpThread: "
...
.method private loopProcessThreads(I)V
    ...
    const-string/jumbo v3, "find svp thread: Failed to list tasks for pid: "
    ...
    const-string/jumbo v6, "find svp thread: Sched file does not exist for tid: "
    ...
    const-string/jumbo v12, "find svp thread: Sched info for UnityMain task (pid: "
    ...
    const-string/jumbo v12, "find svp thread: Sched info for UnityGfxDeviceW task (pid: "
    ...
    const-string/jumbo v12, "find svp thread: Failed to read task comm file for tid: "
    ...
    const-string/jumbo v6, "find svp thread: Invalid task id: "
    ...
    const-string/jumbo v6, "find svp thread: setUIFirstSched: "
    ...
    const-string/jumbo v3, "find svp thread: Task directory does not exist for pid: "
...
.method private parseSumExecRuntime(Ljava/io/File;)D
    ...
    const-string/jumbo v7, "find svp thread: Failed to parse sum_exec_runtime value: "
    ...
    const-string/jumbo v3, "find svp thread: Failed to read sched file: "
...
.method public clearAppSvpThreads(Lcom/android/server/am/ProcessRecord;)V
    ...
    const-string/jumbo v1, "find svp thread: clearAppSvpThreads "
...
.method public findingSvpThreadAppDied(Lcom/android/server/am/ProcessRecord;)V
    ...
    const-string/jumbo v1, "find svp thread: find svp thread process died "
...
.method public scheduleFindSvpThread(Lcom/android/server/am/ProcessRecord;)V
    ...
    const-string/jumbo v1, "find svp thread: schedule loop under process "
