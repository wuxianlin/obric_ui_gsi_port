...
.method public writePkg(Landroid/os/health/HealthStatsWriter;Landroid/os/BatteryStats$Uid$Pkg;)V
    ...
    invoke-virtual {p1, v4, v3, v2}, Landroid/os/health/HealthStatsWriter;->addStats(ILjava/lang/String;Landroid/os/health/HealthStatsWriter;)V
    ...
    invoke-virtual {p1, v6, v3, v4, v5}, Landroid/os/health/HealthStatsWriter;->addMeasurements(ILjava/lang/String;J)V
...
.method public writeUid(Landroid/os/health/HealthStatsWriter;Landroid/os/BatteryStats;Landroid/os/BatteryStats$Uid;)V
    ...
    invoke-direct {v0, v1, v13, v11, v12}, Lcom/android/server/am/HealthStatsBatteryStatsWriter;->addTimers(Landroid/os/health/HealthStatsWriter;ILjava/lang/String;Landroid/os/BatteryStats$Timer;)V
    ...
    invoke-direct {v0, v1, v14, v13}, Lcom/android/server/am/HealthStatsBatteryStatsWriter;->addTimer(Landroid/os/health/HealthStatsWriter;ILandroid/os/BatteryStats$Timer;)V
    ...
    invoke-direct {v0, v1, v15, v13, v14}, Lcom/android/server/am/HealthStatsBatteryStatsWriter;->addTimers(Landroid/os/health/HealthStatsWriter;ILjava/lang/String;Landroid/os/BatteryStats$Timer;)V
    ...
    invoke-virtual {v1, v15, v14, v13}, Landroid/os/health/HealthStatsWriter;->addStats(ILjava/lang/String;Landroid/os/health/HealthStatsWriter;)V
    ...
    invoke-virtual {v1, v9, v15, v14}, Landroid/os/health/HealthStatsWriter;->addStats(ILjava/lang/String;Landroid/os/health/HealthStatsWriter;)V
    ...
    invoke-virtual {v1, v14, v12, v13}, Landroid/os/health/HealthStatsWriter;->addMeasurement(IJ)V
    ...
    .line 228
    invoke-virtual {v3, v9, v10, v8}, Landroid/os/BatteryStats$Uid;->getWifiScanTime(JI)J
    ...
    invoke-virtual {v1, v14, v7, v9, v10}, Landroid/os/health/HealthStatsWriter;->addTimer(IIJ)V
    ...
    invoke-direct {v0, v1, v9, v7}, Lcom/android/server/am/HealthStatsBatteryStatsWriter;->addTimer(Landroid/os/health/HealthStatsWriter;ILandroid/os/BatteryStats$Timer;)V
    ...
    invoke-virtual {v3, v7}, Landroid/os/BatteryStats$Uid;->getProcessStateTimer(I)Landroid/os/BatteryStats$Timer;
    ...
    invoke-direct {v0, v1, v10, v9}, Lcom/android/server/am/HealthStatsBatteryStatsWriter;->addTimer(Landroid/os/health/HealthStatsWriter;ILandroid/os/BatteryStats$Timer;)V
    ...
    invoke-direct {v0, v1, v9, v10}, Lcom/android/server/am/HealthStatsBatteryStatsWriter;->addTimer(Landroid/os/health/HealthStatsWriter;ILandroid/os/BatteryStats$Timer;)V
    ...
    invoke-direct {v0, v1, v12, v10}, Lcom/android/server/am/HealthStatsBatteryStatsWriter;->addTimer(Landroid/os/health/HealthStatsWriter;ILandroid/os/BatteryStats$Timer;)V
    ...
    invoke-virtual {v1, v10, v12, v13}, Landroid/os/health/HealthStatsWriter;->addMeasurement(IJ)V
    ...
    invoke-virtual {v3, v10, v8}, Landroid/os/BatteryStats$Uid;->getUserActivityCount(II)I
    ...
    invoke-virtual {v1, v9, v12, v13}, Landroid/os/health/HealthStatsWriter;->addMeasurement(IJ)V
    ...
    invoke-virtual {v1, v12, v7, v9, v10}, Landroid/os/health/HealthStatsWriter;->addTimer(IIJ)V
    ...
    invoke-virtual {v1, v9, v7, v8}, Landroid/os/health/HealthStatsWriter;->addMeasurement(IJ)V
