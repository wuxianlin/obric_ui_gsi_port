...
# static fields
.field private static final TAG:Ljava/lang/String; = "FaceServiceRegistry"
...
.method public constructor <init>(Landroid/hardware/face/IFaceService;Ljava/util/function/Supplier;)V
    .locals 0
    .param p1, "service"    # Landroid/hardware/face/IFaceService;
        .annotation build Landroid/annotation/NonNull;
        .end annotation
    .end param
...
# virtual methods
.method protected invokeRegisteredCallback(Landroid/hardware/face/IFaceAuthenticatorsRegisteredCallback;Ljava/util/List;)V
    .locals 0
    ...
    .line 69
    .local p2, "allProps":Ljava/util/List;, "Ljava/util/List<Landroid/hardware/face/FaceSensorPropertiesInternal;>;"
...
.method protected registerService(Landroid/hardware/biometrics/IBiometricService;Landroid/hardware/face/FaceSensorPropertiesInternal;)V
    .locals 5
    .param p1, "service"    # Landroid/hardware/biometrics/IBiometricService;
        .annotation build Landroid/annotation/NonNull;
        .end annotation
    .end param
    .param p2, "props"    # Landroid/hardware/face/FaceSensorPropertiesInternal;
        .annotation build Landroid/annotation/NonNull;
        .end annotation
    .end param
    ...
    iget-object v3, p0, Lcom/android/server/biometrics/sensors/face/FaceServiceRegistry;->mService:Landroid/hardware/face/IFaceService;

    iget v4, p2, Landroid/hardware/face/FaceSensorPropertiesInternal;->sensorId:I

    invoke-direct {v2, v3, v4}, Lcom/android/server/biometrics/sensors/face/FaceAuthenticator;-><init>(Landroid/hardware/face/IFaceService;I)V
    ...
    const-string v3, "FaceServiceRegistry"
