...
# direct methods
.method static bridge synthetic -$$Nest$fgetmAccountManagerInternal(Lcom/android/server/accounts/AccountManagerBackupHelper;)Landroid/accounts/AccountManagerInternal;
    .locals 0
...
.method static bridge synthetic -$$Nest$fgetmAccountManagerService(Lcom/android/server/accounts/AccountManagerBackupHelper;)Lcom/android/server/accounts/AccountManagerService;
    .locals 0
...
.method static bridge synthetic -$$Nest$fgetmLock(Lcom/android/server/accounts/AccountManagerBackupHelper;)Ljava/lang/Object;
    .locals 0
...
.method static bridge synthetic -$$Nest$fgetmRestoreCancelCommand(Lcom/android/server/accounts/AccountManagerBackupHelper;)Ljava/lang/Runnable;
    .locals 0
...
.method static bridge synthetic -$$Nest$fgetmRestorePackageMonitor(Lcom/android/server/accounts/AccountManagerBackupHelper;)Lcom/android/server/accounts/AccountManagerBackupHelper$RestorePackageMonitor;
    .locals 0
...
.method static bridge synthetic -$$Nest$fgetmRestorePendingAppPermissions(Lcom/android/server/accounts/AccountManagerBackupHelper;)Ljava/util/List;
    .locals 0
...
.method static bridge synthetic -$$Nest$fputmRestoreCancelCommand(Lcom/android/server/accounts/AccountManagerBackupHelper;Ljava/lang/Runnable;)V
    .locals 0
...
.method static bridge synthetic -$$Nest$fputmRestorePackageMonitor(Lcom/android/server/accounts/AccountManagerBackupHelper;Lcom/android/server/accounts/AccountManagerBackupHelper$RestorePackageMonitor;)V
    .locals 0
...
.method static bridge synthetic -$$Nest$fputmRestorePendingAppPermissions(Lcom/android/server/accounts/AccountManagerBackupHelper;Ljava/util/List;)V
    .locals 0
...
.method public backupAccountAccessPermissions(I)[B
    ...
    .line 163
    .local v9, "serializer":Lcom/android/modules/utils/TypedXmlSerializer;
    ...
    invoke-interface {v9, v8, v0}, Lcom/android/modules/utils/TypedXmlSerializer;->setOutput(Ljava/io/OutputStream;Ljava/lang/String;)V
    ...
    invoke-interface {v9, v7, v0}, Lcom/android/modules/utils/TypedXmlSerializer;->startDocument(Ljava/lang/String;Ljava/lang/Boolean;)V

    .line 165
    const-string/jumbo v0, "permissions"

    invoke-interface {v9, v7, v0}, Lcom/android/modules/utils/TypedXmlSerializer;->startTag(Ljava/lang/String;Ljava/lang/String;)Lorg/xmlpull/v1/XmlSerializer;
    ...
    :try_start_7
    invoke-interface {v9, v6, v0}, Lcom/android/modules/utils/TypedXmlSerializer;->startTag(Ljava/lang/String;Ljava/lang/String;)Lorg/xmlpull/v1/XmlSerializer;
    ...
    invoke-interface {v9, v7, v0, v6}, Lcom/android/modules/utils/TypedXmlSerializer;->attribute(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Lorg/xmlpull/v1/XmlSerializer;

    .line 194
    const-string/jumbo v0, "package"

    invoke-interface {v9, v7, v0, v3}, Lcom/android/modules/utils/TypedXmlSerializer;->attribute(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Lorg/xmlpull/v1/XmlSerializer;

    .line 195
    const-string v0, "digest"

    invoke-interface {v9, v7, v0, v2}, Lcom/android/modules/utils/TypedXmlSerializer;->attribute(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Lorg/xmlpull/v1/XmlSerializer;

    .line 196
    const-string/jumbo v0, "permission"

    invoke-interface {v9, v7, v0}, Lcom/android/modules/utils/TypedXmlSerializer;->endTag(Ljava/lang/String;Ljava/lang/String;)Lorg/xmlpull/v1/XmlSerializer;
    ...
    .end local v9    # "serializer":Lcom/android/modules/utils/TypedXmlSerializer;
    ...
    .restart local v9    # "serializer":Lcom/android/modules/utils/TypedXmlSerializer;
    ...
    invoke-interface {v9, v1, v0}, Lcom/android/modules/utils/TypedXmlSerializer;->endTag(Ljava/lang/String;Ljava/lang/String;)Lorg/xmlpull/v1/XmlSerializer;

    .line 201
    invoke-interface {v9}, Lcom/android/modules/utils/TypedXmlSerializer;->endDocument()V

    .line 202
    invoke-interface {v9}, Lcom/android/modules/utils/TypedXmlSerializer;->flush()V
...
.method public restoreAccountAccessPermissions([BI)V
    ...
    invoke-interface {v10, v9, v0}, Lcom/android/modules/utils/TypedXmlPullParser;->setInput(Ljava/io/InputStream;Ljava/lang/String;)V
    ...
    invoke-interface {v10, v13, v0}, Lcom/android/modules/utils/TypedXmlPullParser;->getAttributeValue(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 233
    .restart local v3    # "accountDigest":Ljava/lang/String;
    .restart local v9    # "dataStream":Ljava/io/ByteArrayInputStream;
    ...
    .restart local v12    # "permissionsOuterDepth":I
    .restart local v14    # "permissionOuterDepth":I
    :cond_2
    :goto_2
    const-string/jumbo v0, "package"
    ...
    invoke-direct {v0, v7, v13}, Lcom/android/server/accounts/AccountManagerBackupHelper$RestorePackageMonitor;-><init>(Lcom/android/server/accounts/AccountManagerBackupHelper;Lcom/android/server/accounts/AccountManagerBackupHelper$RestorePackageMonitor-IA;)V
    ...
    invoke-virtual {v0, v6, v15, v13}, Lcom/android/internal/content/PackageMonitor;->register(Landroid/content/Context;Landroid/os/Looper;Z)V
    ...
    invoke-direct {v0, v7, v1}, Lcom/android/server/accounts/AccountManagerBackupHelper$CancelRestoreCommand;-><init>(Lcom/android/server/accounts/AccountManagerBackupHelper;Lcom/android/server/accounts/AccountManagerBackupHelper$CancelRestoreCommand-IA;)V
