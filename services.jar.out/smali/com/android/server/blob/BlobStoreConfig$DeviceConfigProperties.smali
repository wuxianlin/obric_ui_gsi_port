...
# direct methods
.method public static synthetic $r8$lambda$unYz3hyV5nejxKvtymKhcBV8QJ4(Landroid/provider/DeviceConfig$Properties;Ljava/lang/String;)V
    .locals 0
...
.method static constructor <clinit>()V
    ...
    .line 111
    sget-wide v3, Lcom/android/server/blob/BlobStoreConfig$DeviceConfigProperties;->DEFAULT_LEASE_ACQUISITION_WAIT_DURATION_MS:J
    ...
    .line 123
    sget-wide v3, Lcom/android/server/blob/BlobStoreConfig$DeviceConfigProperties;->DEFAULT_COMMIT_COOL_OFF_DURATION_MS:J
    ...
    sput v1, Lcom/android/server/blob/BlobStoreConfig$DeviceConfigProperties;->MAX_BLOB_ACCESS_PERMITTED_PACKAGES:I
...
.method static dump(Landroid/util/IndentingPrintWriter;Landroid/content/Context;)V
    ...
    sget-wide v1, Lcom/android/server/blob/BlobStoreConfig$DeviceConfigProperties;->IDLE_JOB_PERIOD_MS:J
    ...
    sget-wide v2, Lcom/android/server/blob/BlobStoreConfig$DeviceConfigProperties;->DEFAULT_IDLE_JOB_PERIOD_MS:J
    ...
    const-string/jumbo v3, "idle_job_period_ms"
    ...
    .line 247
    sget-wide v3, Lcom/android/server/blob/BlobStoreConfig$DeviceConfigProperties;->SESSION_EXPIRY_TIMEOUT_MS:J
    ...
    sget-wide v3, Lcom/android/server/blob/BlobStoreConfig$DeviceConfigProperties;->DEFAULT_SESSION_EXPIRY_TIMEOUT_MS:J
    ...
    const-string/jumbo v4, "session_expiry_timeout_ms"
    ...
    invoke-static {p1, v3, v4, v1}, Landroid/text/format/Formatter;->formatFileSize(Landroid/content/Context;JI)Ljava/lang/String;

    move-result-object v3

    sget-wide v4, Lcom/android/server/blob/BlobStoreConfig$DeviceConfigProperties;->DEFAULT_TOTAL_BYTES_PER_APP_LIMIT_FLOOR:J

    .line 252
    invoke-static {p1, v4, v5, v1}, Landroid/text/format/Formatter;->formatFileSize(Landroid/content/Context;JI)Ljava/lang/String;

    move-result-object v1

    const-string/jumbo v4, "total_bytes_per_app_limit_floor"
    ...
    const-string/jumbo v4, "total_bytes_per_app_limit_fraction"
    ...
    .line 257
    sget-wide v3, Lcom/android/server/blob/BlobStoreConfig$DeviceConfigProperties;->LEASE_ACQUISITION_WAIT_DURATION_MS:J
    ...
    const-string/jumbo v4, "lease_acquisition_wait_time_ms"
    ...
    .line 260
    sget-wide v3, Lcom/android/server/blob/BlobStoreConfig$DeviceConfigProperties;->COMMIT_COOL_OFF_DURATION_MS:J
    ...
    const-string v4, "commit_cool_off_duration_ms"
    ...
    const-string/jumbo v4, "use_revocable_fd_for_reads"
    ...
    sget-wide v3, Lcom/android/server/blob/BlobStoreConfig$DeviceConfigProperties;->DEFAULT_DELETE_ON_LAST_LEASE_DELAY_MS:J
    ...
    const-string v4, "delete_on_last_lease_delay_ms"
    ...
    sget v3, Lcom/android/server/blob/BlobStoreConfig$DeviceConfigProperties;->DEFAULT_MAX_ACTIVE_SESSIONS:I

    invoke-static {v3}, Ljava/lang/Integer;->valueOf(I)Ljava/lang/Integer;

    move-result-object v3

    const-string/jumbo v4, "max_active_sessions"
    ...
    sget v3, Lcom/android/server/blob/BlobStoreConfig$DeviceConfigProperties;->DEFAULT_MAX_COMMITTED_BLOBS:I

    invoke-static {v3}, Ljava/lang/Integer;->valueOf(I)Ljava/lang/Integer;

    move-result-object v3

    const-string/jumbo v4, "max_committed_blobs"
    ...
    sget v3, Lcom/android/server/blob/BlobStoreConfig$DeviceConfigProperties;->DEFAULT_MAX_LEASED_BLOBS:I

    invoke-static {v3}, Ljava/lang/Integer;->valueOf(I)Ljava/lang/Integer;

    move-result-object v3

    const-string/jumbo v4, "max_leased_blobs"
    ...
    sget v3, Lcom/android/server/blob/BlobStoreConfig$DeviceConfigProperties;->DEFAULT_MAX_BLOB_ACCESS_PERMITTED_PACKAGES:I
    ...
    const-string/jumbo v4, "max_permitted_pks"
    ...
    .line 277
    sget v1, Lcom/android/server/blob/BlobStoreConfig$DeviceConfigProperties;->LEASE_DESC_CHAR_LIMIT:I
    ...
    sget v3, Lcom/android/server/blob/BlobStoreConfig$DeviceConfigProperties;->DEFAULT_LEASE_DESC_CHAR_LIMIT:I

    invoke-static {v3}, Ljava/lang/Integer;->valueOf(I)Ljava/lang/Integer;

    move-result-object v3

    const-string/jumbo v4, "lease_desc_char_limit"
