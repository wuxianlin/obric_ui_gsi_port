...
.method static constructor <clinit>()V
    ...
    .line 36
    const-class v0, Lcom/android/server/ambientcontext/DefaultAmbientContextManagerPerUserService;

    invoke-virtual {v0}, Ljava/lang/Class;->getSimpleName()Ljava/lang/String;

    move-result-object v0

    sput-object v0, Lcom/android/server/ambientcontext/DefaultAmbientContextManagerPerUserService;->TAG:Ljava/lang/String;
...
.method constructor <init>(Lcom/android/server/ambientcontext/AmbientContextManagerService;Ljava/lang/Object;ILcom/android/server/ambientcontext/AmbientContextManagerPerUserService$ServiceType;Ljava/lang/String;)V
    ...
    .line 52
    iget-object v0, p0, Lcom/android/server/ambientcontext/DefaultAmbientContextManagerPerUserService;->mServiceName:Ljava/lang/String;

    invoke-static {v0}, Landroid/content/ComponentName;->unflattenFromString(Ljava/lang/String;)Landroid/content/ComponentName;

    move-result-object v0

    iput-object v0, p0, Lcom/android/server/ambientcontext/DefaultAmbientContextManagerPerUserService;->mComponentName:Landroid/content/ComponentName;

    .line 53
    sget-object v0, Lcom/android/server/ambientcontext/DefaultAmbientContextManagerPerUserService;->TAG:Ljava/lang/String;

    new-instance v1, Ljava/lang/StringBuilder;

    invoke-direct {v1}, Ljava/lang/StringBuilder;-><init>()V

    const-string v2, "Created DefaultAmbientContextManagerPerUserServiceand service type: "

    invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget-object v2, p0, Lcom/android/server/ambientcontext/DefaultAmbientContextManagerPerUserService;->mServiceType:Lcom/android/server/ambientcontext/AmbientContextManagerPerUserService$ServiceType;
...
.method getComponentName()Landroid/content/ComponentName;
    ...
    .line 70
    iget-object v0, p0, Lcom/android/server/ambientcontext/DefaultAmbientContextManagerPerUserService;->mComponentName:Landroid/content/ComponentName;
...
.method public getServiceType()Lcom/android/server/ambientcontext/AmbientContextManagerPerUserService$ServiceType;
    ...
    .line 90
    iget-object v0, p0, Lcom/android/server/ambientcontext/DefaultAmbientContextManagerPerUserService;->mServiceType:Lcom/android/server/ambientcontext/AmbientContextManagerPerUserService$ServiceType;
