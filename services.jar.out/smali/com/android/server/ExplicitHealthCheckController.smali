...
# direct methods
.method public static synthetic $r8$lambda$4I8YBZ-LzYvFs0qdhFHXqaSXFyc(Lcom/android/server/ExplicitHealthCheckController;Ljava/lang/String;)V
    .locals 0
...
.method public static synthetic $r8$lambda$IIsfdI4E19kYetXH_5L-g69gD5U(Lcom/android/server/ExplicitHealthCheckController;Ljava/util/Set;Ljava/util/List;)V
    .locals 0
...
.method public static synthetic $r8$lambda$aL6X4oZMCjln5Vk0sguqqu-vOzk(Ljava/util/function/Consumer;Landroid/os/Bundle;)V
    .locals 0
...
.method public static synthetic $r8$lambda$eCl1yWrhAdR5PTMsrBjSC92O-Ao(Lcom/android/server/ExplicitHealthCheckController;Landroid/os/Bundle;)V
    .locals 0
...
.method public static synthetic $r8$lambda$eUe0MojcRAKKWZDwi3yGDDE4Q6Y(Lcom/android/server/ExplicitHealthCheckController;Ljava/util/List;Ljava/util/Set;Ljava/util/List;)V
    .locals 0
...
.method public static synthetic $r8$lambda$lHImziYyqT2PGGO1F6pWnIlKZEs(Lcom/android/server/ExplicitHealthCheckController;Ljava/lang/String;)V
    .locals 0
...
.method public static synthetic $r8$lambda$mGwCwsEZmtVNkWk1gYFRO7gIRQk(Ljava/util/function/Consumer;Landroid/os/Bundle;)V
    .locals 0
...
.method static bridge synthetic -$$Nest$fgetmLock(Lcom/android/server/ExplicitHealthCheckController;)Ljava/lang/Object;
    .locals 0
...
.method static bridge synthetic -$$Nest$fputmRemoteService(Lcom/android/server/ExplicitHealthCheckController;Landroid/service/watchdog/IExplicitHealthCheckService;)V
    .locals 0
...
.method static bridge synthetic -$$Nest$mbindService(Lcom/android/server/ExplicitHealthCheckController;)V
    .locals 0
...
.method static bridge synthetic -$$Nest$minitState(Lcom/android/server/ExplicitHealthCheckController;Landroid/os/IBinder;)V
    .locals 0
...
.method static bridge synthetic -$$Nest$munbindService(Lcom/android/server/ExplicitHealthCheckController;)V
    .locals 0
...
.method private getRequestedPackages(Ljava/util/function/Consumer;)V
    ...
    .line 268
    :try_start_0
    const-string/jumbo v1, "get health check requested packages"
    ...
    new-instance v3, Lcom/android/server/ExplicitHealthCheckController$$ExternalSyntheticLambda3;

    invoke-direct {v3, p1}, Lcom/android/server/ExplicitHealthCheckController$$ExternalSyntheticLambda3;-><init>(Ljava/util/function/Consumer;)V
...
.method private getSupportedPackages(Ljava/util/function/Consumer;)V
    ...
    .line 241
    :try_start_0
    const-string/jumbo v1, "get health check supported packages"
    ...
    new-instance v3, Lcom/android/server/ExplicitHealthCheckController$$ExternalSyntheticLambda5;

    invoke-direct {v3, p1}, Lcom/android/server/ExplicitHealthCheckController$$ExternalSyntheticLambda5;-><init>(Ljava/util/function/Consumer;)V
...
.method private initState(Landroid/os/IBinder;)V
    ...
    new-instance v3, Lcom/android/server/ExplicitHealthCheckController$$ExternalSyntheticLambda6;

    invoke-direct {v3, p0}, Lcom/android/server/ExplicitHealthCheckController$$ExternalSyntheticLambda6;-><init>(Lcom/android/server/ExplicitHealthCheckController;)V
...
.method private static synthetic lambda$getRequestedPackages$5(Ljava/util/function/Consumer;Landroid/os/Bundle;)V
    .locals 3
...
.method private static synthetic lambda$getSupportedPackages$4(Ljava/util/function/Consumer;Landroid/os/Bundle;)V
    .locals 3
    .param p0, "consumer"    # Ljava/util/function/Consumer;
    .param p1, "result"    # Landroid/os/Bundle;

    .line 248
    const-class v0, Landroid/service/watchdog/ExplicitHealthCheckService$PackageConfig;

    .line 249
    const-string v1, "android.service.watchdog.extra.supported_packages"
...
.method private synthetic lambda$syncRequests$2(Ljava/util/List;Ljava/util/Set;Ljava/util/List;)V
    ...
    .line 163
    .restart local v1    # "supportedPackages":Ljava/util/Set;, "Ljava/util/Set<Ljava/lang/String;>;"
    :cond_0
    ...
    invoke-direct {v2, p0}, Lcom/android/server/ExplicitHealthCheckController$$ExternalSyntheticLambda1;-><init>(Lcom/android/server/ExplicitHealthCheckController;)V
    ...
    invoke-direct {v2, p0}, Lcom/android/server/ExplicitHealthCheckController$$ExternalSyntheticLambda2;-><init>(Lcom/android/server/ExplicitHealthCheckController;)V
