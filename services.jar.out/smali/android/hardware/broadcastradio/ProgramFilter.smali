.class public Landroid/hardware/broadcastradio/ProgramFilter;
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0}, Landroid/hardware/broadcastradio/ProgramFilter$1;-><init>()V
...
.method private describeContents(Ljava/lang/Object;)I
    ...
    invoke-direct {p0, v4}, Landroid/hardware/broadcastradio/ProgramFilter;->describeContents(Ljava/lang/Object;)I
...
.method public describeContents()I
    ...
    invoke-direct {p0, v1}, Landroid/hardware/broadcastradio/ProgramFilter;->describeContents(Ljava/lang/Object;)I
...
.method public equals(Ljava/lang/Object;)Z
    ...
    check-cast v2, Landroid/hardware/broadcastradio/ProgramFilter;

    .line 75
    .local v2, "that":Landroid/hardware/broadcastradio/ProgramFilter;
    iget-object v3, p0, Landroid/hardware/broadcastradio/ProgramFilter;->identifierTypes:[I

    iget-object v4, v2, Landroid/hardware/broadcastradio/ProgramFilter;->identifierTypes:[I
    ...
    .line 76
    :cond_3
    iget-object v3, p0, Landroid/hardware/broadcastradio/ProgramFilter;->identifiers:[Landroid/hardware/broadcastradio/ProgramIdentifier;

    iget-object v4, v2, Landroid/hardware/broadcastradio/ProgramFilter;->identifiers:[Landroid/hardware/broadcastradio/ProgramIdentifier;
    ...
    .line 77
    :cond_4
    iget-boolean v3, p0, Landroid/hardware/broadcastradio/ProgramFilter;->includeCategories:Z

    invoke-static {v3}, Ljava/lang/Boolean;->valueOf(Z)Ljava/lang/Boolean;

    move-result-object v3

    iget-boolean v4, v2, Landroid/hardware/broadcastradio/ProgramFilter;->includeCategories:Z
    ...
    .line 78
    :cond_5
    iget-boolean v3, p0, Landroid/hardware/broadcastradio/ProgramFilter;->excludeModifications:Z

    invoke-static {v3}, Ljava/lang/Boolean;->valueOf(Z)Ljava/lang/Boolean;

    move-result-object v3

    iget-boolean v4, v2, Landroid/hardware/broadcastradio/ProgramFilter;->excludeModifications:Z
...
.method public hashCode()I
    ...
    iget-boolean v1, p0, Landroid/hardware/broadcastradio/ProgramFilter;->excludeModifications:Z
...
.method public final readFromParcel(Landroid/os/Parcel;)V
    ...
    .end local p0    # "this":Landroid/hardware/broadcastradio/ProgramFilter;
    ...
    .restart local p0    # "this":Landroid/hardware/broadcastradio/ProgramFilter;
...
.method public toString()Ljava/lang/String;
    ...
    const-string/jumbo v2, "includeCategories: "
    ...
    const-string v2, "excludeModifications: "

    invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget-boolean v2, p0, Landroid/hardware/broadcastradio/ProgramFilter;->excludeModifications:Z
