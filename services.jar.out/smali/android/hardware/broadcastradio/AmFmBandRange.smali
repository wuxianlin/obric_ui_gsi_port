.class public Landroid/hardware/broadcastradio/AmFmBandRange;
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0}, Landroid/hardware/broadcastradio/AmFmBandRange$1;-><init>()V
...
.method public equals(Ljava/lang/Object;)Z
    ...
    .line 75
    .local v2, "that":Landroid/hardware/broadcastradio/AmFmBandRange;
    iget v3, p0, Landroid/hardware/broadcastradio/AmFmBandRange;->lowerBound:I

    invoke-static {v3}, Ljava/lang/Integer;->valueOf(I)Ljava/lang/Integer;

    move-result-object v3

    iget v4, v2, Landroid/hardware/broadcastradio/AmFmBandRange;->lowerBound:I
    ...
    .line 76
    :cond_3
    iget v3, p0, Landroid/hardware/broadcastradio/AmFmBandRange;->upperBound:I

    invoke-static {v3}, Ljava/lang/Integer;->valueOf(I)Ljava/lang/Integer;

    move-result-object v3

    iget v4, v2, Landroid/hardware/broadcastradio/AmFmBandRange;->upperBound:I
    ...
    .line 77
    :cond_4
    iget v3, p0, Landroid/hardware/broadcastradio/AmFmBandRange;->spacing:I

    invoke-static {v3}, Ljava/lang/Integer;->valueOf(I)Ljava/lang/Integer;

    move-result-object v3

    iget v4, v2, Landroid/hardware/broadcastradio/AmFmBandRange;->spacing:I
    ...
    .line 78
    :cond_5
    iget v3, p0, Landroid/hardware/broadcastradio/AmFmBandRange;->seekSpacing:I

    invoke-static {v3}, Ljava/lang/Integer;->valueOf(I)Ljava/lang/Integer;

    move-result-object v3

    iget v4, v2, Landroid/hardware/broadcastradio/AmFmBandRange;->seekSpacing:I
...
.method public final readFromParcel(Landroid/os/Parcel;)V
    ...
    .end local p0    # "this":Landroid/hardware/broadcastradio/AmFmBandRange;
    ...
    .restart local p0    # "this":Landroid/hardware/broadcastradio/AmFmBandRange;
...
.method public toString()Ljava/lang/String;
    ...
    const-string/jumbo v2, "seekSpacing: "

    invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget v2, p0, Landroid/hardware/broadcastradio/AmFmBandRange;->seekSpacing:I
...
.method public final writeToParcel(Landroid/os/Parcel;I)V
    ...
    .line 30
    iget v1, p0, Landroid/hardware/broadcastradio/AmFmBandRange;->lowerBound:I
    ...
    .line 32
    iget v1, p0, Landroid/hardware/broadcastradio/AmFmBandRange;->spacing:I

    invoke-virtual {p1, v1}, Landroid/os/Parcel;->writeInt(I)V

    .line 33
    iget v1, p0, Landroid/hardware/broadcastradio/AmFmBandRange;->seekSpacing:I
