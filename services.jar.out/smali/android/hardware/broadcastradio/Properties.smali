.class public Landroid/hardware/broadcastradio/Properties;
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0}, Landroid/hardware/broadcastradio/Properties$1;-><init>()V
...
.method private describeContents(Ljava/lang/Object;)I
    ...
    invoke-direct {p0, v4}, Landroid/hardware/broadcastradio/Properties;->describeContents(Ljava/lang/Object;)I
...
.method public describeContents()I
    ...
    .line 101
    .local v0, "_mask":I
    iget-object v1, p0, Landroid/hardware/broadcastradio/Properties;->vendorInfo:[Landroid/hardware/broadcastradio/VendorKeyValue;

    invoke-direct {p0, v1}, Landroid/hardware/broadcastradio/Properties;->describeContents(Ljava/lang/Object;)I
...
.method public equals(Ljava/lang/Object;)Z
    ...
    check-cast v2, Landroid/hardware/broadcastradio/Properties;

    .line 85
    .local v2, "that":Landroid/hardware/broadcastradio/Properties;
    iget-object v3, p0, Landroid/hardware/broadcastradio/Properties;->maker:Ljava/lang/String;

    iget-object v4, v2, Landroid/hardware/broadcastradio/Properties;->maker:Ljava/lang/String;
    ...
    .line 86
    :cond_3
    iget-object v3, p0, Landroid/hardware/broadcastradio/Properties;->product:Ljava/lang/String;

    iget-object v4, v2, Landroid/hardware/broadcastradio/Properties;->product:Ljava/lang/String;
    ...
    .line 87
    :cond_4
    iget-object v3, p0, Landroid/hardware/broadcastradio/Properties;->version:Ljava/lang/String;

    iget-object v4, v2, Landroid/hardware/broadcastradio/Properties;->version:Ljava/lang/String;
    ...
    .line 88
    :cond_5
    iget-object v3, p0, Landroid/hardware/broadcastradio/Properties;->serial:Ljava/lang/String;

    iget-object v4, v2, Landroid/hardware/broadcastradio/Properties;->serial:Ljava/lang/String;
    ...
    .line 89
    :cond_6
    iget-object v3, p0, Landroid/hardware/broadcastradio/Properties;->supportedIdentifierTypes:[I

    iget-object v4, v2, Landroid/hardware/broadcastradio/Properties;->supportedIdentifierTypes:[I
    ...
    .line 90
    :cond_7
    iget-object v3, p0, Landroid/hardware/broadcastradio/Properties;->vendorInfo:[Landroid/hardware/broadcastradio/VendorKeyValue;

    iget-object v4, v2, Landroid/hardware/broadcastradio/Properties;->vendorInfo:[Landroid/hardware/broadcastradio/VendorKeyValue;
...
.method public hashCode()I
    ...
    iget-object v2, p0, Landroid/hardware/broadcastradio/Properties;->vendorInfo:[Landroid/hardware/broadcastradio/VendorKeyValue;
...
.method public final readFromParcel(Landroid/os/Parcel;)V
    ...
    .end local p0    # "this":Landroid/hardware/broadcastradio/Properties;
    ...
    .restart local p0    # "this":Landroid/hardware/broadcastradio/Properties;
...
.method public toString()Ljava/lang/String;
    ...
    const-string/jumbo v2, "supportedIdentifierTypes: "
