...
.field static final TRANSACTION_healthInfoChanged:I = 0x1
...
.method public static asInterface(Landroid/os/IBinder;)Landroid/hardware/health/IHealthInfoCallback;
    ...
    check-cast v1, Landroid/hardware/health/IHealthInfoCallback;

    return-object v1

    .line 58
    :cond_1
    new-instance v1, Landroid/hardware/health/IHealthInfoCallback$Stub$Proxy;

    invoke-direct {v1, p0}, Landroid/hardware/health/IHealthInfoCallback$Stub$Proxy;-><init>(Landroid/os/IBinder;)V
...
.method public onTransact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    .line 89
    :pswitch_0
    sget-object v1, Landroid/hardware/health/HealthInfo;->CREATOR:Landroid/os/Parcelable$Creator;

    invoke-virtual {p2, v1}, Landroid/os/Parcel;->readTypedObject(Landroid/os/Parcelable$Creator;)Ljava/lang/Object;

    move-result-object v1

    check-cast v1, Landroid/hardware/health/HealthInfo;

    .line 90
    .local v1, "_arg0":Landroid/hardware/health/HealthInfo;
    invoke-virtual {p2}, Landroid/os/Parcel;->enforceNoDataAvail()V

    .line 91
    invoke-interface {p0, v1}, Landroid/hardware/health/IHealthInfoCallback;->healthInfoChanged(Landroid/hardware/health/HealthInfo;)V

    .line 92
    nop

    .line 99
    .end local v1    # "_arg0":Landroid/hardware/health/HealthInfo;
    return v2
