...
.method public updateDnsEvent(Ljava/lang/String;IJ)V
    ...
    const-string v3, "Method updateDnsEvent is unimplemented."
...
.method public updateDnsEvents([Ljava/lang/String;[I[J)V
    ...
    const-string v3, "Method updateDnsEvents is unimplemented."

    invoke-direct {v2, v3}, Landroid/os/RemoteException;-><init>(Ljava/lang/String;)V

    .end local v0    # "_data":Landroid/os/Parcel;
    .end local p0    # "this":Landroid/net/INetworkStackConnector$Stub$Proxy;
    .end local p1    # "hostnameList":[Ljava/lang/String;
    .end local p2    # "returncodeList":[I
    .end local p3    # "timestampList":[J
    throw v2
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
    ...
    .restart local v0    # "_data":Landroid/os/Parcel;
    .restart local p0    # "this":Landroid/net/INetworkStackConnector$Stub$Proxy;
    .restart local p1    # "hostnameList":[Ljava/lang/String;
    .restart local p2    # "returncodeList":[I
    .restart local p3    # "timestampList":[J
    :catchall_0
    move-exception v1
