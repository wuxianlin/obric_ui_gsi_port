...
.method public synthetic constructor <init>(Landroid/net/IIpMemoryStore;Ljava/lang/String;Landroid/net/ipmemorystore/NetworkAttributes;Landroid/net/ipmemorystore/OnStatusListener;)V
    ...
    iput-object p3, p0, Landroid/net/IpMemoryStoreClient$$ExternalSyntheticLambda12;->f$2:Landroid/net/ipmemorystore/NetworkAttributes;

    iput-object p4, p0, Landroid/net/IpMemoryStoreClient$$ExternalSyntheticLambda12;->f$3:Landroid/net/ipmemorystore/OnStatusListener;
...
.method public final run()V
    ...
    .line 0
    iget-object v0, p0, Landroid/net/IpMemoryStoreClient$$ExternalSyntheticLambda12;->f$0:Landroid/net/IIpMemoryStore;

    iget-object v1, p0, Landroid/net/IpMemoryStoreClient$$ExternalSyntheticLambda12;->f$1:Ljava/lang/String;

    iget-object v2, p0, Landroid/net/IpMemoryStoreClient$$ExternalSyntheticLambda12;->f$2:Landroid/net/ipmemorystore/NetworkAttributes;

    iget-object v3, p0, Landroid/net/IpMemoryStoreClient$$ExternalSyntheticLambda12;->f$3:Landroid/net/ipmemorystore/OnStatusListener;

    invoke-static {v0, v1, v2, v3}, Landroid/net/IpMemoryStoreClient;->$r8$lambda$tPwd2hc2Euvwob2T0xc07lBBUjs(Landroid/net/IIpMemoryStore;Ljava/lang/String;Landroid/net/ipmemorystore/NetworkAttributes;Landroid/net/ipmemorystore/OnStatusListener;)V
