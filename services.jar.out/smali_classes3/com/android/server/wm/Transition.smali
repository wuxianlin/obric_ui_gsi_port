...
.method static calculateTargets(Landroid/util/ArraySet;Landroid/util/ArrayMap;)Ljava/util/ArrayList;
    ...
    invoke-virtual {v4, v1}, Lcom/android/server/wm/ActivityRecord;->occludesParent(Z)Z
    ...
    const-wide v7, -0x6fe20247231ecaebL    # -4.829428748910759E-231
    ...
    const-wide v8, -0x50a7cb220392c8b9L    # -1.2759492176507397E-80
    ...
    .end local v4    # "record":Lcom/android/server/wm/ActivityRecord;
...
.method isTransientVisible(Lcom/android/server/wm/Task;)Z
    ...
    .line 463
    .local v4, "transientRoot":Lcom/android/server/wm/Task;
    if-nez v4, :cond_1
    ...
    .line 465
    .local v5, "rootParent":Lcom/android/server/wm/WindowContainer;, "Lcom/android/server/wm/WindowContainer<*>;"
    if-eqz v5, :cond_2
    ...
    iget-object v6, v6, Lcom/android/server/wm/ActivityTaskSupervisor;->mOpaqueActivityHelper:Lcom/android/server/wm/ActivityTaskSupervisor$OpaqueActivityHelper;

    .line 467
    const/4 v7, 0x1

    invoke-virtual {v6, v5, v7}, Lcom/android/server/wm/ActivityTaskSupervisor$OpaqueActivityHelper;->getOpaqueActivity(Lcom/android/server/wm/WindowContainer;Z)Lcom/android/server/wm/ActivityRecord;

    move-result-object v6

    .line 468
    .local v6, "topOpaque":Lcom/android/server/wm/ActivityRecord;
    invoke-virtual {v6}, Lcom/android/server/wm/ActivityRecord;->getRootTask()Lcom/android/server/wm/Task;

    move-result-object v7

    invoke-virtual {v4, v7}, Lcom/android/server/wm/WindowContainer;->compareTo(Lcom/android/server/wm/WindowContainer;)I
    ...
    .line 461
    .end local v4    # "transientRoot":Lcom/android/server/wm/Task;
    .end local v5    # "rootParent":Lcom/android/server/wm/WindowContainer;, "Lcom/android/server/wm/WindowContainer<*>;"
    .end local v6    # "topOpaque":Lcom/android/server/wm/ActivityRecord;
    :cond_4
    :goto_1
    add-int/lit8 v3, v3, -0x1
