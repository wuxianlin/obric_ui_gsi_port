...
# direct methods
.method static bridge synthetic -$$Nest$fgetmHandler(Lcom/android/server/wm/ForceRefreshRatePackageList;)Landroid/os/Handler;
    .locals 0

    .line 0
    iget-object p0, p0, Lcom/android/server/wm/ForceRefreshRatePackageList;->mHandler:Landroid/os/Handler;

    return-object p0
.end method

.method static bridge synthetic -$$Nest$mupdateForcedPackagelist(Lcom/android/server/wm/ForceRefreshRatePackageList;Ljava/lang/String;)V
    .locals 0
...
.method constructor <init>(Lcom/android/server/wm/WindowManagerService;Landroid/view/DisplayInfo;)V
    ...
    .line 63
    iget-object v1, p0, Lcom/android/server/wm/ForceRefreshRatePackageList;->mHandler:Landroid/os/Handler;

    iget-object v2, p0, Lcom/android/server/wm/ForceRefreshRatePackageList;->mSettingsObserver:Lcom/android/server/wm/ForceRefreshRatePackageList$SettingsObserver;

    invoke-static {v2}, Ljava/util/Objects;->requireNonNull(Ljava/lang/Object;)Ljava/lang/Object;

    new-instance v3, Lcom/android/server/wm/ForceRefreshRatePackageList$$ExternalSyntheticLambda0;

    invoke-direct {v3, v2}, Lcom/android/server/wm/ForceRefreshRatePackageList$$ExternalSyntheticLambda0;-><init>(Lcom/android/server/wm/ForceRefreshRatePackageList$SettingsObserver;)V
...
.method private findModeByRefreshRate(F)Landroid/view/Display$Mode;
    .locals 4
...
.method private updateForcedPackagelist(Ljava/lang/String;)V
    ...
    .line 80
    .restart local v1    # "pairs":[Ljava/lang/String;
...
# virtual methods
.method getForceRefreshRate(Ljava/lang/String;)F
    .locals 4
    ...
    invoke-direct {p0, v1}, Lcom/android/server/wm/ForceRefreshRatePackageList;->findModeByRefreshRate(F)Landroid/view/Display$Mode;
    ...
    .line 107
    .restart local v1    # "refreshRate":F
    .restart local v3    # "mode":Landroid/view/Display$Mode;
    :cond_0
    :goto_0
    monitor-exit v0
