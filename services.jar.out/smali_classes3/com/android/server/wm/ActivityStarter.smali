...
.method private executeRequest(Lcom/android/server/wm/ActivityStarter$Request;)I
    ...
    const-string v11, "start u0 finalPrefetchState="
    ...
    .end local v61    # "finalPrefetchState":I
    .local v11, "finalPrefetchState":I
    ...
    .end local v11    # "finalPrefetchState":I
    .restart local v61    # "finalPrefetchState":I
    .restart local v62    # "setToAms":I
    :cond_17
    move-object/from16 v47, v3
    ...
    .restart local v11    # "finalPrefetchState":I
    :goto_b
    const/4 v0, 0x0
    ...
    .local v20, "resultRecord":Lcom/android/server/wm/ActivityRecord;
    ...
    .line 1132
    .end local v20    # "resultRecord":Lcom/android/server/wm/ActivityRecord;
    .end local v62    # "setToAms":I
    ...
    .end local v3    # "resultRecord":Lcom/android/server/wm/ActivityRecord;
    .end local v5    # "setToAms":I
    .restart local v20    # "resultRecord":Lcom/android/server/wm/ActivityRecord;
    .restart local v62    # "setToAms":I
    :goto_c
    if-eqz v0, :cond_19
    ...
    iget v1, v5, Lcom/android/server/wm/ActivityRecord;->requestCode:I
    ...
    iput-object v9, v5, Lcom/android/server/wm/ActivityRecord;->resultTo:Lcom/android/server/wm/ActivityRecord;

    .line 1157
    if-eqz v3, :cond_1d

    .line 1158
    invoke-virtual {v3, v5, v0, v1}, Lcom/android/server/wm/ActivityRecord;->removeResultsLocked(Lcom/android/server/wm/ActivityRecord;Ljava/lang/String;I)V

    .line 1160
    :cond_1d
    iget v9, v5, Lcom/android/server/wm/ActivityRecord;->launchedFromUid:I

    if-ne v9, v4, :cond_1e

    .line 1171
    iget-object v9, v5, Lcom/android/server/wm/ActivityRecord;->launchedFromPackage:Ljava/lang/String;
    ...
    .local v65, "resultTo":Landroid/os/IBinder;
    ...
    .local v67, "queryPrefetchState":I
    ...
    .line 1192
    invoke-virtual {v0, v7, v13, v12, v8}, Lcom/android/server/pm/PackageArchiver;->requestUnarchiveOnActivityStart(Landroid/content/Intent;Ljava/lang/String;II)I
    ...
    .end local v67    # "queryPrefetchState":I
    .restart local v12    # "queryPrefetchState":I
    :cond_21
    move/from16 v67, v12

    .end local v12    # "queryPrefetchState":I
    .restart local v67    # "queryPrefetchState":I
    goto :goto_10
    ...
    .local v68, "finalPrefetchState":I
    :try_start_3
    invoke-interface {v0, v5, v7, v11, v2}, Landroid/content/pm/IPackageManager;->activitySupportsIntentAsUser(Landroid/content/ComponentName;Landroid/content/Intent;Ljava/lang/String;I)Z
    ...
    .line 1214
    .end local v68    # "finalPrefetchState":I
    .local v11, "finalPrefetchState":I
    ...
    .end local v37    # "resolvedType":Ljava/lang/String;
    .local v11, "resolvedType":Ljava/lang/String;
    .restart local v68    # "finalPrefetchState":I
    :goto_12
    nop
    ...
    invoke-virtual/range {v20 .. v27}, Lcom/android/server/wm/ActivityRecord;->sendResult(ILjava/lang/String;IILandroid/content/Intent;Landroid/os/IBinder;Lcom/android/server/uri/NeededUriGrants;)V
    ...
    iget-boolean v5, v14, Lcom/android/server/wm/ActivityStarter$Request;->ignoreTargetSecurity:Z
    ...
    .end local v3    # "resultWho":Ljava/lang/String;
    .local v31, "resultWho":Ljava/lang/String;
    move/from16 v3, v42
    ...
    invoke-virtual {v2, v7, v9, v13}, Lcom/android/server/policy/PermissionPolicyInternal;->checkStartActivity(Landroid/content/Intent;ILjava/lang/String;)Z
    ...
    invoke-virtual {v12, v7, v10, v5, v0}, Lcom/android/server/wm/SafeActivityOptions;->getOptions(Landroid/content/Intent;Landroid/content/pm/ActivityInfo;Lcom/android/server/wm/WindowProcessController;Lcom/android/server/wm/ActivityTaskSupervisor;)Landroid/app/ActivityOptions;
    ...
    .restart local v12    # "options":Lcom/android/server/wm/SafeActivityOptions;
    const/4 v0, 0x0
    ...
    iget-object v3, v14, Lcom/android/server/wm/ActivityStarter$Request;->forcedBalByPiSender:Landroid/app/BackgroundStartPrivileges;
    ...
    .line 1318
    invoke-virtual {v0, v13, v2}, Lcom/android/server/wm/PendingRemoteAnimationRegistry;->overrideOptionsIfNeeded(Ljava/lang/String;Landroid/app/ActivityOptions;)Landroid/app/ActivityOptions;
    ...
    invoke-direct {v15, v1, v11, v2}, Lcom/android/server/wm/ActivityStarter;->computeSuggestedLaunchDisplayArea(Lcom/android/server/wm/Task;Lcom/android/server/wm/ActivityRecord;Landroid/app/ActivityOptions;)Lcom/android/server/wm/TaskDisplayArea;
    ...
    iget-object v6, v15, Lcom/android/server/wm/ActivityStarter;->mInterceptor:Lcom/android/server/wm/ActivityStartInterceptor;

    iget-object v1, v6, Lcom/android/server/wm/ActivityStartInterceptor;->mInTask:Lcom/android/server/wm/Task;
    ...
    .local v9, "resolvedType":Ljava/lang/String;
    .local v10, "checkedOptions":Landroid/app/ActivityOptions;
    .local v42, "inTask":Lcom/android/server/wm/Task;
    :goto_1d
    if-eqz v0, :cond_36
    ...
    .local v12, "userId":I
    .local v25, "options":Lcom/android/server/wm/SafeActivityOptions;
    invoke-virtual {v0, v3, v12}, Landroid/content/pm/PackageManagerInternal;->isPermissionsReviewRequired(Ljava/lang/String;I)Z
    ...
    .line 1422
    iget-object v5, v15, Lcom/android/server/wm/ActivityStarter;->mSupervisor:Lcom/android/server/wm/ActivityTaskSupervisor;

    move-object/from16 v27, v0

    .end local v0    # "target":Landroid/content/IIntentSender;
    .local v27, "target":Landroid/content/IIntentSender;
    ...
    .local v9, "startFlags":I
    .local v17, "resolvedType":Ljava/lang/String;
    .local v18, "aInfo":Landroid/content/pm/ActivityInfo;
    invoke-virtual {v5, v7, v0, v9, v1}, Lcom/android/server/wm/ActivityTaskSupervisor;->resolveActivity(Landroid/content/Intent;Landroid/content/pm/ResolveInfo;ILandroid/app/ProfilerInfo;)Landroid/content/pm/ActivityInfo;
    ...
    .restart local v28    # "resultRecord":Lcom/android/server/wm/ActivityRecord;
    invoke-virtual {v7, v11, v11, v11, v3}, Landroid/content/Intent;->toShortString(ZZZZ)Ljava/lang/String;
    ...
    .end local v27    # "target":Landroid/content/IIntentSender;
    .end local v28    # "resultRecord":Lcom/android/server/wm/ActivityRecord;
    .end local v60    # "callerApp":Lcom/android/server/wm/WindowProcessController;
    .local v1, "aInfo":Landroid/content/pm/ActivityInfo;
    .restart local v4    # "resultRecord":Lcom/android/server/wm/ActivityRecord;
    ...
    .end local v24    # "rInfo":Landroid/content/pm/ResolveInfo;
    .end local v25    # "options":Lcom/android/server/wm/SafeActivityOptions;
    .end local v28    # "resultRecord":Lcom/android/server/wm/ActivityRecord;
    .end local v60    # "callerApp":Lcom/android/server/wm/WindowProcessController;
    .local v0, "abort":Z
    ...
    .restart local v24    # "rInfo":Landroid/content/pm/ResolveInfo;
    .restart local v25    # "options":Lcom/android/server/wm/SafeActivityOptions;
    .restart local v28    # "resultRecord":Lcom/android/server/wm/ActivityRecord;
    .restart local v60    # "callerApp":Lcom/android/server/wm/WindowProcessController;
    :goto_1f
    ...
    .end local v28    # "resultRecord":Lcom/android/server/wm/ActivityRecord;
    .local v6, "resultRecord":Lcom/android/server/wm/ActivityRecord;
    move-object v4, v13

    move-object/from16 v28, v60

    .end local v60    # "callerApp":Lcom/android/server/wm/WindowProcessController;
    .local v28, "callerApp":Lcom/android/server/wm/WindowProcessController;
    ...
    .local v6, "verificationBundle":Landroid/os/Bundle;
    .local v12, "resultRecord":Lcom/android/server/wm/ActivityRecord;
    .local v24, "userId":I
    ...
    invoke-virtual {v2, v1, v0, v9, v3}, Lcom/android/server/wm/ActivityTaskSupervisor;->resolveActivity(Landroid/content/Intent;Landroid/content/pm/ResolveInfo;ILandroid/app/ProfilerInfo;)Landroid/content/pm/ActivityInfo;
    ...
    .end local v28    # "callerApp":Lcom/android/server/wm/WindowProcessController;
    ...
    .restart local v28    # "callerApp":Lcom/android/server/wm/WindowProcessController;
    ...
    :goto_22
    new-instance v11, Lcom/android/server/wm/ActivityRecord$Builder;
    ...
    invoke-direct {v11, v0}, Lcom/android/server/wm/ActivityRecord$Builder;-><init>(Lcom/android/server/wm/ActivityTaskManagerService;)V

    .line 1465
    invoke-virtual {v11, v7}, Lcom/android/server/wm/ActivityRecord$Builder;->setCaller(Lcom/android/server/wm/WindowProcessController;)Lcom/android/server/wm/ActivityRecord$Builder;

    move-result-object v0

    .line 1466
    invoke-virtual {v0, v2}, Lcom/android/server/wm/ActivityRecord$Builder;->setLaunchedFromPid(I)Lcom/android/server/wm/ActivityRecord$Builder;
    ...
    .local v11, "callingFeatureId":Ljava/lang/String;
    invoke-virtual {v0, v11}, Lcom/android/server/wm/ActivityRecord$Builder;->setLaunchedFromFeature(Ljava/lang/String;)Lcom/android/server/wm/ActivityRecord$Builder;
    ...
    .line 1471
    invoke-virtual {v0, v5}, Lcom/android/server/wm/ActivityRecord$Builder;->setResolvedType(Ljava/lang/String;)Lcom/android/server/wm/ActivityRecord$Builder;
    ...
    .end local v31    # "resultWho":Ljava/lang/String;
    ...
    .local v1, "requestCode":I
    .restart local v31    # "resultWho":Ljava/lang/String;
    ...
    .end local v1    # "requestCode":I
    .restart local v69    # "requestCode":I
    ...
    .local v28, "prefetchAffected":Z
    iget v2, v4, Lcom/android/server/wm/WindowProcessController;->mUid:I
    ...
    .end local v28    # "prefetchAffected":Z
    .restart local v2    # "prefetchAffected":Z
    :cond_41
    move/from16 v28, v2

    .end local v2    # "prefetchAffected":Z
    .restart local v28    # "prefetchAffected":Z
    :cond_42
    move/from16 v57, v22
    ...
    .end local v9    # "startFlags":I
    .end local v39    # "inTaskFragment":Lcom/android/server/wm/TaskFragment;
    .end local v69    # "requestCode":I
    .local v17, "startFlags":I
    .local v35, "inTaskFragment":Lcom/android/server/wm/TaskFragment;
    .local v36, "requestCode":I
    move-object v9, v1

    move-object/from16 v39, v10

    .end local v10    # "checkedOptions":Landroid/app/ActivityOptions;
    ...
    .end local v11    # "callingFeatureId":Ljava/lang/String;
    .end local v68    # "finalPrefetchState":I
    .local v40, "finalPrefetchState":I
    .local v41, "sourceRecord":Lcom/android/server/wm/ActivityRecord;
    .local v46, "callingFeatureId":Ljava/lang/String;
    move-object v11, v5
    ...
    .end local v12    # "resultRecord":Lcom/android/server/wm/ActivityRecord;
    .end local v24    # "userId":I
    .end local v67    # "queryPrefetchState":I
    .local v1, "userId":I
    .local v5, "caller":Landroid/app/IApplicationThread;
    .local v43, "queryPrefetchState":I
    .local v47, "resultRecord":Lcom/android/server/wm/ActivityRecord;
    move/from16 v12, v17
    ...
    .end local v17    # "startFlags":I
    .end local v25    # "options":Lcom/android/server/wm/SafeActivityOptions;
    .end local v61    # "isFromPrefetch":I
    .end local v65    # "resultTo":Landroid/os/IBinder;
    .local v48, "resultTo":Landroid/os/IBinder;
    .local v49, "realCallingPid":I
    .local v50, "startFlags":I
    .local v51, "options":Lcom/android/server/wm/SafeActivityOptions;
    .local v52, "isFromPrefetch":I
    ...
    .end local v2    # "isHomeProcess":Z
    .local v24, "isHomeProcess":Z
    ...
    .end local v31    # "resultWho":Ljava/lang/String;
    .end local v40    # "finalPrefetchState":I
    .end local v46    # "callingFeatureId":Ljava/lang/String;
    .end local v47    # "resultRecord":Lcom/android/server/wm/ActivityRecord;
    .end local v48    # "resultTo":Landroid/os/IBinder;
    .end local v49    # "realCallingPid":I
    .end local v50    # "startFlags":I
    .end local v51    # "options":Lcom/android/server/wm/SafeActivityOptions;
    .end local v52    # "isFromPrefetch":I
    .end local v53    # "callingPackage":Ljava/lang/String;
    .local v1, "resultRecord":Lcom/android/server/wm/ActivityRecord;
    .local v2, "userId":I
    .local v3, "resultWho":Ljava/lang/String;
    .local v4, "callingUid":I
    ...
    .local v59, "options":Lcom/android/server/wm/SafeActivityOptions;
    .restart local v60    # "callerApp":Lcom/android/server/wm/WindowProcessController;
    .restart local v61    # "isFromPrefetch":I
    .restart local v65    # "resultTo":Landroid/os/IBinder;
    .restart local v66    # "callingFeatureId":Ljava/lang/String;
    .restart local v67    # "queryPrefetchState":I
    .restart local v68    # "finalPrefetchState":I
    :catch_6
    move-exception v0
    ...
    .restart local v5    # "caller":Landroid/app/IApplicationThread;
    .restart local v6    # "verificationBundle":Landroid/os/Bundle;
    .local v9, "callingUid":I
    .local v19, "resultWho":Ljava/lang/String;
    .local v28, "callerApp":Lcom/android/server/wm/WindowProcessController;
    ...
    .local v35, "inTaskFragment":Lcom/android/server/wm/TaskFragment;
    .local v36, "requestCode":I
    .restart local v40    # "finalPrefetchState":I
    .local v41, "sourceRecord":Lcom/android/server/wm/ActivityRecord;
    .local v43, "queryPrefetchState":I
    .restart local v45    # "resolvedType":Ljava/lang/String;
    .restart local v46    # "callingFeatureId":Ljava/lang/String;
    .restart local v47    # "resultRecord":Lcom/android/server/wm/ActivityRecord;
    .restart local v48    # "resultTo":Landroid/os/IBinder;
    .restart local v49    # "realCallingPid":I
    .restart local v50    # "startFlags":I
    .restart local v51    # "options":Lcom/android/server/wm/SafeActivityOptions;
    .restart local v52    # "isFromPrefetch":I
    .restart local v53    # "callingPackage":Ljava/lang/String;
    iget-object v8, v2, Lcom/android/server/wm/ActivityStarter$Request;->ephemeralIntent:Landroid/content/Intent;
    ...
    iget-object v12, v3, Lcom/android/server/wm/ActivityStarter;->mService:Lcom/android/server/wm/ActivityTaskManagerService;

    invoke-virtual {v12}, Lcom/android/server/wm/ActivityTaskManagerService;->getPackageManagerInternalLocked()Landroid/content/pm/PackageManagerInternal;

    move-result-object v12

    .line 1265
    invoke-virtual {v12, v11, v9, v1}, Landroid/content/pm/PackageManagerInternal;->filterAppAccess(Ljava/lang/String;II)Z
    ...
    .line 1271
    :cond_47
    invoke-static/range {v51 .. v51}, Lcom/android/server/wm/SafeActivityOptions;->abort(Lcom/android/server/wm/SafeActivityOptions;)V
    ...
    .end local v33    # "intentGrants":Lcom/android/server/uri/NeededUriGrants;
    .end local v34    # "previousStart":Lcom/android/server/wm/ActivityRecord;
    .end local v35    # "inTaskFragment":Lcom/android/server/wm/TaskFragment;
    .end local v36    # "requestCode":I
    .end local v37    # "err":I
    .end local v40    # "finalPrefetchState":I
