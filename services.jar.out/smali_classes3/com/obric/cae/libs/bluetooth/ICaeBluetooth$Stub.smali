...
.method public onTransact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    :goto_0
    invoke-interface {p0, v2}, Lcom/obric/cae/libs/bluetooth/ICaeBluetooth;->getProductId(Landroid/bluetooth/BluetoothDevice;)I
    ...
    :goto_1
    invoke-interface {p0, v2, v3}, Lcom/obric/cae/libs/bluetooth/ICaeBluetooth;->removeDeviceFromStaticExtDatabase(Ljava/lang/String;Landroid/bluetooth/BluetoothDevice;)V
    ...
    .restart local v3    # "_arg1":Landroid/bluetooth/BluetoothDevice;
    :goto_2
    invoke-interface {p0, v2, v3}, Lcom/obric/cae/libs/bluetooth/ICaeBluetooth;->addDeviceToStaticExtDatabase(Ljava/lang/String;Landroid/bluetooth/BluetoothDevice;)V
    ...
    :goto_3
    invoke-interface {p0, v2, v3}, Lcom/obric/cae/libs/bluetooth/ICaeBluetooth;->requestLeConnectionPriority(ILandroid/content/AttributionSource;)V
    ...
    .restart local v3    # "_arg1":Landroid/bluetooth/BluetoothDevice;
    :goto_4
    invoke-interface {p0, v2, v3}, Lcom/obric/cae/libs/bluetooth/ICaeBluetooth;->removeDeviceFromDatabase(Ljava/lang/String;Landroid/bluetooth/BluetoothDevice;)V
    ...
    .restart local v3    # "_arg1":Landroid/bluetooth/BluetoothDevice;
    :goto_5
    invoke-interface {p0, v2, v3}, Lcom/obric/cae/libs/bluetooth/ICaeBluetooth;->addDeviceToDatabase(Ljava/lang/String;Landroid/bluetooth/BluetoothDevice;)V
    ...
    invoke-interface {p0, v2}, Lcom/obric/cae/libs/bluetooth/ICaeBluetooth;->unregisterEventCallback(Lcom/obric/cae/libs/bluetooth/ICaeBluetoothEventCallback;)V
    ...
    invoke-interface {p0, v2}, Lcom/obric/cae/libs/bluetooth/ICaeBluetooth;->registerEventCallback(Lcom/obric/cae/libs/bluetooth/ICaeBluetoothEventCallback;)V
