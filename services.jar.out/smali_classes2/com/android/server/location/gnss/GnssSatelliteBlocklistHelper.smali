...
.method constructor <init>(Landroid/content/Context;Landroid/os/Looper;Lcom/android/server/location/gnss/GnssSatelliteBlocklistHelper$GnssSatelliteBlocklistCallback;)V
    ...
    iget-object v1, p0, Lcom/android/server/location/gnss/GnssSatelliteBlocklistHelper;->mContext:Landroid/content/Context;
    ...
    .line 59
    const-string/jumbo v2, "gnss_satellite_blocklist"
...
.method updateSatelliteBlocklist()V
    ...
    .line 73
    :cond_0
    const-string v2, "Update GNSS satellite blocklist: %s"
    ...
    const-string v3, "GnssBlocklistHelper"
    ...
    .line 81
    .local v2, "blocklistValues":Ljava/util/List;, "Ljava/util/List<Ljava/lang/Integer;>;"
    nop
    ...
    .line 84
    const-string v4, "blocklist string has odd number of values.Aborting updateSatelliteBlocklist"
    ...
    .line 96
    .end local v6    # "i":I
    iget-object v6, p0, Lcom/android/server/location/gnss/GnssSatelliteBlocklistHelper;->mCallback:Lcom/android/server/location/gnss/GnssSatelliteBlocklistHelper$GnssSatelliteBlocklistCallback;

    invoke-interface {v6, v4, v5}, Lcom/android/server/location/gnss/GnssSatelliteBlocklistHelper$GnssSatelliteBlocklistCallback;->onUpdateSatelliteBlocklist([I[I)V

    .line 97
    return-void

    .line 78
    .end local v2    # "blocklistValues":Ljava/util/List;, "Ljava/util/List<Ljava/lang/Integer;>;"
    .end local v3    # "length":I
    .end local v4    # "constellations":[I
    .end local v5    # "svids":[I
    :catch_0
    move-exception v2

    .line 79
    .local v2, "e":Ljava/lang/NumberFormatException;
    const-string v4, "Exception thrown when parsing blocklist string."
