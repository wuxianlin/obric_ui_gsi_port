...
# direct methods
.method static bridge synthetic -$$Nest$mqueryCountryCode(Lcom/android/server/location/countrydetector/LocationBasedCountryDetector;Landroid/location/Location;)V
    .locals 0
...
.method public declared-synchronized detectCountry()Landroid/location/Country;
    ...
    .line 173
    .restart local v0    # "enabledProviders":Ljava/util/List;, "Ljava/util/List<Ljava/lang/String;>;"
    .restart local v1    # "totalProviders":I
    ...
    .line 200
    iget-object v2, p0, Lcom/android/server/location/countrydetector/LocationBasedCountryDetector;->mTimer:Ljava/util/Timer;
    ...
    .line 214
    :goto_2
    iget-object v2, p0, Lcom/android/server/location/countrydetector/CountryDetectorBase;->mDetectedCountry:Landroid/location/Country;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method protected getCountryFromLocation(Landroid/location/Location;)Ljava/lang/String;
    ...
    iget-object v2, p0, Lcom/android/server/location/countrydetector/CountryDetectorBase;->mContext:Landroid/content/Context;
...
.method protected getLastKnownLocation()Landroid/location/Location;
    ...
    .restart local v3    # "bestLocation":Landroid/location/Location;
    .restart local v5    # "provider":Ljava/lang/String;
    .restart local v6    # "lastKnownLocation":Landroid/location/Location;
    :cond_0
    :goto_1
    move-object v3, v6
