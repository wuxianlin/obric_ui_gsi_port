...
.method private final parseAppId(Lcom/android/modules/utils/BinaryXmlPullParser;Lcom/android/server/permission/access/immutable/MutableIntReferenceMap;)V
    ...
    .param p2, "appIdAppOpModes"    # Lcom/android/server/permission/access/immutable/MutableIntReferenceMap;
...
.method private final parseAppIdAppOps(Lcom/android/modules/utils/BinaryXmlPullParser;Lcom/android/server/permission/access/MutableAccessState;I)V
    .locals 16
    .param p1, "$this$parseAppIdAppOps"    # Lcom/android/modules/utils/BinaryXmlPullParser;
    ...
    .line 46
    .local v3, "appIdAppOpModes":Lcom/android/server/permission/access/immutable/MutableIntReferenceMap;
    ...
    .local v10, "$this$parseAppIdAppOps_u24lambda_u240":Lcom/android/modules/utils/BinaryXmlPullParser;
    const/4 v11, 0x0

    .line 47
    .local v11, "$i$a$-forEachTag-AppIdAppOpPersistence$parseAppIdAppOps$1":I
    move-object v12, v10
    ...
    invoke-direct {v12, v10, v3}, Lcom/android/server/permission/access/appop/AppIdAppOpPersistence;->parseAppId(Lcom/android/modules/utils/BinaryXmlPullParser;Lcom/android/server/permission/access/immutable/MutableIntReferenceMap;)V
    ...
    sget-object v13, Lcom/android/server/permission/access/appop/AppIdAppOpPersistence;->LOG_TAG:Ljava/lang/String;
    ...
    .line 61
    .end local v10    # "$this$parseAppIdAppOps_u24lambda_u240":Lcom/android/modules/utils/BinaryXmlPullParser;
    .end local v11    # "$i$a$-forEachTag-AppIdAppOpPersistence$parseAppIdAppOps$1":I
    nop
    ...
    .line 54
    .local v10, "$i$a$-forEachReversedIndexed-AppIdAppOpPersistence$parseAppIdAppOps$2":I
    nop
    ...
    .line 58
    sget-object v11, Lcom/android/server/permission/access/appop/AppIdAppOpPersistence;->LOG_TAG:Ljava/lang/String;
    ...
    .end local v10    # "$i$a$-forEachReversedIndexed-AppIdAppOpPersistence$parseAppIdAppOps$2":I
    nop
...
.method private final serializeAppId(Lcom/android/modules/utils/BinaryXmlSerializer;ILcom/android/server/permission/access/immutable/IndexedMap;)V
    ...
    .local v4, "$this$serializeAppId_u24lambda_u244":Lcom/android/modules/utils/BinaryXmlSerializer;
    const/4 v5, 0x0

    .line 89
    .local v5, "$i$a$-tag-AppIdAppOpPersistence$serializeAppId$1":I
    ...
    invoke-virtual {v7, v3, v6, p2}, Lcom/android/modules/utils/BinaryXmlSerializer;->attributeInt(Ljava/lang/String;Ljava/lang/String;I)Lorg/xmlpull/v1/XmlSerializer;
    ...
    .line 54
    .end local v4    # "$this$serializeAppId_u24lambda_u244":Lcom/android/modules/utils/BinaryXmlSerializer;
    .end local v5    # "$i$a$-tag-AppIdAppOpPersistence$serializeAppId$1":I
    nop
...
.method private final serializeAppIdAppOps(Lcom/android/modules/utils/BinaryXmlSerializer;Lcom/android/server/permission/access/immutable/IntReferenceMap;)V
    .locals 13
    .param p1, "$this$serializeAppIdAppOps"    # Lcom/android/modules/utils/BinaryXmlSerializer;
    .param p2, "appIdAppOpModes"    # Lcom/android/server/permission/access/immutable/IntReferenceMap;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
            "Lcom/android/modules/utils/BinaryXmlSerializer;",
    ...
    .local v4, "$this$serializeAppIdAppOps_u24lambda_u243":Lcom/android/modules/utils/BinaryXmlSerializer;
    const/4 v5, 0x0

    .line 78
    .local v5, "$i$a$-tag-AppIdAppOpPersistence$serializeAppIdAppOps$1":I
    move-object v6, p2
    ...
    .line 79
    .local v12, "$i$a$-forEachIndexed-AppIdAppOpPersistence$serializeAppIdAppOps$1$1":I
    invoke-direct {p0, v4, v10, v11}, Lcom/android/server/permission/access/appop/AppIdAppOpPersistence;->serializeAppId(Lcom/android/modules/utils/BinaryXmlSerializer;ILcom/android/server/permission/access/immutable/IndexedMap;)V
    ...
    .end local v12    # "$i$a$-forEachIndexed-AppIdAppOpPersistence$serializeAppIdAppOps$1$1":I
    nop
    ...
    .line 54
    .end local v4    # "$this$serializeAppIdAppOps_u24lambda_u243":Lcom/android/modules/utils/BinaryXmlSerializer;
    .end local v5    # "$i$a$-tag-AppIdAppOpPersistence$serializeAppIdAppOps$1":I
    nop
...
.method public parseUserState(Lcom/android/modules/utils/BinaryXmlPullParser;Lcom/android/server/permission/access/MutableAccessState;I)V
    ...
    invoke-direct {p0, p1, p2, p3}, Lcom/android/server/permission/access/appop/AppIdAppOpPersistence;->parseAppIdAppOps(Lcom/android/modules/utils/BinaryXmlPullParser;Lcom/android/server/permission/access/MutableAccessState;I)V
...
.method public serializeUserState(Lcom/android/modules/utils/BinaryXmlSerializer;Lcom/android/server/permission/access/AccessState;I)V
    ...
    invoke-direct {p0, p1, v0}, Lcom/android/server/permission/access/appop/AppIdAppOpPersistence;->serializeAppIdAppOps(Lcom/android/modules/utils/BinaryXmlSerializer;Lcom/android/server/permission/access/immutable/IntReferenceMap;)V
