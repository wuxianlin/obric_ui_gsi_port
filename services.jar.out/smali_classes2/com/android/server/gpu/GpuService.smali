...
# direct methods
.method static bridge synthetic -$$Nest$fgetmContentResolver(Lcom/android/server/gpu/GpuService;)Landroid/content/ContentResolver;
    .locals 0
...
.method static bridge synthetic -$$Nest$fgetmContext(Lcom/android/server/gpu/GpuService;)Landroid/content/Context;
    .locals 0
...
.method static bridge synthetic -$$Nest$fgetmDevDriverPackageName(Lcom/android/server/gpu/GpuService;)Ljava/lang/String;
    .locals 0
...
.method static bridge synthetic -$$Nest$fgetmDeviceConfigLock(Lcom/android/server/gpu/GpuService;)Ljava/lang/Object;
    .locals 0
...
.method static bridge synthetic -$$Nest$fgetmProdDriverPackageName(Lcom/android/server/gpu/GpuService;)Ljava/lang/String;
    .locals 0
...
.method static bridge synthetic -$$Nest$mfetchPrereleaseDriverPackageProperties(Lcom/android/server/gpu/GpuService;)V
    .locals 0
...
.method static bridge synthetic -$$Nest$mfetchProductionDriverPackageProperties(Lcom/android/server/gpu/GpuService;)V
    .locals 0
...
.method static bridge synthetic -$$Nest$mparseDenylists(Lcom/android/server/gpu/GpuService;Ljava/lang/String;)V
    .locals 0
...
.method static bridge synthetic -$$Nest$mprocessDenylists(Lcom/android/server/gpu/GpuService;)V
    .locals 0
...
.method static bridge synthetic -$$Nest$msetDenylist(Lcom/android/server/gpu/GpuService;)V
    .locals 0
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-direct {v2, p0, v3}, Lcom/android/server/gpu/GpuService$PackageReceiver;-><init>(Lcom/android/server/gpu/GpuService;Lcom/android/server/gpu/GpuService$PackageReceiver-IA;)V
...
.method private static assetToSettingsGlobal(Landroid/content/Context;Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Ljava/lang/CharSequence;)V
    ...
    .restart local v1    # "assetStrings":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Ljava/lang/String;>;"
    .restart local v3    # "assetString":Ljava/lang/String;
    :cond_0
    nop
...
.method private fetchProductionDriverPackageProperties()V
    ...
    iget-object v2, p0, Lcom/android/server/gpu/GpuService;->mProdDriverPackageName:Ljava/lang/String;
    ...
    iget-object v2, p0, Lcom/android/server/gpu/GpuService;->mContext:Landroid/content/Context;

    const-string v4, "allowlist.txt"

    const-string v5, ","

    invoke-static {v2, v1, v4, v3, v5}, Lcom/android/server/gpu/GpuService;->assetToSettingsGlobal(Landroid/content/Context;Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Ljava/lang/CharSequence;)V
    :try_end_1
