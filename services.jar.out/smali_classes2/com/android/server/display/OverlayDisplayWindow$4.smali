...
.method public onScroll(Landroid/view/MotionEvent;Landroid/view/MotionEvent;FF)Z
    ...
    invoke-static {v0}, Lcom/android/server/display/OverlayDisplayWindow;->-$$Nest$fgetmLiveTranslationX(Lcom/android/server/display/OverlayDisplayWindow;)F

    move-result v1

    sub-float/2addr v1, p3

    invoke-static {v0, v1}, Lcom/android/server/display/OverlayDisplayWindow;->-$$Nest$fputmLiveTranslationX(Lcom/android/server/display/OverlayDisplayWindow;F)V

    .line 375
    iget-object v0, p0, Lcom/android/server/display/OverlayDisplayWindow$4;->this$0:Lcom/android/server/display/OverlayDisplayWindow;

    invoke-static {v0}, Lcom/android/server/display/OverlayDisplayWindow;->-$$Nest$fgetmLiveTranslationY(Lcom/android/server/display/OverlayDisplayWindow;)F

    move-result v1

    sub-float/2addr v1, p4

    invoke-static {v0, v1}, Lcom/android/server/display/OverlayDisplayWindow;->-$$Nest$fputmLiveTranslationY(Lcom/android/server/display/OverlayDisplayWindow;F)V
