...
.field private threshold:Ljava/math/BigDecimal;
    .annotation build Landroid/annotation/NonNull;
    .end annotation
.end field
...
.method static read(Lorg/xmlpull/v1/XmlPullParser;)Lcom/android/server/display/config/ThresholdPoint;
    .locals 7
    ...
    .line 39
    .local v0, "_instance":Lcom/android/server/display/config/ThresholdPoint;
    const/4 v1, 0x0
    ...
    invoke-virtual {v0, v5}, Lcom/android/server/display/config/ThresholdPoint;->setThreshold(Ljava/math/BigDecimal;)V
    ...
    invoke-virtual {v0, v5}, Lcom/android/server/display/config/ThresholdPoint;->setPercentage(Ljava/math/BigDecimal;)V
    ...
    const-string v5, "ThresholdPoint is not closed"
...
.method public final getPercentage()Ljava/math/BigDecimal;
    ...
    .line 23
    iget-object v0, p0, Lcom/android/server/display/config/ThresholdPoint;->percentage:Ljava/math/BigDecimal;
...
.method public final getThreshold()Ljava/math/BigDecimal;
    ...
    .line 8
    iget-object v0, p0, Lcom/android/server/display/config/ThresholdPoint;->threshold:Ljava/math/BigDecimal;

    return-object v0
.end method

.method hasPercentage()Z
    .locals 1
...
.method public final setPercentage(Ljava/math/BigDecimal;)V
    .locals 0
    .param p1, "percentage"    # Ljava/math/BigDecimal;
        .annotation build Landroid/annotation/NonNull;
        .end annotation
    .end param
...
.method public final setThreshold(Ljava/math/BigDecimal;)V
    .locals 0
    .param p1, "threshold"    # Ljava/math/BigDecimal;
        .annotation build Landroid/annotation/NonNull;
        .end annotation
    .end param
