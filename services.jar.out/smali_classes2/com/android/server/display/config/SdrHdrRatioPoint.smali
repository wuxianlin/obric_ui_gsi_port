...
# instance fields
.field private hdrRatio:Ljava/math/BigDecimal;
    .annotation build Landroid/annotation/NonNull;
    .end annotation
.end field

.field private sdrNits:Ljava/math/BigDecimal;
    .annotation build Landroid/annotation/NonNull;
    .end annotation
.end field
...
.method static read(Lorg/xmlpull/v1/XmlPullParser;)Lcom/android/server/display/config/SdrHdrRatioPoint;
    .locals 7
    ...
    .line 39
    .local v0, "_instance":Lcom/android/server/display/config/SdrHdrRatioPoint;
    const/4 v1, 0x0
    ...
    invoke-virtual {v0, v5}, Lcom/android/server/display/config/SdrHdrRatioPoint;->setSdrNits(Ljava/math/BigDecimal;)V
    ...
    :cond_1
    const-string/jumbo v5, "hdrRatio"
    ...
    invoke-virtual {v0, v5}, Lcom/android/server/display/config/SdrHdrRatioPoint;->setHdrRatio(Ljava/math/BigDecimal;)V
    ...
    const-string v5, "SdrHdrRatioPoint is not closed"
...
.method public final getHdrRatio()Ljava/math/BigDecimal;
    ...
    .line 23
    iget-object v0, p0, Lcom/android/server/display/config/SdrHdrRatioPoint;->hdrRatio:Ljava/math/BigDecimal;
...
.method public final getSdrNits()Ljava/math/BigDecimal;
    ...
    .line 8
    iget-object v0, p0, Lcom/android/server/display/config/SdrHdrRatioPoint;->sdrNits:Ljava/math/BigDecimal;

    return-object v0
.end method

.method hasHdrRatio()Z
    .locals 1
...
.method public final setHdrRatio(Ljava/math/BigDecimal;)V
    .locals 0
    .param p1, "hdrRatio"    # Ljava/math/BigDecimal;
        .annotation build Landroid/annotation/NonNull;
        .end annotation
    .end param
...
.method public final setSdrNits(Ljava/math/BigDecimal;)V
    .locals 0
    .param p1, "sdrNits"    # Ljava/math/BigDecimal;
        .annotation build Landroid/annotation/NonNull;
        .end annotation
    .end param
