...
.method querySince(J)Z
    ...
    .local v2, "type":I
    invoke-direct {v1, v0, v13, v14, v2}, Lcom/android/server/people/data/SmsQueryHelper;->addEvent(Ljava/lang/String;JI)Z
    ...
    .end local v12    # "hasResults":Z
    .local v3, "hasResults":Z
    goto :goto_2

    .line 96
    .end local v2    # "type":I
    .end local v3    # "hasResults":Z
    .restart local v12    # "hasResults":Z
