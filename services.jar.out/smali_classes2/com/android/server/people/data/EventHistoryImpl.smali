...
# direct methods
.method public static synthetic $r8$lambda$hAiy-YwVfvqOWISrmcvCHvZADVg(Lcom/android/server/people/data/EventHistoryImpl;)V
    .locals 0
...
.method public static synthetic $r8$lambda$nQTxefT1kWveqCuO85tnZPddb28(Ljava/io/File;Ljava/lang/String;)Z
    .locals 0
...
.method private declared-synchronized addEventInMemory(Lcom/android/server/people/data/Event;)V
    ...
    .line 212
    .restart local v0    # "eventIndex":Lcom/android/server/people/data/EventIndex;
    .restart local p1    # "event":Lcom/android/server/people/data/Event;
    :cond_0
    :goto_0
...
.method static eventHistoriesImplFromDisk(Lcom/android/server/people/data/EventHistoryImpl$Injector;Ljava/io/File;Ljava/util/concurrent/ScheduledExecutorService;)Ljava/util/Map;
    ...
    new-instance v5, Lcom/android/server/people/data/EventHistoryImpl$$ExternalSyntheticLambda1;

    invoke-direct {v5}, Lcom/android/server/people/data/EventHistoryImpl$$ExternalSyntheticLambda1;-><init>()V
...
.method private static synthetic lambda$eventHistoriesImplFromDisk$0(Ljava/io/File;Ljava/lang/String;)Z
    .locals 1
...
.method private synthetic lambda$loadFromDisk$1()V
    ...
    .line 135
    .restart local v0    # "diskEvents":Lcom/android/server/people/data/EventList;
    :cond_0
    :goto_0
...
.method public declared-synchronized getEventIndex(Ljava/util/Set;)Lcom/android/server/people/data/EventIndex;
    ...
    .line 171
    .restart local v0    # "combined":Lcom/android/server/people/data/EventIndex;
    .restart local p1    # "eventTypes":Ljava/util/Set;, "Ljava/util/Set<Ljava/lang/Integer;>;"
    :cond_0
    :goto_1
    goto :goto_0
