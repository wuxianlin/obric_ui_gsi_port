...
.method handlePackageBroadcast(Landroid/content/Intent;)V
    ...
    .line 73
    .local v8, "userId":I
    iget-object v2, p0, Lcom/android/server/signedconfig/SignedConfigService;->mPacMan:Landroid/content/pm/PackageManagerInternal;
    ...
    const-string v5, "Got null PackageInfo for "
    ...
    .line 84
    :cond_3
    const-string v5, "android.settings.global"
    ...
    .line 85
    const-string v6, "android.settings.global.signature"
    ...
    .line 86
    new-instance v7, Lcom/android/server/signedconfig/SignedConfigEvent;

    invoke-direct {v7}, Lcom/android/server/signedconfig/SignedConfigEvent;-><init>()V

    .line 88
    .local v7, "event":Lcom/android/server/signedconfig/SignedConfigEvent;
    const/4 v9, 0x1

    :try_start_0
    iput v9, v7, Lcom/android/server/signedconfig/SignedConfigEvent;->type:I

    .line 89
    iput-object v1, v7, Lcom/android/server/signedconfig/SignedConfigEvent;->fromPackage:Ljava/lang/String;
    ...
    invoke-virtual {v10, v5}, Ljava/util/Base64$Decoder;->decode(Ljava/lang/String;)[B
    ...
    .line 106
    :try_start_2
    new-instance v5, Lcom/android/server/signedconfig/GlobalSettingsConfigApplicator;

    iget-object v9, p0, Lcom/android/server/signedconfig/SignedConfigService;->mContext:Landroid/content/Context;

    invoke-direct {v5, v9, v1, v7}, Lcom/android/server/signedconfig/GlobalSettingsConfigApplicator;-><init>(Landroid/content/Context;Ljava/lang/String;Lcom/android/server/signedconfig/SignedConfigEvent;)V

    invoke-virtual {v5, v3, v6}, Lcom/android/server/signedconfig/GlobalSettingsConfigApplicator;->applyConfig(Ljava/lang/String;Ljava/lang/String;)V
    :try_end_2
    ...
    invoke-virtual {v7}, Lcom/android/server/signedconfig/SignedConfigEvent;->send()V
    ...
    iput v3, v7, Lcom/android/server/signedconfig/SignedConfigEvent;->status:I
    :try_end_3
    ...
    .line 114
    .end local v7    # "event":Lcom/android/server/signedconfig/SignedConfigEvent;
    :cond_4
    :goto_2
    return-void
.end method
