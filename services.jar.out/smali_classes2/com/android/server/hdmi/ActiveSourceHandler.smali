...
.method process(Lcom/android/server/hdmi/HdmiCecLocalDevice$ActiveSource;I)V
    ...
    const-string v3, "ActiveSourceHandler"
    ...
    invoke-virtual {v0, p1, v3}, Lcom/android/server/hdmi/HdmiCecLocalDeviceTv;->updateActiveSource(Lcom/android/server/hdmi/HdmiCecLocalDevice$ActiveSource;Ljava/lang/String;)V
    ...
    invoke-static {v5, v6}, Lcom/android/server/hdmi/HdmiCecMessageBuilder;->buildActiveSource(II)Lcom/android/server/hdmi/HdmiCecMessage;

    move-result-object v5

    .line 87
    .local v5, "activeSourceCommand":Lcom/android/server/hdmi/HdmiCecMessage;
    iget-object v6, p0, Lcom/android/server/hdmi/ActiveSourceHandler;->mService:Lcom/android/server/hdmi/HdmiControlService;

    invoke-virtual {v6, v5}, Lcom/android/server/hdmi/HdmiControlService;->sendCecCommand(Lcom/android/server/hdmi/HdmiCecMessage;)V

    .line 88
    invoke-virtual {v0, v2, v3}, Lcom/android/server/hdmi/HdmiCecLocalDeviceTv;->updateActiveSource(Lcom/android/server/hdmi/HdmiCecLocalDevice$ActiveSource;Ljava/lang/String;)V

    .line 89
    invoke-direct {p0, v4}, Lcom/android/server/hdmi/ActiveSourceHandler;->invokeCallback(I)V

    .line 90
    .end local v5    # "activeSourceCommand":Lcom/android/server/hdmi/HdmiCecMessage;
    goto :goto_1

    .line 91
    :cond_4
    iget v3, p1, Lcom/android/server/hdmi/HdmiCecLocalDevice$ActiveSource;->physicalAddress:I
    ...
    invoke-virtual {v0, v3, v4, v5}, Lcom/android/server/hdmi/HdmiCecLocalDeviceTv;->startRoutingControl(IILandroid/hardware/hdmi/IHdmiControlCallback;)V
