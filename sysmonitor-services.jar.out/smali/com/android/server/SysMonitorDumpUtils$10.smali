.class Lcom/android/server/SysMonitorDumpUtils$10;
...
# direct methods
.method constructor <init>(Lcom/android/server/SysMonitorDumpUtils;IILjava/lang/String;Lcom/android/server/SysMonitorDumpUtils$EventConfigInfo;J)V
    .locals 0
    ...
    .line 2349
    iput-object p1, p0, Lcom/android/server/SysMonitorDumpUtils$10;->this$0:Lcom/android/server/SysMonitorDumpUtils;

    iput p2, p0, Lcom/android/server/SysMonitorDumpUtils$10;->val$eventCode:I

    iput p3, p0, Lcom/android/server/SysMonitorDumpUtils$10;->val$reasonCode:I

    iput-object p4, p0, Lcom/android/server/SysMonitorDumpUtils$10;->val$outFilePath:Ljava/lang/String;

    iput-object p5, p0, Lcom/android/server/SysMonitorDumpUtils$10;->val$eventConfigInfo:Lcom/android/server/SysMonitorDumpUtils$EventConfigInfo;

    iput-wide p6, p0, Lcom/android/server/SysMonitorDumpUtils$10;->val$currentTime:J
...
.method public run()V
    ...
    .line 2353
    const-string v0, " DumpAtrace reportException finally"
    ...
    :try_start_0
    iget-object v4, p0, Lcom/android/server/SysMonitorDumpUtils$10;->this$0:Lcom/android/server/SysMonitorDumpUtils;

    iget v5, p0, Lcom/android/server/SysMonitorDumpUtils$10;->val$eventCode:I

    iget v6, p0, Lcom/android/server/SysMonitorDumpUtils$10;->val$reasonCode:I

    iget-object v7, p0, Lcom/android/server/SysMonitorDumpUtils$10;->val$outFilePath:Ljava/lang/String;

    invoke-static {v4, v5, v6, v3, v7}, Lcom/android/server/SysMonitorDumpUtils;->-$$Nest$mdumpAtraceEvent(Lcom/android/server/SysMonitorDumpUtils;IIZLjava/lang/String;)V

    .line 2354
    const-string v4, "DumpAtrace ReportEvent success"
    ...
    .line 2359
    iget-object v4, p0, Lcom/android/server/SysMonitorDumpUtils$10;->val$eventConfigInfo:Lcom/android/server/SysMonitorDumpUtils$EventConfigInfo;
    ...
    iget-object v5, p0, Lcom/android/server/SysMonitorDumpUtils$10;->val$eventConfigInfo:Lcom/android/server/SysMonitorDumpUtils$EventConfigInfo;
    ...
    .line 2364
    iget-object v0, p0, Lcom/android/server/SysMonitorDumpUtils$10;->val$eventConfigInfo:Lcom/android/server/SysMonitorDumpUtils$EventConfigInfo;

    iget-wide v3, p0, Lcom/android/server/SysMonitorDumpUtils$10;->val$currentTime:J
    ...
    iget v1, p0, Lcom/android/server/SysMonitorDumpUtils$10;->val$eventCode:I

    invoke-static {v1}, Ljava/lang/Integer;->valueOf(I)Ljava/lang/Integer;

    move-result-object v1

    iget-object v2, p0, Lcom/android/server/SysMonitorDumpUtils$10;->val$eventConfigInfo:Lcom/android/server/SysMonitorDumpUtils$EventConfigInfo;
    ...
    const-string v6, "DumpAtrace reportException Exception "
    ...
    .line 2358
    :goto_2
    iget-object v5, p0, Lcom/android/server/SysMonitorDumpUtils$10;->this$0:Lcom/android/server/SysMonitorDumpUtils;
    ...
    iget-object v6, p0, Lcom/android/server/SysMonitorDumpUtils$10;->val$eventConfigInfo:Lcom/android/server/SysMonitorDumpUtils$EventConfigInfo;
    ...
    iget-wide v5, p0, Lcom/android/server/SysMonitorDumpUtils$10;->val$currentTime:J
