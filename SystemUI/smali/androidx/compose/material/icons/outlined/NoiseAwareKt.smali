...
.method public static final getNoiseAware(Landroidx/compose/material/icons/Icons$Outlined;)Landroidx/compose/ui/graphics/vector/ImageVector;
    ...
    .line 29
    :cond_0
    const-string v0, "Outlined.NoiseAware"
    ...
    .local v16, "$this$_get_NoiseAware__u24lambda_u2416_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/16 v34, 0x0

    .line 31
    .local v34, "$i$a$-materialPath-YwgOQQI$default-NoiseAwareKt$NoiseAware$1$1":I
    ...
    .local v36, "$i$a$-materialIcon$default-NoiseAwareKt$NoiseAware$1":I
    ...
    .end local v16    # "$this$_get_NoiseAware__u24lambda_u2416_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .local v3, "$this$_get_NoiseAware__u24lambda_u2416_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    .end local v3    # "$this$_get_NoiseAware__u24lambda_u2416_u24lambda_u240":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v34    # "$i$a$-materialPath-YwgOQQI$default-NoiseAwareKt$NoiseAware$1$1":I
    ...
    .local v11, "$this$_get_NoiseAware__u24lambda_u2416_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/4 v12, 0x0

    .line 51
    .local v12, "$i$a$-materialPath-YwgOQQI$default-NoiseAwareKt$NoiseAware$1$2":I
    ...
    .end local v11    # "$this$_get_NoiseAware__u24lambda_u2416_u24lambda_u241":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v12    # "$i$a$-materialPath-YwgOQQI$default-NoiseAwareKt$NoiseAware$1$2":I
    sget-object v0, Lkotlin/Unit;->INSTANCE:Lkotlin/Unit;
    ...
    .local v11, "$this$_get_NoiseAware__u24lambda_u2416_u24lambda_u242":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/4 v12, 0x0

    .line 57
    .local v12, "$i$a$-materialPath-YwgOQQI$default-NoiseAwareKt$NoiseAware$1$3":I
    ...
    .end local v11    # "$this$_get_NoiseAware__u24lambda_u2416_u24lambda_u242":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v12    # "$i$a$-materialPath-YwgOQQI$default-NoiseAwareKt$NoiseAware$1$3":I
    sget-object v0, Lkotlin/Unit;->INSTANCE:Lkotlin/Unit;
    ...
    .local v11, "$this$_get_NoiseAware__u24lambda_u2416_u24lambda_u243":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/4 v12, 0x0

    .line 65
    .local v12, "$i$a$-materialPath-YwgOQQI$default-NoiseAwareKt$NoiseAware$1$4":I
    ...
    .end local v11    # "$this$_get_NoiseAware__u24lambda_u2416_u24lambda_u243":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v12    # "$i$a$-materialPath-YwgOQQI$default-NoiseAwareKt$NoiseAware$1$4":I
    sget-object v0, Lkotlin/Unit;->INSTANCE:Lkotlin/Unit;
    ...
    .local v11, "$this$_get_NoiseAware__u24lambda_u2416_u24lambda_u244":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/4 v12, 0x0

    .line 73
    .local v12, "$i$a$-materialPath-YwgOQQI$default-NoiseAwareKt$NoiseAware$1$5":I
    ...
    .end local v11    # "$this$_get_NoiseAware__u24lambda_u2416_u24lambda_u244":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v12    # "$i$a$-materialPath-YwgOQQI$default-NoiseAwareKt$NoiseAware$1$5":I
    sget-object v0, Lkotlin/Unit;->INSTANCE:Lkotlin/Unit;
    ...
    .local v11, "$this$_get_NoiseAware__u24lambda_u2416_u24lambda_u247":Landroidx/compose/ui/graphics/vector/PathBuilder;
    const/4 v12, 0x0

    .line 97
    .local v12, "$i$a$-materialPath-YwgOQQI$default-NoiseAwareKt$NoiseAware$1$8":I
    ...
    .end local v11    # "$this$_get_NoiseAware__u24lambda_u2416_u24lambda_u247":Landroidx/compose/ui/graphics/vector/PathBuilder;
    .end local v12    # "$i$a$-materialPath-YwgOQQI$default-NoiseAwareKt$NoiseAware$1$8":I
    sget-object v0, Lkotlin/Unit;->INSTANCE:Lkotlin/Unit;
    ...
    .end local v3    # "strokeAlpha$iv":F
    .restart local v24    # "strokeAlpha$iv":F
    ...
    .line 129
    const v20, 0x419c147b    # 19.51f

    const v21, 0x416bd70a    # 14.74f

    const v16, 0x419f1eb8    # 19.89f

    const v17, 0x4157851f    # 13.47f

    const v18, 0x419dd70a    # 19.73f
    ...
    const v21, 0x41335c29    # 11.21f

    const v16, 0x419dd70a    # 19.73f

    const v17, 0x411e147b    # 9.88f

    const v18, 0x419f1eb8    # 19.89f

    const v19, 0x41287ae1    # 10.53f
    ...
    .line 145
    const v20, 0x418ca3d7    # 17.58f

    const v21, 0x418dd70a    # 17.73f

    const v16, 0x4193c28f    # 18.47f
    ...
    .end local v36    # "$i$a$-materialIcon$default-NoiseAwareKt$NoiseAware$1":I
