...
.method public final addOverflowComposables$foundation_layout_release(Landroidx/compose/foundation/layout/FlowLayoutOverflowState;Ljava/util/List;)V
    ...
    .line 678
    .local v0, "expandIndicator":Lkotlin/jvm/functions/Function2;
    ...
    .line 907
    .local v1, "getter":Lkotlin/jvm/functions/Function1;
    const/4 v2, 0x0

    .line 678
    .local v2, "$i$a$-let-FlowLayoutOverflow$addOverflowComposables$collapseIndicator$1":I
    ...
    .line 680
    .end local v2    # "$i$a$-let-FlowLayoutOverflow$addOverflowComposables$collapseIndicator$1":I
    .local v1, "collapseIndicator":Lkotlin/jvm/functions/Function2;
    :cond_1
    iget-object v2, p0, Landroidx/compose/foundation/layout/FlowLayoutOverflow;->type:Landroidx/compose/foundation/layout/FlowLayoutOverflow$OverflowType;

    sget-object v3, Landroidx/compose/foundation/layout/FlowLayoutOverflow$WhenMappings;->$EnumSwitchMapping$0:[I

    invoke-virtual {v2}, Landroidx/compose/foundation/layout/FlowLayoutOverflow$OverflowType;->ordinal()I
    ...
    .line 683
    .local v3, "$i$a$-let-FlowLayoutOverflow$addOverflowComposables$2":I
    invoke-interface {p2, v0}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    .line 684
    .end local v2    # "it":Lkotlin/jvm/functions/Function2;
    .end local v3    # "$i$a$-let-FlowLayoutOverflow$addOverflowComposables$2":I
    :cond_2
    if-eqz v1, :cond_3
    ...
    .line 684
    .local v3, "$i$a$-let-FlowLayoutOverflow$addOverflowComposables$3":I
    invoke-interface {p2, v1}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    .end local v2    # "it":Lkotlin/jvm/functions/Function2;
    .end local v3    # "$i$a$-let-FlowLayoutOverflow$addOverflowComposables$3":I
    goto :goto_1
    ...
    .line 681
    .local v3, "$i$a$-let-FlowLayoutOverflow$addOverflowComposables$1":I
    invoke-interface {p2, v0}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    .line 688
    .end local v2    # "it":Lkotlin/jvm/functions/Function2;
    .end local v3    # "$i$a$-let-FlowLayoutOverflow$addOverflowComposables$1":I
    :cond_3
    :goto_1
    return-void
