...
.method public final getAndMeasure(I)Landroidx/compose/foundation/lazy/grid/LazyGridMeasuredLine;
    ...
    iget v6, v0, Landroidx/compose/foundation/lazy/grid/LazyGridMeasuredLineProvider;->gridItemsCount:I
    ...
    .line 65
    :cond_0
    iget v5, v0, Landroidx/compose/foundation/lazy/grid/LazyGridMeasuredLineProvider;->spaceBetweenLines:I
    ...
    .line 68
    .local v5, "mainAxisSpacing":I
    const/4 v6, 0x0

    .line 69
    .local v6, "startSlot":I
    new-array v13, v3, [Landroidx/compose/foundation/lazy/grid/LazyGridMeasuredItem;

    move v14, v6

    .end local v6    # "startSlot":I
    .local v14, "startSlot":I
    :goto_2
    if-ge v4, v3, :cond_2
    ...
    .line 71
    .local v15, "span":I
    invoke-virtual {v0, v14, v15}, Landroidx/compose/foundation/lazy/grid/LazyGridMeasuredLineProvider;->childConstraints-JhjzzOo$foundation_release(II)J

    move-result-wide v16

    .line 72
    .local v16, "constraints":J
    iget-object v6, v0, Landroidx/compose/foundation/lazy/grid/LazyGridMeasuredLineProvider;->measuredItemProvider:Landroidx/compose/foundation/lazy/grid/LazyGridMeasuredItemProvider;
    ...
    invoke-virtual/range {v6 .. v12}, Landroidx/compose/foundation/lazy/grid/LazyGridMeasuredItemProvider;->getAndMeasure-m8Kt_7k(IJIII)Landroidx/compose/foundation/lazy/grid/LazyGridMeasuredItem;
    ...
    .local v7, "it":Landroidx/compose/foundation/lazy/grid/LazyGridMeasuredItem;
    const/4 v8, 0x0

    .line 78
    .local v8, "$i$a$-also-LazyGridMeasuredLineProvider$getAndMeasure$items$1$1":I
    add-int/2addr v14, v15

    .end local v7    # "it":Landroidx/compose/foundation/lazy/grid/LazyGridMeasuredItem;
    .end local v8    # "$i$a$-also-LazyGridMeasuredLineProvider$getAndMeasure$items$1$1":I
    ...
    .line 80
    .local v4, "items":[Landroidx/compose/foundation/lazy/grid/LazyGridMeasuredItem;
    nop
    ...
    .line 80
    invoke-virtual {v0, v1, v4, v6, v5}, Landroidx/compose/foundation/lazy/grid/LazyGridMeasuredLineProvider;->createLine(I[Landroidx/compose/foundation/lazy/grid/LazyGridMeasuredItem;Ljava/util/List;I)Landroidx/compose/foundation/lazy/grid/LazyGridMeasuredLine;
