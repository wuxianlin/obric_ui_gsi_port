...
.method public final invoke(Lkotlinx/coroutines/CoroutineScope;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    check-cast v0, Landroidx/compose/foundation/gestures/Draggable2DNode$onDragStopped$1;

    sget-object v1, Lkotlin/Unit;->INSTANCE:Lkotlin/Unit;

    invoke-virtual {v0, v1}, Landroidx/compose/foundation/gestures/Draggable2DNode$onDragStopped$1;->invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
...
.method public final invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .local v0, "this":Landroidx/compose/foundation/gestures/Draggable2DNode$onDragStopped$1;
    .local p1, "$result":Ljava/lang/Object;
    invoke-static {p1}, Lkotlin/ResultKt;->throwOnFailure(Ljava/lang/Object;)V

    goto :goto_0

    .end local v0    # "this":Landroidx/compose/foundation/gestures/Draggable2DNode$onDragStopped$1;
    ...
    .local v1, "this":Landroidx/compose/foundation/gestures/Draggable2DNode$onDragStopped$1;
    .restart local p1    # "$result":Ljava/lang/Object;
    iget-object v2, v1, Landroidx/compose/foundation/gestures/Draggable2DNode$onDragStopped$1;->L$0:Ljava/lang/Object;

    check-cast v2, Lkotlinx/coroutines/CoroutineScope;

    .line 436
    .local v2, "$this$launch":Lkotlinx/coroutines/CoroutineScope;
    iget-object v3, v1, Landroidx/compose/foundation/gestures/Draggable2DNode$onDragStopped$1;->this$0:Landroidx/compose/foundation/gestures/Draggable2DNode;

    invoke-static {v3}, Landroidx/compose/foundation/gestures/Draggable2DNode;->access$getOnDragStopped$p(Landroidx/compose/foundation/gestures/Draggable2DNode;)Lkotlin/jvm/functions/Function3;

    move-result-object v3

    iget-object v4, v1, Landroidx/compose/foundation/gestures/Draggable2DNode$onDragStopped$1;->this$0:Landroidx/compose/foundation/gestures/Draggable2DNode;

    iget-wide v5, v1, Landroidx/compose/foundation/gestures/Draggable2DNode$onDragStopped$1;->$velocity:J

    invoke-static {v4, v5, v6}, Landroidx/compose/foundation/gestures/Draggable2DNode;->access$reverseIfNeeded-AH228Gc(Landroidx/compose/foundation/gestures/Draggable2DNode;J)J
    ...
    iput v5, v1, Landroidx/compose/foundation/gestures/Draggable2DNode$onDragStopped$1;->label:I
    ...
    .line 437
    .end local v1    # "this":Landroidx/compose/foundation/gestures/Draggable2DNode$onDragStopped$1;
    .restart local v0    # "this":Landroidx/compose/foundation/gestures/Draggable2DNode$onDragStopped$1;
    :goto_0
    sget-object v1, Lkotlin/Unit;->INSTANCE:Lkotlin/Unit;
