...
.method public final invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .local v0, "this":Landroidx/window/area/WindowAreaControllerImpl$transferActivityToWindowArea$2;
    .local p1, "$result":Ljava/lang/Object;
    invoke-static {p1}, Lkotlin/ResultKt;->throwOnFailure(Ljava/lang/Object;)V

    goto :goto_0

    .end local v0    # "this":Landroidx/window/area/WindowAreaControllerImpl$transferActivityToWindowArea$2;
    ...
    .line 217
    .local v1, "this":Landroidx/window/area/WindowAreaControllerImpl$transferActivityToWindowArea$2;
    .restart local p1    # "$result":Ljava/lang/Object;
    iget-object v2, v1, Landroidx/window/area/WindowAreaControllerImpl$transferActivityToWindowArea$2;->this$0:Landroidx/window/area/WindowAreaControllerImpl;
    ...
    iput v4, v1, Landroidx/window/area/WindowAreaControllerImpl$transferActivityToWindowArea$2;->label:I
    ...
    .line 218
    .end local v1    # "this":Landroidx/window/area/WindowAreaControllerImpl$transferActivityToWindowArea$2;
    .restart local v0    # "this":Landroidx/window/area/WindowAreaControllerImpl$transferActivityToWindowArea$2;
    :goto_0
    iget-object v1, v0, Landroidx/window/area/WindowAreaControllerImpl$transferActivityToWindowArea$2;->this$0:Landroidx/window/area/WindowAreaControllerImpl;

    iget-object v2, v0, Landroidx/window/area/WindowAreaControllerImpl$transferActivityToWindowArea$2;->$activity:Landroid/app/Activity;

    iget-object v3, v0, Landroidx/window/area/WindowAreaControllerImpl$transferActivityToWindowArea$2;->$executor:Ljava/util/concurrent/Executor;

    iget-object v4, v0, Landroidx/window/area/WindowAreaControllerImpl$transferActivityToWindowArea$2;->$windowAreaSessionCallback:Landroidx/window/area/WindowAreaSessionCallback;

    invoke-static {v1, v2, v3, v4}, Landroidx/window/area/WindowAreaControllerImpl;->access$startRearDisplayMode(Landroidx/window/area/WindowAreaControllerImpl;Landroid/app/Activity;Ljava/util/concurrent/Executor;Landroidx/window/area/WindowAreaSessionCallback;)V
