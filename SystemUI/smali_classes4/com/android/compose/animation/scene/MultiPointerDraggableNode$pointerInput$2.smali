...
.method public final create(Ljava/lang/Object;Lkotlin/coroutines/Continuation;)Lkotlin/coroutines/Continuation;
    ...
    iget-object v2, p0, Lcom/android/compose/animation/scene/MultiPointerDraggableNode$pointerInput$2;->this$0:Lcom/android/compose/animation/scene/MultiPointerDraggableNode;

    invoke-direct {v0, v1, v2, p2}, Lcom/android/compose/animation/scene/MultiPointerDraggableNode$pointerInput$2;-><init>(Landroidx/compose/ui/input/pointer/PointerInputScope;Lcom/android/compose/animation/scene/MultiPointerDraggableNode;Lkotlin/coroutines/Continuation;)V
...
.method public final invoke(Lkotlinx/coroutines/CoroutineScope;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    check-cast v0, Lcom/android/compose/animation/scene/MultiPointerDraggableNode$pointerInput$2;

    sget-object v1, Lkotlin/Unit;->INSTANCE:Lkotlin/Unit;

    invoke-virtual {v0, v1}, Lcom/android/compose/animation/scene/MultiPointerDraggableNode$pointerInput$2;->invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
...
.method public final invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .local v0, "this":Lcom/android/compose/animation/scene/MultiPointerDraggableNode$pointerInput$2;
    .local p1, "$result":Ljava/lang/Object;
    invoke-static {p1}, Lkotlin/ResultKt;->throwOnFailure(Ljava/lang/Object;)V

    goto :goto_0

    .end local v0    # "this":Lcom/android/compose/animation/scene/MultiPointerDraggableNode$pointerInput$2;
    ...
    .local v1, "this":Lcom/android/compose/animation/scene/MultiPointerDraggableNode$pointerInput$2;
    .restart local p1    # "$result":Ljava/lang/Object;
    iget-object v2, v1, Lcom/android/compose/animation/scene/MultiPointerDraggableNode$pointerInput$2;->L$0:Ljava/lang/Object;

    check-cast v2, Lkotlinx/coroutines/CoroutineScope;

    .line 179
    .local v2, "$this$coroutineScope":Lkotlinx/coroutines/CoroutineScope;
    iget-object v3, v1, Lcom/android/compose/animation/scene/MultiPointerDraggableNode$pointerInput$2;->$this_pointerInput:Landroidx/compose/ui/input/pointer/PointerInputScope;

    new-instance v4, Lcom/android/compose/animation/scene/MultiPointerDraggableNode$pointerInput$2$1;

    iget-object v5, v1, Lcom/android/compose/animation/scene/MultiPointerDraggableNode$pointerInput$2;->this$0:Lcom/android/compose/animation/scene/MultiPointerDraggableNode;

    const/4 v6, 0x0

    invoke-direct {v4, v2, v5, v6}, Lcom/android/compose/animation/scene/MultiPointerDraggableNode$pointerInput$2$1;-><init>(Lkotlinx/coroutines/CoroutineScope;Lcom/android/compose/animation/scene/MultiPointerDraggableNode;Lkotlin/coroutines/Continuation;)V
    ...
    iput v6, v1, Lcom/android/compose/animation/scene/MultiPointerDraggableNode$pointerInput$2;->label:I
    ...
    .line 220
    .end local v1    # "this":Lcom/android/compose/animation/scene/MultiPointerDraggableNode$pointerInput$2;
    .restart local v0    # "this":Lcom/android/compose/animation/scene/MultiPointerDraggableNode$pointerInput$2;
    :goto_0
    sget-object v1, Lkotlin/Unit;->INSTANCE:Lkotlin/Unit;
