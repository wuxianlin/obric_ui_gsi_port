...
.method public final create(Ljava/lang/Object;Lkotlin/coroutines/Continuation;)Lkotlin/coroutines/Continuation;
    ...
    iget-object v3, p0, Lcom/android/systemui/media/controls/ui/binder/MediaRecommendationsViewBinder$bind$2$1$1$1$1;->$falsingManager:Lcom/android/systemui/plugins/FalsingManager;
...
.method public final invoke(Lcom/android/systemui/media/controls/ui/viewmodel/MediaRecsCardViewModel;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    check-cast v0, Lcom/android/systemui/media/controls/ui/binder/MediaRecommendationsViewBinder$bind$2$1$1$1$1;

    sget-object v1, Lkotlin/Unit;->INSTANCE:Lkotlin/Unit;

    invoke-virtual {v0, v1}, Lcom/android/systemui/media/controls/ui/binder/MediaRecommendationsViewBinder$bind$2$1$1$1$1;->invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
...
.method public final invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .local v0, "this":Lcom/android/systemui/media/controls/ui/binder/MediaRecommendationsViewBinder$bind$2$1$1$1$1;
    .local p1, "$result":Ljava/lang/Object;
    iget-object v1, v0, Lcom/android/systemui/media/controls/ui/binder/MediaRecommendationsViewBinder$bind$2$1$1$1$1;->L$0:Ljava/lang/Object;

    check-cast v1, Lcom/android/systemui/media/controls/ui/viewmodel/MediaRecsCardViewModel;

    .line 61
    .local v1, "viewModel":Lcom/android/systemui/media/controls/ui/viewmodel/MediaRecsCardViewModel;
    if-eqz v1, :cond_0

    iget-object v2, v0, Lcom/android/systemui/media/controls/ui/binder/MediaRecommendationsViewBinder$bind$2$1$1$1$1;->$viewHolder:Lcom/android/systemui/media/controls/ui/view/RecommendationViewHolder;

    iget-object v3, v0, Lcom/android/systemui/media/controls/ui/binder/MediaRecommendationsViewBinder$bind$2$1$1$1$1;->$mediaViewController:Lcom/android/systemui/media/controls/ui/controller/MediaViewController;

    iget-object v4, v0, Lcom/android/systemui/media/controls/ui/binder/MediaRecommendationsViewBinder$bind$2$1$1$1$1;->$falsingManager:Lcom/android/systemui/plugins/FalsingManager;

    .local v1, "it":Lcom/android/systemui/media/controls/ui/viewmodel/MediaRecsCardViewModel;
    const/4 v5, 0x0

    .line 62
    .local v5, "$i$a$-let-MediaRecommendationsViewBinder$bind$2$1$1$1$1$1":I
    sget-object v6, Lcom/android/systemui/media/controls/ui/binder/MediaRecommendationsViewBinder;->INSTANCE:Lcom/android/systemui/media/controls/ui/binder/MediaRecommendationsViewBinder;

    invoke-virtual {v6, v2, v1, v3, v4}, Lcom/android/systemui/media/controls/ui/binder/MediaRecommendationsViewBinder;->bindRecsCard(Lcom/android/systemui/media/controls/ui/view/RecommendationViewHolder;Lcom/android/systemui/media/controls/ui/viewmodel/MediaRecsCardViewModel;Lcom/android/systemui/media/controls/ui/controller/MediaViewController;Lcom/android/systemui/plugins/FalsingManager;)V

    .line 63
    nop

    .line 61
    .end local v1    # "it":Lcom/android/systemui/media/controls/ui/viewmodel/MediaRecsCardViewModel;
    .end local v5    # "$i$a$-let-MediaRecommendationsViewBinder$bind$2$1$1$1$1$1":I
    nop
