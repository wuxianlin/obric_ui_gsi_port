...
.method public final invoke(Lkotlinx/coroutines/CoroutineScope;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    check-cast v0, Lcom/android/systemui/media/controls/ui/binder/MediaControlViewBinder$bind$1$1;

    sget-object v1, Lkotlin/Unit;->INSTANCE:Lkotlin/Unit;

    invoke-virtual {v0, v1}, Lcom/android/systemui/media/controls/ui/binder/MediaControlViewBinder$bind$1$1;->invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
...
.method public final invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .local v0, "this":Lcom/android/systemui/media/controls/ui/binder/MediaControlViewBinder$bind$1$1;
    .local p1, "$result":Ljava/lang/Object;
    iget-object v1, v0, Lcom/android/systemui/media/controls/ui/binder/MediaControlViewBinder$bind$1$1;->L$0:Ljava/lang/Object;

    check-cast v1, Lkotlinx/coroutines/CoroutineScope;

    .line 84
    .local v1, "$this$repeatOnLifecycle":Lkotlinx/coroutines/CoroutineScope;
    new-instance v11, Lcom/android/systemui/media/controls/ui/binder/MediaControlViewBinder$bind$1$1$1;

    iget-object v3, v0, Lcom/android/systemui/media/controls/ui/binder/MediaControlViewBinder$bind$1$1;->$viewModel:Lcom/android/systemui/media/controls/ui/viewmodel/MediaControlViewModel;

    iget-object v4, v0, Lcom/android/systemui/media/controls/ui/binder/MediaControlViewBinder$bind$1$1;->$viewHolder:Lcom/android/systemui/media/controls/ui/view/MediaViewHolder;

    iget-object v5, v0, Lcom/android/systemui/media/controls/ui/binder/MediaControlViewBinder$bind$1$1;->$viewController:Lcom/android/systemui/media/controls/ui/controller/MediaViewController;

    iget-object v6, v0, Lcom/android/systemui/media/controls/ui/binder/MediaControlViewBinder$bind$1$1;->$falsingManager:Lcom/android/systemui/plugins/FalsingManager;

    iget-object v7, v0, Lcom/android/systemui/media/controls/ui/binder/MediaControlViewBinder$bind$1$1;->$backgroundDispatcher:Lkotlinx/coroutines/CoroutineDispatcher;

    iget-object v8, v0, Lcom/android/systemui/media/controls/ui/binder/MediaControlViewBinder$bind$1$1;->$mainDispatcher:Lkotlinx/coroutines/CoroutineDispatcher;

    iget-object v9, v0, Lcom/android/systemui/media/controls/ui/binder/MediaControlViewBinder$bind$1$1;->$mediaFlags:Lcom/android/systemui/media/controls/util/MediaFlags;

    const/4 v10, 0x0

    move-object v2, v11

    invoke-direct/range {v2 .. v10}, Lcom/android/systemui/media/controls/ui/binder/MediaControlViewBinder$bind$1$1$1;-><init>(Lcom/android/systemui/media/controls/ui/viewmodel/MediaControlViewModel;Lcom/android/systemui/media/controls/ui/view/MediaViewHolder;Lcom/android/systemui/media/controls/ui/controller/MediaViewController;Lcom/android/systemui/plugins/FalsingManager;Lkotlinx/coroutines/CoroutineDispatcher;Lkotlinx/coroutines/CoroutineDispatcher;Lcom/android/systemui/media/controls/util/MediaFlags;Lkotlin/coroutines/Continuation;)V
