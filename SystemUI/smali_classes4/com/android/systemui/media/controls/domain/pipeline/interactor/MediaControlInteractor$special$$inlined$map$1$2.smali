...
.method public final emit(Ljava/lang/Object;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    iget-object v0, p2, Lcom/android/systemui/media/controls/domain/pipeline/interactor/MediaControlInteractor$special$$inlined$map$1$2$1;->result:Ljava/lang/Object;
    ...
    .line 0
    iget v2, p2, Lcom/android/systemui/media/controls/domain/pipeline/interactor/MediaControlInteractor$special$$inlined$map$1$2$1;->label:I
    ...
    .line 53
    .local v2, "this":Lcom/android/systemui/media/controls/domain/pipeline/interactor/MediaControlInteractor$special$$inlined$map$1$2;
    .local p1, "value":Ljava/lang/Object;
    iget-object v3, v2, Lcom/android/systemui/media/controls/domain/pipeline/interactor/MediaControlInteractor$special$$inlined$map$1$2;->$this_unsafeFlow:Lkotlinx/coroutines/flow/FlowCollector;
    ...
    .local p1, "entries":Ljava/util/Map;
    const/4 v5, 0x0

    .line 224
    .local v5, "$i$a$-map-MediaControlInteractor$mediaControl$1":I
    iget-object v6, v2, Lcom/android/systemui/media/controls/domain/pipeline/interactor/MediaControlInteractor$special$$inlined$map$1$2;->this$0:Lcom/android/systemui/media/controls/domain/pipeline/interactor/MediaControlInteractor;

    invoke-static {v6}, Lcom/android/systemui/media/controls/domain/pipeline/interactor/MediaControlInteractor;->access$getInstanceId$p(Lcom/android/systemui/media/controls/domain/pipeline/interactor/MediaControlInteractor;)Lcom/android/internal/logging/InstanceId;
    ...
    .line 225
    .local p1, "it":Lcom/android/systemui/media/controls/shared/model/MediaData;
    const/4 v6, 0x0

    .line 224
    .local v6, "$i$a$-let-MediaControlInteractor$mediaControl$1$1":I
    iget-object v7, v2, Lcom/android/systemui/media/controls/domain/pipeline/interactor/MediaControlInteractor$special$$inlined$map$1$2;->this$0:Lcom/android/systemui/media/controls/domain/pipeline/interactor/MediaControlInteractor;

    invoke-static {v7, p1}, Lcom/android/systemui/media/controls/domain/pipeline/interactor/MediaControlInteractor;->access$toMediaControlModel(Lcom/android/systemui/media/controls/domain/pipeline/interactor/MediaControlInteractor;Lcom/android/systemui/media/controls/shared/model/MediaData;)Lcom/android/systemui/media/controls/shared/model/MediaControlModel;

    move-result-object p1

    .end local v2    # "this":Lcom/android/systemui/media/controls/domain/pipeline/interactor/MediaControlInteractor$special$$inlined$map$1$2;
    .end local v6    # "$i$a$-let-MediaControlInteractor$mediaControl$1$1":I
    .end local p1    # "it":Lcom/android/systemui/media/controls/shared/model/MediaData;
    goto :goto_1
    ...
    .line 223
    .end local v5    # "$i$a$-map-MediaControlInteractor$mediaControl$1":I
    :goto_1
    const/4 v2, 0x1

    iput v2, p2, Lcom/android/systemui/media/controls/domain/pipeline/interactor/MediaControlInteractor$special$$inlined$map$1$2$1;->label:I
