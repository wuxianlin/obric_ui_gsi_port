...
.method public final create(Ljava/lang/Object;Lkotlin/coroutines/Continuation;)Lkotlin/coroutines/Continuation;
    ...
    new-instance v0, Lcom/android/systemui/media/controls/domain/pipeline/MediaDataProcessor$allowMediaRecommendations$2;

    iget-object v1, p0, Lcom/android/systemui/media/controls/domain/pipeline/MediaDataProcessor$allowMediaRecommendations$2;->this$0:Lcom/android/systemui/media/controls/domain/pipeline/MediaDataProcessor;

    invoke-direct {v0, v1, p2}, Lcom/android/systemui/media/controls/domain/pipeline/MediaDataProcessor$allowMediaRecommendations$2;-><init>(Lcom/android/systemui/media/controls/domain/pipeline/MediaDataProcessor;Lkotlin/coroutines/Continuation;)V
...
.method public final invoke(Lkotlinx/coroutines/CoroutineScope;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    check-cast v0, Lcom/android/systemui/media/controls/domain/pipeline/MediaDataProcessor$allowMediaRecommendations$2;

    sget-object v1, Lkotlin/Unit;->INSTANCE:Lkotlin/Unit;

    invoke-virtual {v0, v1}, Lcom/android/systemui/media/controls/domain/pipeline/MediaDataProcessor$allowMediaRecommendations$2;->invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
...
.method public final invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 361
    .local v0, "this":Lcom/android/systemui/media/controls/domain/pipeline/MediaDataProcessor$allowMediaRecommendations$2;
    .local p1, "$result":Ljava/lang/Object;
    iget-object v1, v0, Lcom/android/systemui/media/controls/domain/pipeline/MediaDataProcessor$allowMediaRecommendations$2;->this$0:Lcom/android/systemui/media/controls/domain/pipeline/MediaDataProcessor;

    invoke-static {v1}, Lcom/android/systemui/media/controls/domain/pipeline/MediaDataProcessor;->access$getSecureSettings$p(Lcom/android/systemui/media/controls/domain/pipeline/MediaDataProcessor;)Lcom/android/systemui/util/settings/SecureSettings;
    ...
    .line 370
    .local v1, "flag":Z
    iget-object v2, v0, Lcom/android/systemui/media/controls/domain/pipeline/MediaDataProcessor$allowMediaRecommendations$2;->this$0:Lcom/android/systemui/media/controls/domain/pipeline/MediaDataProcessor;

    invoke-static {v2}, Lcom/android/systemui/media/controls/domain/pipeline/MediaDataProcessor;->access$getUseQsMediaPlayer$p(Lcom/android/systemui/media/controls/domain/pipeline/MediaDataProcessor;)Z
