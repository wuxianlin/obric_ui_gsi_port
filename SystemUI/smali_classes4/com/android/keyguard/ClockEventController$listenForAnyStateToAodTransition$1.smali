...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lcom/android/keyguard/ClockEventController;->listenForAnyStateToAodTransition$packages__apps__SystemUINew__android_common__SystemUI_core(Lkotlinx/coroutines/CoroutineScope;)Lkotlinx/coroutines/Job;
.end annotation
...
.method public final create(Ljava/lang/Object;Lkotlin/coroutines/Continuation;)Lkotlin/coroutines/Continuation;
    ...
    iget-object v1, p0, Lcom/android/keyguard/ClockEventController$listenForAnyStateToAodTransition$1;->this$0:Lcom/android/keyguard/ClockEventController;

    invoke-direct {v0, v1, p2}, Lcom/android/keyguard/ClockEventController$listenForAnyStateToAodTransition$1;-><init>(Lcom/android/keyguard/ClockEventController;Lkotlin/coroutines/Continuation;)V
...
.method public final invoke(Lkotlinx/coroutines/CoroutineScope;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    check-cast v0, Lcom/android/keyguard/ClockEventController$listenForAnyStateToAodTransition$1;

    sget-object v1, Lkotlin/Unit;->INSTANCE:Lkotlin/Unit;

    invoke-virtual {v0, v1}, Lcom/android/keyguard/ClockEventController$listenForAnyStateToAodTransition$1;->invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
...
.method public final invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .local v0, "this":Lcom/android/keyguard/ClockEventController$listenForAnyStateToAodTransition$1;
    .local p1, "$result":Ljava/lang/Object;
    invoke-static {p1}, Lkotlin/ResultKt;->throwOnFailure(Ljava/lang/Object;)V

    goto :goto_0

    .end local v0    # "this":Lcom/android/keyguard/ClockEventController$listenForAnyStateToAodTransition$1;
    ...
    .line 576
    .local v1, "this":Lcom/android/keyguard/ClockEventController$listenForAnyStateToAodTransition$1;
    .restart local p1    # "$result":Ljava/lang/Object;
    iget-object v2, v1, Lcom/android/keyguard/ClockEventController$listenForAnyStateToAodTransition$1;->this$0:Lcom/android/keyguard/ClockEventController;
    ...
    new-instance v8, Lcom/android/keyguard/ClockEventController$listenForAnyStateToAodTransition$1$invokeSuspend$$inlined$filter$1;

    invoke-direct {v8, v4}, Lcom/android/keyguard/ClockEventController$listenForAnyStateToAodTransition$1$invokeSuspend$$inlined$filter$1;-><init>(Lkotlinx/coroutines/flow/Flow;)V
    ...
    new-instance v8, Lcom/android/keyguard/ClockEventController$listenForAnyStateToAodTransition$1$invokeSuspend$$inlined$filter$2;

    invoke-direct {v8, v4}, Lcom/android/keyguard/ClockEventController$listenForAnyStateToAodTransition$1$invokeSuspend$$inlined$filter$2;-><init>(Lkotlinx/coroutines/flow/Flow;)V
    ...
    .end local v2    # "$this$filter$iv":Lkotlinx/coroutines/flow/Flow;
    .end local v3    # "$i$f$filter":I
    new-instance v2, Lcom/android/keyguard/ClockEventController$listenForAnyStateToAodTransition$1$3;

    iget-object v3, v1, Lcom/android/keyguard/ClockEventController$listenForAnyStateToAodTransition$1;->this$0:Lcom/android/keyguard/ClockEventController;

    invoke-direct {v2, v3}, Lcom/android/keyguard/ClockEventController$listenForAnyStateToAodTransition$1$3;-><init>(Lcom/android/keyguard/ClockEventController;)V
    ...
    iput v6, v1, Lcom/android/keyguard/ClockEventController$listenForAnyStateToAodTransition$1;->label:I
    ...
    .line 581
    .end local v1    # "this":Lcom/android/keyguard/ClockEventController$listenForAnyStateToAodTransition$1;
    .restart local v0    # "this":Lcom/android/keyguard/ClockEventController$listenForAnyStateToAodTransition$1;
    :goto_0
    sget-object v1, Lkotlin/Unit;->INSTANCE:Lkotlin/Unit;
