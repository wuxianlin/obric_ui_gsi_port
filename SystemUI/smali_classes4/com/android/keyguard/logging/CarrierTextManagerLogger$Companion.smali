...
.method public static final synthetic access$reasonMessage(Lcom/android/keyguard/logging/CarrierTextManagerLogger$Companion;I)Ljava/lang/String;
    .locals 1
    .param p0, "$this"    # Lcom/android/keyguard/logging/CarrierTextManagerLogger$Companion;
    .param p1, "$receiver"    # I
...
.method private final reasonMessage(I)Ljava/lang/String;
    ...
    .line 201
    :pswitch_0
    const-string v0, "SATELLITE_CHANGED"

    goto :goto_0

    .line 200
    :pswitch_1
    const-string v0, "ACTIVE_DATA_SUB_CHANGED"

    goto :goto_0

    .line 199
    :pswitch_2
    const-string v0, "SIM_ERROR_STATE_CHANGED"

    goto :goto_0

    .line 198
    :pswitch_3
    const-string v0, "ON_TELEPHONY_CAPABLE"

    goto :goto_0

    .line 197
    :pswitch_4
    const-string v0, "REFRESH_CARRIER_INFO"
