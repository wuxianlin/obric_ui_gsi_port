...
.method public final create(Ljava/lang/Object;Lkotlin/coroutines/Continuation;)Lkotlin/coroutines/Continuation;
    ...
    iget-object v1, p0, Lcom/android/systemui/clipboardoverlay/ClipboardImageLoader$loadAsync$1;->$callback:Ljava/util/function/Consumer;

    iget-object v2, p0, Lcom/android/systemui/clipboardoverlay/ClipboardImageLoader$loadAsync$1;->this$0:Lcom/android/systemui/clipboardoverlay/ClipboardImageLoader;

    iget-object v3, p0, Lcom/android/systemui/clipboardoverlay/ClipboardImageLoader$loadAsync$1;->$uri:Landroid/net/Uri;

    invoke-direct {v0, v1, v2, v3, p2}, Lcom/android/systemui/clipboardoverlay/ClipboardImageLoader$loadAsync$1;-><init>(Ljava/util/function/Consumer;Lcom/android/systemui/clipboardoverlay/ClipboardImageLoader;Landroid/net/Uri;Lkotlin/coroutines/Continuation;)V
...
.method public final invoke(Lkotlinx/coroutines/CoroutineScope;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    check-cast v0, Lcom/android/systemui/clipboardoverlay/ClipboardImageLoader$loadAsync$1;

    sget-object v1, Lkotlin/Unit;->INSTANCE:Lkotlin/Unit;

    invoke-virtual {v0, v1}, Lcom/android/systemui/clipboardoverlay/ClipboardImageLoader$loadAsync$1;->invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
...
.method public final invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .local v0, "this":Lcom/android/systemui/clipboardoverlay/ClipboardImageLoader$loadAsync$1;
    .local p1, "$result":Ljava/lang/Object;
    iget-object v1, v0, Lcom/android/systemui/clipboardoverlay/ClipboardImageLoader$loadAsync$1;->L$0:Ljava/lang/Object;
    ...
    .end local v0    # "this":Lcom/android/systemui/clipboardoverlay/ClipboardImageLoader$loadAsync$1;
    ...
    .local v1, "this":Lcom/android/systemui/clipboardoverlay/ClipboardImageLoader$loadAsync$1;
    .restart local p1    # "$result":Ljava/lang/Object;
    iget-object v2, v1, Lcom/android/systemui/clipboardoverlay/ClipboardImageLoader$loadAsync$1;->$callback:Ljava/util/function/Consumer;

    iget-object v3, v1, Lcom/android/systemui/clipboardoverlay/ClipboardImageLoader$loadAsync$1;->this$0:Lcom/android/systemui/clipboardoverlay/ClipboardImageLoader;

    iget-object v4, v1, Lcom/android/systemui/clipboardoverlay/ClipboardImageLoader$loadAsync$1;->$uri:Landroid/net/Uri;

    move-object v7, v1

    check-cast v7, Lkotlin/coroutines/Continuation;

    iput-object v2, v1, Lcom/android/systemui/clipboardoverlay/ClipboardImageLoader$loadAsync$1;->L$0:Ljava/lang/Object;

    const/4 v5, 0x1

    iput v5, v1, Lcom/android/systemui/clipboardoverlay/ClipboardImageLoader$loadAsync$1;->label:I
