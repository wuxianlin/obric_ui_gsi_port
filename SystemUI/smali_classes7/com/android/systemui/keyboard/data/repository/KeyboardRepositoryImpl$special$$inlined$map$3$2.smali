...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lcom/android/systemui/keyboard/data/repository/KeyboardRepositoryImpl$special$$inlined$map$3;->collect(Lkotlinx/coroutines/flow/FlowCollector;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
.end annotation
...
.method public final emit(Ljava/lang/Object;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    iget p2, v0, Lcom/android/systemui/keyboard/data/repository/KeyboardRepositoryImpl$special$$inlined$map$3$2$1;->label:I

    sub-int/2addr p2, v2

    iput p2, v0, Lcom/android/systemui/keyboard/data/repository/KeyboardRepositoryImpl$special$$inlined$map$3$2$1;->label:I
    ...
    iget-object v0, p2, Lcom/android/systemui/keyboard/data/repository/KeyboardRepositoryImpl$special$$inlined$map$3$2$1;->result:Ljava/lang/Object;
    ...
    .line 0
    iget v2, p2, Lcom/android/systemui/keyboard/data/repository/KeyboardRepositoryImpl$special$$inlined$map$3$2$1;->label:I
    ...
    .line 53
    .local v2, "this":Lcom/android/systemui/keyboard/data/repository/KeyboardRepositoryImpl$special$$inlined$map$3$2;
    .local p1, "value":Ljava/lang/Object;
    iget-object v2, v2, Lcom/android/systemui/keyboard/data/repository/KeyboardRepositoryImpl$special$$inlined$map$3$2;->$this_unsafeFlow:Lkotlinx/coroutines/flow/FlowCollector;
    ...
    .local p1, "it":Landroid/hardware/input/KeyboardBacklightState;
    const/4 v4, 0x0

    .line 224
    .local v4, "$i$a$-map-KeyboardRepositoryImpl$backlight$1":I
    new-instance v5, Lcom/android/systemui/keyboard/shared/model/BacklightModel;
    ...
    invoke-direct {v5, v6, v7}, Lcom/android/systemui/keyboard/shared/model/BacklightModel;-><init>(II)V

    .line 223
    .end local v4    # "$i$a$-map-KeyboardRepositoryImpl$backlight$1":I
    .end local p1    # "it":Landroid/hardware/input/KeyboardBacklightState;
    const/4 p1, 0x1

    iput p1, p2, Lcom/android/systemui/keyboard/data/repository/KeyboardRepositoryImpl$special$$inlined$map$3$2$1;->label:I
