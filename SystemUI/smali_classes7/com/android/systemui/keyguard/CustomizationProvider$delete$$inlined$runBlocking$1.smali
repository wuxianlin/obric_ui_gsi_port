...
.method public final invoke(Lkotlinx/coroutines/CoroutineScope;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    check-cast v0, Lcom/android/systemui/keyguard/CustomizationProvider$delete$$inlined$runBlocking$1;

    sget-object v1, Lkotlin/Unit;->INSTANCE:Lkotlin/Unit;

    invoke-virtual {v0, v1}, Lcom/android/systemui/keyguard/CustomizationProvider$delete$$inlined$runBlocking$1;->invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
...
.method public final invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iget v2, v1, Lcom/android/systemui/keyguard/CustomizationProvider$delete$$inlined$runBlocking$1;->label:I
    ...
    .local v1, "this":Lcom/android/systemui/keyguard/CustomizationProvider$delete$$inlined$runBlocking$1;
    ...
    .local v6, "$i$a$-runBlocking-CustomizationProvider$delete$1":I
    iget v7, v1, Lcom/android/systemui/keyguard/CustomizationProvider$delete$$inlined$runBlocking$1;->I$0:I

    .local v7, "cookie$iv$iv":I
    iget-boolean v8, v1, Lcom/android/systemui/keyguard/CustomizationProvider$delete$$inlined$runBlocking$1;->Z$0:Z

    .local v8, "asyncTracingEnabled$iv$iv":Z
    iget-object v9, v1, Lcom/android/systemui/keyguard/CustomizationProvider$delete$$inlined$runBlocking$1;->L$1:Ljava/lang/Object;

    check-cast v9, Ljava/lang/String;

    .local v9, "spanString$iv$iv":Ljava/lang/String;
    iget-object v10, v1, Lcom/android/systemui/keyguard/CustomizationProvider$delete$$inlined$runBlocking$1;->L$0:Ljava/lang/Object;
    ...
    .end local v6    # "$i$a$-runBlocking-CustomizationProvider$delete$1":I
    :catchall_0
    move-exception v0
    ...
    .line 0
    .end local v1    # "this":Lcom/android/systemui/keyguard/CustomizationProvider$delete$$inlined$runBlocking$1;
    ...
    .restart local v1    # "this":Lcom/android/systemui/keyguard/CustomizationProvider$delete$$inlined$runBlocking$1;
    move-object/from16 v2, p1

    .restart local v2    # "$result":Ljava/lang/Object;
    iget-object v4, v1, Lcom/android/systemui/keyguard/CustomizationProvider$delete$$inlined$runBlocking$1;->L$0:Ljava/lang/Object;

    check-cast v4, Lkotlinx/coroutines/CoroutineScope;

    .line 108
    .local v4, "$this$runBlocking":Lkotlinx/coroutines/CoroutineScope;
    iget-object v5, v1, Lcom/android/systemui/keyguard/CustomizationProvider$delete$$inlined$runBlocking$1;->$spanName:Ljava/lang/String;
    ...
    .line 224
    .local v4, "$i$a$-runBlocking-CustomizationProvider$delete$1":I
    iget-object v12, v1, Lcom/android/systemui/keyguard/CustomizationProvider$delete$$inlined$runBlocking$1;->this$0:Lcom/android/systemui/keyguard/CustomizationProvider;

    iget-object v13, v1, Lcom/android/systemui/keyguard/CustomizationProvider$delete$$inlined$runBlocking$1;->$uri$inlined:Landroid/net/Uri;

    iget-object v14, v1, Lcom/android/systemui/keyguard/CustomizationProvider$delete$$inlined$runBlocking$1;->$selectionArgs$inlined:[Ljava/lang/String;

    iput-object v10, v1, Lcom/android/systemui/keyguard/CustomizationProvider$delete$$inlined$runBlocking$1;->L$0:Ljava/lang/Object;

    iput-object v9, v1, Lcom/android/systemui/keyguard/CustomizationProvider$delete$$inlined$runBlocking$1;->L$1:Ljava/lang/Object;

    iput-boolean v8, v1, Lcom/android/systemui/keyguard/CustomizationProvider$delete$$inlined$runBlocking$1;->Z$0:Z

    iput v5, v1, Lcom/android/systemui/keyguard/CustomizationProvider$delete$$inlined$runBlocking$1;->I$0:I

    const/4 v15, 0x1

    iput v15, v1, Lcom/android/systemui/keyguard/CustomizationProvider$delete$$inlined$runBlocking$1;->label:I

    invoke-static {v12, v13, v14, v1}, Lcom/android/systemui/keyguard/CustomizationProvider;->access$deleteSelection(Lcom/android/systemui/keyguard/CustomizationProvider;Landroid/net/Uri;[Ljava/lang/String;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    .local v5, "$i$f$traceCoroutine":I
    .local v7, "$i$a$-runBlocking-CustomizationProvider$delete$1":I
    ...
    .line 108
    .end local v7    # "$i$a$-runBlocking-CustomizationProvider$delete$1":I
    nop
