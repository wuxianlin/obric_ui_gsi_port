...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lcom/android/systemui/keyguard/domain/interactor/LightRevealScrimInteractor$special$$inlined$filter$1;->collect(Lkotlinx/coroutines/flow/FlowCollector;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
.end annotation
...
.method public final emit(Ljava/lang/Object;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    iget p2, v0, Lcom/android/systemui/keyguard/domain/interactor/LightRevealScrimInteractor$special$$inlined$filter$1$2$1;->label:I

    sub-int/2addr p2, v2

    iput p2, v0, Lcom/android/systemui/keyguard/domain/interactor/LightRevealScrimInteractor$special$$inlined$filter$1$2$1;->label:I
    ...
    iget-object v0, p2, Lcom/android/systemui/keyguard/domain/interactor/LightRevealScrimInteractor$special$$inlined$filter$1$2$1;->result:Ljava/lang/Object;
    ...
    .line 0
    iget v2, p2, Lcom/android/systemui/keyguard/domain/interactor/LightRevealScrimInteractor$special$$inlined$filter$1$2$1;->label:I
    ...
    .line 53
    .local v2, "this":Lcom/android/systemui/keyguard/domain/interactor/LightRevealScrimInteractor$special$$inlined$filter$1$2;
    .local p1, "value":Ljava/lang/Object;
    iget-object v3, v2, Lcom/android/systemui/keyguard/domain/interactor/LightRevealScrimInteractor$special$$inlined$filter$1$2;->$this_unsafeFlow:Lkotlinx/coroutines/flow/FlowCollector;
    ...
    .line 224
    .local v6, "$i$a$-filter-LightRevealScrimInteractor$revealAmount$1":I
    iget-object v7, v2, Lcom/android/systemui/keyguard/domain/interactor/LightRevealScrimInteractor$special$$inlined$filter$1$2;->this$0:Lcom/android/systemui/keyguard/domain/interactor/LightRevealScrimInteractor;

    invoke-static {v7}, Lcom/android/systemui/keyguard/domain/interactor/LightRevealScrimInteractor;->access$screenIsShowingContent(Lcom/android/systemui/keyguard/domain/interactor/LightRevealScrimInteractor;)Z
    ...
    .end local v2    # "this":Lcom/android/systemui/keyguard/domain/interactor/LightRevealScrimInteractor$special$$inlined$filter$1$2;
    :goto_1
    if-nez v2, :cond_3
    ...
    .line 223
    .end local v6    # "$i$a$-filter-LightRevealScrimInteractor$revealAmount$1":I
    :cond_4
    if-eqz v9, :cond_6

    iput v8, p2, Lcom/android/systemui/keyguard/domain/interactor/LightRevealScrimInteractor$special$$inlined$filter$1$2$1;->label:I
