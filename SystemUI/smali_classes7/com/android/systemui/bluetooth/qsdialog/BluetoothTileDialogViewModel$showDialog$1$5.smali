...
.method public final create(Ljava/lang/Object;Lkotlin/coroutines/Continuation;)Lkotlin/coroutines/Continuation;
    ...
    iget-object v3, p0, Lcom/android/systemui/bluetooth/qsdialog/BluetoothTileDialogViewModel$showDialog$1$5;->$context:Landroid/content/Context;

    invoke-direct {v0, v1, v2, v3, p2}, Lcom/android/systemui/bluetooth/qsdialog/BluetoothTileDialogViewModel$showDialog$1$5;-><init>(Lcom/android/systemui/bluetooth/qsdialog/BluetoothTileDialogDelegate;Lcom/android/systemui/statusbar/phone/SystemUIDialog;Landroid/content/Context;Lkotlin/coroutines/Continuation;)V
...
.method public final invoke(Lcom/android/systemui/bluetooth/qsdialog/AudioSharingButtonState;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    check-cast v0, Lcom/android/systemui/bluetooth/qsdialog/BluetoothTileDialogViewModel$showDialog$1$5;

    sget-object v1, Lkotlin/Unit;->INSTANCE:Lkotlin/Unit;

    invoke-virtual {v0, v1}, Lcom/android/systemui/bluetooth/qsdialog/BluetoothTileDialogViewModel$showDialog$1$5;->invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
...
.method public final invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .local v0, "this":Lcom/android/systemui/bluetooth/qsdialog/BluetoothTileDialogViewModel$showDialog$1$5;
    .local p1, "$result":Ljava/lang/Object;
    iget-object v1, v0, Lcom/android/systemui/bluetooth/qsdialog/BluetoothTileDialogViewModel$showDialog$1$5;->L$0:Ljava/lang/Object;

    check-cast v1, Lcom/android/systemui/bluetooth/qsdialog/AudioSharingButtonState;

    .line 152
    .local v1, "it":Lcom/android/systemui/bluetooth/qsdialog/AudioSharingButtonState;
    instance-of v2, v1, Lcom/android/systemui/bluetooth/qsdialog/AudioSharingButtonState$Visible;

    if-eqz v2, :cond_0

    .line 153
    iget-object v2, v0, Lcom/android/systemui/bluetooth/qsdialog/BluetoothTileDialogViewModel$showDialog$1$5;->$dialogDelegate:Lcom/android/systemui/bluetooth/qsdialog/BluetoothTileDialogDelegate;

    .line 154
    iget-object v3, v0, Lcom/android/systemui/bluetooth/qsdialog/BluetoothTileDialogViewModel$showDialog$1$5;->$dialog:Lcom/android/systemui/statusbar/phone/SystemUIDialog;

    .line 155
    nop

    .line 156
    iget-object v4, v0, Lcom/android/systemui/bluetooth/qsdialog/BluetoothTileDialogViewModel$showDialog$1$5;->$context:Landroid/content/Context;

    move-object v5, v1

    check-cast v5, Lcom/android/systemui/bluetooth/qsdialog/AudioSharingButtonState$Visible;

    invoke-virtual {v5}, Lcom/android/systemui/bluetooth/qsdialog/AudioSharingButtonState$Visible;->getResId()I
    ...
    .line 153
    .end local v1    # "it":Lcom/android/systemui/bluetooth/qsdialog/AudioSharingButtonState;
    const/4 v4, 0x0

    invoke-virtual {v2, v3, v4, v1}, Lcom/android/systemui/bluetooth/qsdialog/BluetoothTileDialogDelegate;->onAudioSharingButtonUpdated$packages__apps__SystemUINew__android_common__SystemUI_core(Lcom/android/systemui/statusbar/phone/SystemUIDialog;ILjava/lang/String;)V

    goto :goto_0

    .line 159
    :cond_0
    iget-object v1, v0, Lcom/android/systemui/bluetooth/qsdialog/BluetoothTileDialogViewModel$showDialog$1$5;->$dialogDelegate:Lcom/android/systemui/bluetooth/qsdialog/BluetoothTileDialogDelegate;

    iget-object v2, v0, Lcom/android/systemui/bluetooth/qsdialog/BluetoothTileDialogViewModel$showDialog$1$5;->$dialog:Lcom/android/systemui/statusbar/phone/SystemUIDialog;

    const/16 v3, 0x8

    const/4 v4, 0x0

    invoke-virtual {v1, v2, v3, v4}, Lcom/android/systemui/bluetooth/qsdialog/BluetoothTileDialogDelegate;->onAudioSharingButtonUpdated$packages__apps__SystemUINew__android_common__SystemUI_core(Lcom/android/systemui/statusbar/phone/SystemUIDialog;ILjava/lang/String;)V
