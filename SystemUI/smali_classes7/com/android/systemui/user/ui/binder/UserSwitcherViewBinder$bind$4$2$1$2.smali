...
# direct methods
.method constructor <init>(Lcom/android/systemui/user/ui/viewmodel/UserSwitcherViewModel;Lkotlin/jvm/internal/Ref$ObjectRef;Landroid/view/ViewGroup;Landroid/view/View;Lcom/android/systemui/user/ui/binder/UserSwitcherViewBinder$MenuAdapter;Lkotlin/coroutines/Continuation;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public final create(Ljava/lang/Object;Lkotlin/coroutines/Continuation;)Lkotlin/coroutines/Continuation;
    ...
    new-instance v7, Lcom/android/systemui/user/ui/binder/UserSwitcherViewBinder$bind$4$2$1$2;
...
.method public bridge synthetic invoke(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1, p2}, Lcom/android/systemui/user/ui/binder/UserSwitcherViewBinder$bind$4$2$1$2;->invoke(Lkotlinx/coroutines/CoroutineScope;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
...
.method public final invoke(Lkotlinx/coroutines/CoroutineScope;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    check-cast v0, Lcom/android/systemui/user/ui/binder/UserSwitcherViewBinder$bind$4$2$1$2;

    sget-object v1, Lkotlin/Unit;->INSTANCE:Lkotlin/Unit;

    invoke-virtual {v0, v1}, Lcom/android/systemui/user/ui/binder/UserSwitcherViewBinder$bind$4$2$1$2;->invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
...
.method public final invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .local v0, "this":Lcom/android/systemui/user/ui/binder/UserSwitcherViewBinder$bind$4$2$1$2;
    .local p1, "$result":Ljava/lang/Object;
    invoke-static {p1}, Lkotlin/ResultKt;->throwOnFailure(Ljava/lang/Object;)V

    goto :goto_0

    .end local v0    # "this":Lcom/android/systemui/user/ui/binder/UserSwitcherViewBinder$bind$4$2$1$2;
    ...
    .line 101
    .local v1, "this":Lcom/android/systemui/user/ui/binder/UserSwitcherViewBinder$bind$4$2$1$2;
    .restart local p1    # "$result":Ljava/lang/Object;
    iget-object v2, v1, Lcom/android/systemui/user/ui/binder/UserSwitcherViewBinder$bind$4$2$1$2;->$viewModel:Lcom/android/systemui/user/ui/viewmodel/UserSwitcherViewModel;

    invoke-virtual {v2}, Lcom/android/systemui/user/ui/viewmodel/UserSwitcherViewModel;->isMenuVisible()Lkotlinx/coroutines/flow/Flow;

    move-result-object v2

    new-instance v9, Lcom/android/systemui/user/ui/binder/UserSwitcherViewBinder$bind$4$2$1$2$1;

    iget-object v4, v1, Lcom/android/systemui/user/ui/binder/UserSwitcherViewBinder$bind$4$2$1$2;->$popupMenu:Lkotlin/jvm/internal/Ref$ObjectRef;

    iget-object v5, v1, Lcom/android/systemui/user/ui/binder/UserSwitcherViewBinder$bind$4$2$1$2;->$view:Landroid/view/ViewGroup;

    iget-object v6, v1, Lcom/android/systemui/user/ui/binder/UserSwitcherViewBinder$bind$4$2$1$2;->$addButton:Landroid/view/View;

    iget-object v7, v1, Lcom/android/systemui/user/ui/binder/UserSwitcherViewBinder$bind$4$2$1$2;->$popupMenuAdapter:Lcom/android/systemui/user/ui/binder/UserSwitcherViewBinder$MenuAdapter;

    iget-object v8, v1, Lcom/android/systemui/user/ui/binder/UserSwitcherViewBinder$bind$4$2$1$2;->$viewModel:Lcom/android/systemui/user/ui/viewmodel/UserSwitcherViewModel;
    ...
    iput v4, v1, Lcom/android/systemui/user/ui/binder/UserSwitcherViewBinder$bind$4$2$1$2;->label:I
    ...
    .line 120
    .end local v1    # "this":Lcom/android/systemui/user/ui/binder/UserSwitcherViewBinder$bind$4$2$1$2;
    .restart local v0    # "this":Lcom/android/systemui/user/ui/binder/UserSwitcherViewBinder$bind$4$2$1$2;
    :goto_0
    sget-object v1, Lkotlin/Unit;->INSTANCE:Lkotlin/Unit;
