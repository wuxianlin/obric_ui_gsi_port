...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lcom/android/systemui/display/data/repository/DisplayRepositoryImpl$special$$inlined$map$4;->collect(Lkotlinx/coroutines/flow/FlowCollector;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
.end annotation
...
.method public final emit(Ljava/lang/Object;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    iget p2, v0, Lcom/android/systemui/display/data/repository/DisplayRepositoryImpl$special$$inlined$map$4$2$1;->label:I

    sub-int/2addr p2, v2

    iput p2, v0, Lcom/android/systemui/display/data/repository/DisplayRepositoryImpl$special$$inlined$map$4$2$1;->label:I
    ...
    iget-object v0, p2, Lcom/android/systemui/display/data/repository/DisplayRepositoryImpl$special$$inlined$map$4$2$1;->result:Ljava/lang/Object;
    ...
    .line 0
    iget v2, p2, Lcom/android/systemui/display/data/repository/DisplayRepositoryImpl$special$$inlined$map$4$2$1;->label:I
    ...
    .line 53
    .local v2, "this":Lcom/android/systemui/display/data/repository/DisplayRepositoryImpl$special$$inlined$map$4$2;
    .local p1, "value":Ljava/lang/Object;
    iget-object v2, v2, Lcom/android/systemui/display/data/repository/DisplayRepositoryImpl$special$$inlined$map$4$2;->$this_unsafeFlow:Lkotlinx/coroutines/flow/FlowCollector;
    ...
    .local p1, "enabledDisplaysSet":Ljava/util/Set;
    const/4 v4, 0x0

    .line 224
    .local v4, "$i$a$-map-DisplayRepositoryImpl$enabledDisplayIds$2":I
    ...
    .local v9, "it":Landroid/view/Display;
    const/4 v10, 0x0

    .line 224
    .local v10, "$i$a$-map-DisplayRepositoryImpl$enabledDisplayIds$2$1":I
    invoke-virtual {v9}, Landroid/view/Display;->getDisplayId()I

    move-result v9

    .end local v9    # "it":Landroid/view/Display;
    .end local v10    # "$i$a$-map-DisplayRepositoryImpl$enabledDisplayIds$2$1":I
    ...
    .line 223
    .end local v4    # "$i$a$-map-DisplayRepositoryImpl$enabledDisplayIds$2":I
    const/4 v4, 0x1

    iput v4, p2, Lcom/android/systemui/display/data/repository/DisplayRepositoryImpl$special$$inlined$map$4$2$1;->label:I
