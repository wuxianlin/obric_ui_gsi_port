...
.method onConfirm()V
    ...
    .line 67
    iget-object v0, p0, Lcom/android/systemui/usb/UsbConfirmActivity;->mDialogHelper:Lcom/android/systemui/usb/UsbDialogHelper;

    invoke-virtual {v0}, Lcom/android/systemui/usb/UsbDialogHelper;->grantUidAccessPermission()V

    .line 68
    invoke-virtual {p0}, Lcom/android/systemui/usb/UsbConfirmActivity;->isAlwaysUseChecked()Z
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    iget-object v2, p0, Lcom/android/systemui/usb/UsbConfirmActivity;->mDialogHelper:Lcom/android/systemui/usb/UsbDialogHelper;
...
.method protected onResume()V
    ...
    iget-object v3, p0, Lcom/android/systemui/usb/UsbConfirmActivity;->mDialogHelper:Lcom/android/systemui/usb/UsbDialogHelper;
    ...
    .line 52
    invoke-virtual {p0, v1, v2}, Lcom/android/systemui/usb/UsbConfirmActivity;->getString(I[Ljava/lang/Object;)Ljava/lang/String;
    ...
    .line 56
    iget-object v4, p0, Lcom/android/systemui/usb/UsbConfirmActivity;->mDialogHelper:Lcom/android/systemui/usb/UsbDialogHelper;

    invoke-virtual {v4}, Lcom/android/systemui/usb/UsbDialogHelper;->getAppName()Ljava/lang/CharSequence;

    move-result-object v4

    iget-object v5, p0, Lcom/android/systemui/usb/UsbConfirmActivity;->mDialogHelper:Lcom/android/systemui/usb/UsbDialogHelper;
    ...
    .line 56
    invoke-virtual {p0, v3, v4}, Lcom/android/systemui/usb/UsbConfirmActivity;->getString(I[Ljava/lang/Object;)Ljava/lang/String;
    ...
    invoke-virtual {p0, v2, v4}, Lcom/android/systemui/usb/UsbConfirmActivity;->setAlertParams(Ljava/lang/String;Ljava/lang/String;)V

    .line 59
    if-nez v0, :cond_2

    .line 60
    invoke-virtual {p0}, Lcom/android/systemui/usb/UsbConfirmActivity;->addAlwaysUseCheckbox()V
