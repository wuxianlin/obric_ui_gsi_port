...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/android/systemui/accessibility/data/repository/ColorInversionRepositoryImpl$Companion;
    }
.end annotation

.annotation system Ldalvik/annotation/SourceDebugExtension;
    value = "SMAP\nColorInversionRepository.kt\nKotlin\n*S Kotlin\n*F\n+ 1 ColorInversionRepository.kt\ncom/android/systemui/accessibility/data/repository/ColorInversionRepositoryImpl\n+ 2 Maps.kt\nkotlin/collections/MapsKt__MapsKt\n+ 3 Transform.kt\nkotlinx/coroutines/flow/FlowKt__TransformKt\n+ 4 Emitters.kt\nkotlinx/coroutines/flow/FlowKt__EmittersKt\n+ 5 SafeCollector.common.kt\nkotlinx/coroutines/flow/internal/SafeCollector_commonKt\n*L\n1#1,87:1\n372#2,3:88\n375#2,4:96\n53#3:91\n55#3:95\n50#4:92\n55#4:94\n106#5:93\n*S KotlinDebug\n*F\n+ 1 ColorInversionRepository.kt\ncom/android/systemui/accessibility/data/repository/ColorInversionRepositoryImpl\n*L\n59#1:88,3\n59#1:96,4\n63#1:91\n63#1:95\n63#1:92\n63#1:94\n63#1:93\n*E\n"
.end annotation
...
.field public static final Companion:Lcom/android/systemui/accessibility/data/repository/ColorInversionRepositoryImpl$Companion;

.field private static final DISABLED:I = 0x0

.field private static final ENABLED:I = 0x1

.field private static final SETTING_NAME:Ljava/lang/String; = "accessibility_display_inversion_enabled"
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/systemui/accessibility/data/repository/ColorInversionRepositoryImpl;->Companion:Lcom/android/systemui/accessibility/data/repository/ColorInversionRepositoryImpl$Companion;

    const/16 v0, 0x8

    sput v0, Lcom/android/systemui/accessibility/data/repository/ColorInversionRepositoryImpl;->$stable:I
...
.method public constructor <init>(Lkotlin/coroutines/CoroutineContext;Lkotlinx/coroutines/CoroutineScope;Lcom/android/systemui/util/settings/SecureSettings;)V
    ...
    iput-object v0, p0, Lcom/android/systemui/accessibility/data/repository/ColorInversionRepositoryImpl;->userMap:Ljava/util/Map;

    .line 50
    return-void
.end method

.method public static final synthetic access$getSecureSettings$p(Lcom/android/systemui/accessibility/data/repository/ColorInversionRepositoryImpl;)Lcom/android/systemui/util/settings/SecureSettings;
    .locals 1
    .param p0, "$this"    # Lcom/android/systemui/accessibility/data/repository/ColorInversionRepositoryImpl;

    .line 47
    iget-object v0, p0, Lcom/android/systemui/accessibility/data/repository/ColorInversionRepositoryImpl;->secureSettings:Lcom/android/systemui/util/settings/SecureSettings;
...
.method public isEnabled(Landroid/os/UserHandle;)Lkotlinx/coroutines/flow/Flow;
    ...
    .line 61
    .local v4, "$i$a$-getOrPut-ColorInversionRepositoryImpl$isEnabled$1":I
    ...
    .line 60
    iget-object v6, p0, Lcom/android/systemui/accessibility/data/repository/ColorInversionRepositoryImpl;->secureSettings:Lcom/android/systemui/util/settings/SecureSettings;
    ...
    .line 62
    new-instance v6, Lcom/android/systemui/accessibility/data/repository/ColorInversionRepositoryImpl$isEnabled$1$1;

    const/4 v7, 0x0

    invoke-direct {v6, v7}, Lcom/android/systemui/accessibility/data/repository/ColorInversionRepositoryImpl$isEnabled$1$1;-><init>(Lkotlin/coroutines/Continuation;)V
    ...
    new-instance v10, Lcom/android/systemui/accessibility/data/repository/ColorInversionRepositoryImpl$isEnabled$lambda$1$$inlined$map$1;

    invoke-direct {v10, v7, p0, p1}, Lcom/android/systemui/accessibility/data/repository/ColorInversionRepositoryImpl$isEnabled$lambda$1$$inlined$map$1;-><init>(Lkotlinx/coroutines/flow/Flow;Lcom/android/systemui/accessibility/data/repository/ColorInversionRepositoryImpl;Landroid/os/UserHandle;)V
    ...
    .line 68
    iget-object v6, p0, Lcom/android/systemui/accessibility/data/repository/ColorInversionRepositoryImpl;->bgCoroutineContext:Lkotlin/coroutines/CoroutineContext;
    ...
    .line 69
    iget-object v6, p0, Lcom/android/systemui/accessibility/data/repository/ColorInversionRepositoryImpl;->scope:Lkotlinx/coroutines/CoroutineScope;
    ...
    invoke-static {v5, v6, v7, v8}, Lkotlinx/coroutines/flow/FlowKt;->shareIn(Lkotlinx/coroutines/flow/Flow;Lkotlinx/coroutines/CoroutineScope;Lkotlinx/coroutines/flow/SharingStarted;I)Lkotlinx/coroutines/flow/SharedFlow;
    ...
    .line 90
    .end local v4    # "$i$a$-getOrPut-ColorInversionRepositoryImpl$isEnabled$1":I
    move-object v4, v5
...
.method public setIsEnabled(ZLandroid/os/UserHandle;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    .line 73
    iget-object v0, p0, Lcom/android/systemui/accessibility/data/repository/ColorInversionRepositoryImpl;->bgCoroutineContext:Lkotlin/coroutines/CoroutineContext;

    new-instance v1, Lcom/android/systemui/accessibility/data/repository/ColorInversionRepositoryImpl$setIsEnabled$2;

    const/4 v2, 0x0

    invoke-direct {v1, p0, p1, p2, v2}, Lcom/android/systemui/accessibility/data/repository/ColorInversionRepositoryImpl$setIsEnabled$2;-><init>(Lcom/android/systemui/accessibility/data/repository/ColorInversionRepositoryImpl;ZLandroid/os/UserHandle;Lkotlin/coroutines/Continuation;)V
