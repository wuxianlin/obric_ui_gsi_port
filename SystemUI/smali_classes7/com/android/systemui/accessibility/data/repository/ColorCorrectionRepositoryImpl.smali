...
.method public constructor <init>(Lkotlin/coroutines/CoroutineContext;Lkotlinx/coroutines/CoroutineScope;Lcom/android/systemui/util/settings/SecureSettings;)V
    ...
    iput-object v0, p0, Lcom/android/systemui/accessibility/data/repository/ColorCorrectionRepositoryImpl;->userMap:Ljava/util/Map;
...
.method public static final synthetic access$getSecureSettings$p(Lcom/android/systemui/accessibility/data/repository/ColorCorrectionRepositoryImpl;)Lcom/android/systemui/util/settings/SecureSettings;
    .locals 1
    .param p0, "$this"    # Lcom/android/systemui/accessibility/data/repository/ColorCorrectionRepositoryImpl;

    .line 47
    iget-object v0, p0, Lcom/android/systemui/accessibility/data/repository/ColorCorrectionRepositoryImpl;->secureSettings:Lcom/android/systemui/util/settings/SecureSettings;
...
.method public isEnabled(Landroid/os/UserHandle;)Lkotlinx/coroutines/flow/Flow;
    ...
    .line 61
    .local v4, "$i$a$-getOrPut-ColorCorrectionRepositoryImpl$isEnabled$1":I
    ...
    .line 60
    iget-object v6, p0, Lcom/android/systemui/accessibility/data/repository/ColorCorrectionRepositoryImpl;->secureSettings:Lcom/android/systemui/util/settings/SecureSettings;
    ...
    .line 62
    new-instance v6, Lcom/android/systemui/accessibility/data/repository/ColorCorrectionRepositoryImpl$isEnabled$1$1;

    const/4 v7, 0x0

    invoke-direct {v6, v7}, Lcom/android/systemui/accessibility/data/repository/ColorCorrectionRepositoryImpl$isEnabled$1$1;-><init>(Lkotlin/coroutines/Continuation;)V
    ...
    new-instance v10, Lcom/android/systemui/accessibility/data/repository/ColorCorrectionRepositoryImpl$isEnabled$lambda$1$$inlined$map$1;

    invoke-direct {v10, v7, p0, p1}, Lcom/android/systemui/accessibility/data/repository/ColorCorrectionRepositoryImpl$isEnabled$lambda$1$$inlined$map$1;-><init>(Lkotlinx/coroutines/flow/Flow;Lcom/android/systemui/accessibility/data/repository/ColorCorrectionRepositoryImpl;Landroid/os/UserHandle;)V
    ...
    .line 68
    iget-object v6, p0, Lcom/android/systemui/accessibility/data/repository/ColorCorrectionRepositoryImpl;->bgCoroutineContext:Lkotlin/coroutines/CoroutineContext;
    ...
    .line 69
    iget-object v6, p0, Lcom/android/systemui/accessibility/data/repository/ColorCorrectionRepositoryImpl;->scope:Lkotlinx/coroutines/CoroutineScope;
    ...
    .line 90
    .end local v4    # "$i$a$-getOrPut-ColorCorrectionRepositoryImpl$isEnabled$1":I
    move-object v4, v5
