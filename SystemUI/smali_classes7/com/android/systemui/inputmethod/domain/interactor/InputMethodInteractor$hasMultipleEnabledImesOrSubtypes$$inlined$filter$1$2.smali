...
.method public final emit(Ljava/lang/Object;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    iget-object v0, p2, Lcom/android/systemui/inputmethod/domain/interactor/InputMethodInteractor$hasMultipleEnabledImesOrSubtypes$$inlined$filter$1$2$1;->result:Ljava/lang/Object;
    ...
    .line 0
    iget v2, p2, Lcom/android/systemui/inputmethod/domain/interactor/InputMethodInteractor$hasMultipleEnabledImesOrSubtypes$$inlined$filter$1$2$1;->label:I
    ...
    .line 53
    .local v2, "this":Lcom/android/systemui/inputmethod/domain/interactor/InputMethodInteractor$hasMultipleEnabledImesOrSubtypes$$inlined$filter$1$2;
    .local p1, "value":Ljava/lang/Object;
    iget-object v2, v2, Lcom/android/systemui/inputmethod/domain/interactor/InputMethodInteractor$hasMultipleEnabledImesOrSubtypes$$inlined$filter$1$2;->$this_unsafeFlow:Lkotlinx/coroutines/flow/FlowCollector;
    ...
    check-cast v4, Lcom/android/systemui/inputmethod/data/model/InputMethodModel;

    .local v4, "ime":Lcom/android/systemui/inputmethod/data/model/InputMethodModel;
    const/4 v5, 0x0

    .line 224
    .local v5, "$i$a$-filter-InputMethodInteractor$hasMultipleEnabledImesOrSubtypes$matchingInputMethods$1":I
    invoke-virtual {v4}, Lcom/android/systemui/inputmethod/data/model/InputMethodModel;->getSubtypes()Ljava/util/List;
    ...
    check-cast v4, Lcom/android/systemui/inputmethod/data/model/InputMethodModel$Subtype;

    .local v4, "it":Lcom/android/systemui/inputmethod/data/model/InputMethodModel$Subtype;
    const/4 v10, 0x0

    .line 224
    .local v10, "$i$a$-any-InputMethodInteractor$hasMultipleEnabledImesOrSubtypes$matchingInputMethods$1$1":I
    invoke-virtual {v4}, Lcom/android/systemui/inputmethod/data/model/InputMethodModel$Subtype;->isAuxiliary()Z
    ...
    .line 226
    .end local v4    # "it":Lcom/android/systemui/inputmethod/data/model/InputMethodModel$Subtype;
    .end local v10    # "$i$a$-any-InputMethodInteractor$hasMultipleEnabledImesOrSubtypes$matchingInputMethods$1$1":I
    :goto_1
    if-eqz v4, :cond_2
    ...
    .line 223
    .end local v5    # "$i$a$-filter-InputMethodInteractor$hasMultipleEnabledImesOrSubtypes$matchingInputMethods$1":I
    if-eqz v9, :cond_8

    iput v7, p2, Lcom/android/systemui/inputmethod/domain/interactor/InputMethodInteractor$hasMultipleEnabledImesOrSubtypes$$inlined$filter$1$2$1;->label:I
