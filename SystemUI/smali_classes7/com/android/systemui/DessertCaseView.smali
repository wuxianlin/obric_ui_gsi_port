...
.method static constructor <clinit>()V
    ...
    .line 79
    sget v0, Lcom/android/systemui/res/R$drawable;->dessert_petitfour:I

    sget v1, Lcom/android/systemui/res/R$drawable;->dessert_donutburger:I

    sget v2, Lcom/android/systemui/res/R$drawable;->dessert_flan:I

    sget v3, Lcom/android/systemui/res/R$drawable;->dessert_keylimepie:I
    ...
    .line 91
    sget v0, Lcom/android/systemui/res/R$drawable;->dessert_zombiegingerbread:I

    sget v1, Lcom/android/systemui/res/R$drawable;->dessert_dandroid:I

    sget v2, Lcom/android/systemui/res/R$drawable;->dessert_jandycane:I
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-direct {v1, p0}, Lcom/android/systemui/DessertCaseView$1;-><init>(Lcom/android/systemui/DessertCaseView;)V
    ...
    .line 174
    sget v3, Lcom/android/systemui/res/R$dimen;->dessert_case_cell_size:I
    ...
    iget v4, v0, Lcom/android/systemui/DessertCaseView;->mCellSize:I
    ...
    .line 181
    .local v4, "loaded":Landroid/graphics/Bitmap;
    ...
    .line 184
    invoke-static {v1, v10, v3}, Landroid/graphics/BitmapFactory;->decodeResource(Landroid/content/res/Resources;ILandroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    ...
    invoke-static {v4}, Lcom/android/systemui/DessertCaseView;->convertToAlphaMask(Landroid/graphics/Bitmap;)Landroid/graphics/Bitmap;
    ...
    sget-object v13, Lcom/android/systemui/DessertCaseView;->ALPHA_MASK:[F

    invoke-direct {v12, v13}, Landroid/graphics/ColorMatrixColorFilter;-><init>([F)V

    invoke-virtual {v11, v12}, Landroid/graphics/drawable/BitmapDrawable;->setColorFilter(Landroid/graphics/ColorFilter;)V

    .line 187
    iget v12, v0, Lcom/android/systemui/DessertCaseView;->mCellSize:I

    iget v13, v0, Lcom/android/systemui/DessertCaseView;->mCellSize:I

    invoke-virtual {v11, v2, v2, v12, v13}, Landroid/graphics/drawable/BitmapDrawable;->setBounds(IIII)V

    .line 188
    iget-object v12, v0, Lcom/android/systemui/DessertCaseView;->mDrawables:Landroid/util/SparseArray;
    ...
    .line 193
    .end local v4    # "loaded":Landroid/graphics/Bitmap;
...
.method protected declared-synchronized onSizeChanged(IIII)V
    ...
    invoke-virtual {p0, v2}, Lcom/android/systemui/DessertCaseView;->setTranslationY(F)V
...
.method public declared-synchronized place(Landroid/view/View;Landroid/graphics/Point;Z)V
    ...
    .line 366
    iget v10, v1, Lcom/android/systemui/DessertCaseView;->mColumns:I

    sub-int/2addr v10, v11

    if-ge v3, v10, :cond_3

    iget v10, v1, Lcom/android/systemui/DessertCaseView;->mRows:I
    ...
    invoke-virtual {v0, v14, v10}, Landroid/view/View;->setTag(ILjava/lang/Object;)V
    ...
    .line 386
    .local v17, "oc":Landroid/graphics/Point;
    iget-object v11, v1, Lcom/android/systemui/DessertCaseView;->mCells:[Landroid/view/View;

    move-object/from16 v13, v17

    .end local v17    # "oc":Landroid/graphics/Point;
    .local v13, "oc":Landroid/graphics/Point;
    ...
    .line 387
    .local v9, "squatter":Landroid/view/View;
    if-eqz v9, :cond_4

    .line 388
    iget-object v11, v1, Lcom/android/systemui/DessertCaseView;->tmpSet:Ljava/util/HashSet;

    invoke-virtual {v11, v9}, Ljava/util/HashSet;->add(Ljava/lang/Object;)Z

    .line 385
    .end local v9    # "squatter":Landroid/view/View;
    .end local v13    # "oc":Landroid/graphics/Point;
    :cond_4
    ...
    .line 393
    .local v11, "squatter":Landroid/view/View;
    ...
    .line 394
    .local v13, "sq":Landroid/graphics/Point;
    iget-object v6, v1, Lcom/android/systemui/DessertCaseView;->mFreeList:Ljava/util/Set;

    invoke-interface {v6, v13}, Ljava/util/Set;->add(Ljava/lang/Object;)Z

    .line 395
    iget-object v6, v1, Lcom/android/systemui/DessertCaseView;->mCells:[Landroid/view/View;

    iget v8, v13, Landroid/graphics/Point;->y:I

    iget v2, v1, Lcom/android/systemui/DessertCaseView;->mColumns:I
    ...
    .line 393
    .end local v13    # "sq":Landroid/graphics/Point;
    ...
    invoke-virtual {v11, v6, v2}, Landroid/view/View;->setTag(ILjava/lang/Object;)V
    ...
    new-instance v12, Lcom/android/systemui/DessertCaseView$4;

    invoke-direct {v12, v1, v11}, Lcom/android/systemui/DessertCaseView$4;-><init>(Lcom/android/systemui/DessertCaseView;Landroid/view/View;)V
    ...
    .line 417
    .end local v11    # "squatter":Landroid/view/View;
    :goto_5
    move-object v8, v2
    ...
    .line 420
    .local v8, "oc":Landroid/graphics/Point;
    ...
    .end local v8    # "oc":Landroid/graphics/Point;
    add-int/lit8 v6, v6, 0x1
    ...
    .line 450
    .end local v6    # "set1":Landroid/animation/AnimatorSet;
    .end local v8    # "set2":Landroid/animation/AnimatorSet;
    goto :goto_7
