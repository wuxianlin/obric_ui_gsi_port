...
.method public final invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .local v0, "this":Landroidx/window/embedding/SplitController$splitInfoList$1;
    .local p1, "$result":Ljava/lang/Object;
    invoke-static {p1}, Lkotlin/ResultKt;->throwOnFailure(Ljava/lang/Object;)V

    goto :goto_0

    .end local v0    # "this":Landroidx/window/embedding/SplitController$splitInfoList$1;
    ...
    .local v1, "this":Landroidx/window/embedding/SplitController$splitInfoList$1;
    .restart local p1    # "$result":Ljava/lang/Object;
    iget-object v2, v1, Landroidx/window/embedding/SplitController$splitInfoList$1;->L$0:Ljava/lang/Object;

    check-cast v2, Lkotlinx/coroutines/channels/ProducerScope;

    .line 59
    .local v2, "$this$callbackFlow":Lkotlinx/coroutines/channels/ProducerScope;
    new-instance v3, Landroidx/window/embedding/SplitController$splitInfoList$1$$ExternalSyntheticLambda0;

    invoke-direct {v3, v2}, Landroidx/window/embedding/SplitController$splitInfoList$1$$ExternalSyntheticLambda0;-><init>(Lkotlinx/coroutines/channels/ProducerScope;)V

    .line 60
    .local v3, "listener":Landroidx/core/util/Consumer;
    iget-object v4, v1, Landroidx/window/embedding/SplitController$splitInfoList$1;->this$0:Landroidx/window/embedding/SplitController;

    invoke-static {v4}, Landroidx/window/embedding/SplitController;->access$getEmbeddingBackend$p(Landroidx/window/embedding/SplitController;)Landroidx/window/embedding/EmbeddingBackend;

    move-result-object v4

    iget-object v5, v1, Landroidx/window/embedding/SplitController$splitInfoList$1;->$activity:Landroid/app/Activity;
    ...
    invoke-interface {v4, v5, v6, v3}, Landroidx/window/embedding/EmbeddingBackend;->addSplitListenerForActivity(Landroid/app/Activity;Ljava/util/concurrent/Executor;Landroidx/core/util/Consumer;)V

    .line 61
    new-instance v4, Landroidx/window/embedding/SplitController$splitInfoList$1$2;

    iget-object v5, v1, Landroidx/window/embedding/SplitController$splitInfoList$1;->this$0:Landroidx/window/embedding/SplitController;

    invoke-direct {v4, v5, v3}, Landroidx/window/embedding/SplitController$splitInfoList$1$2;-><init>(Landroidx/window/embedding/SplitController;Landroidx/core/util/Consumer;)V
    ...
    iput v6, v1, Landroidx/window/embedding/SplitController$splitInfoList$1;->label:I
    ...
    .line 62
    .end local v1    # "this":Landroidx/window/embedding/SplitController$splitInfoList$1;
    .restart local v0    # "this":Landroidx/window/embedding/SplitController$splitInfoList$1;
    :goto_0
    sget-object v1, Lkotlin/Unit;->INSTANCE:Lkotlin/Unit;
