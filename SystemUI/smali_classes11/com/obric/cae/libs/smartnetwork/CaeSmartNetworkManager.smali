...
.method private informationListenerOnRetryBindFail()V
    ...
    invoke-interface {v3, v4, v4, v5}, Lcom/obric/cae/libs/smartnetwork/CaeSmartNetworkManager$CaeWifiLinkThroughputListener;->onThroughputReported(IIF)V
    ...
    invoke-interface {v3, v4, v4, v5}, Lcom/obric/cae/libs/smartnetwork/CaeSmartNetworkManager$CaeWifiLinkThroughputListener;->onSecondaryThroughputReported(IIF)V
...
.method private setBinderDeath()V
    ...
    invoke-interface {v0}, Lcom/obric/cae/libs/wifi/ICaeSmartNetworkManager;->asBinder()Landroid/os/IBinder;
...
.method public registerLinkThroughputListener(Lcom/obric/cae/libs/smartnetwork/CaeSmartNetworkManager$CaeWifiLinkThroughputListener;)V
    ...
    const-string/jumbo v4, "registerLinkThroughputListener failed: "
...
.method public retryGetServiceThread()V
    ...
    .line 172
    invoke-virtual {v0}, Lcom/obric/cae/libs/smartnetwork/CaeSmartNetworkManager$1;->start()V
...
.method public unregisterLinkThroughputListener(Lcom/obric/cae/libs/smartnetwork/CaeSmartNetworkManager$CaeWifiLinkThroughputListener;)V
    ...
    invoke-interface {p1}, Lcom/obric/cae/libs/smartnetwork/CaeSmartNetworkManager$CaeWifiLinkThroughputListener;->hashCode()I
    ...
    .line 224
    const-string/jumbo v2, "unregisterLinkThroughputListener failed: proxy is null"
    ...
    const-string/jumbo v4, "unregisterLinkThroughputListener failed: "
