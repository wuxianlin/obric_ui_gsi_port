...
.method public constructor <init>()V
    ...
    invoke-virtual {p0, p0, v0}, Lcom/obric/cae/libs/useraware/ICaeUserAware$Stub;->attachInterface(Landroid/os/IInterface;Ljava/lang/String;)V
...
.method public onTransact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    invoke-virtual {p0, v1}, Lcom/obric/cae/libs/useraware/ICaeUserAware$Stub;->unregisterSmartBluetoothEvent(Lcom/obric/cae/libs/bluetooth/ISmartBluetoothEventCallback;)V
    ...
    invoke-virtual {p0, v1}, Lcom/obric/cae/libs/useraware/ICaeUserAware$Stub;->registerSmartBluetoothEvent(Lcom/obric/cae/libs/bluetooth/ISmartBluetoothEventCallback;)V
    ...
    invoke-virtual {p0, v1, v3, v4}, Lcom/obric/cae/libs/useraware/ICaeUserAware$Stub;->setLevel2DataCollection(Ljava/util/List;ILcom/obric/cae/libs/useraware/HarLevel2DataResp;)V
    ...
    .line 609
    .local v1, "_arg0":I
    invoke-virtual {p0, v1}, Lcom/obric/cae/libs/useraware/ICaeUserAware$Stub;->setLevel2HarState(I)V
    ...
    .line 600
    invoke-virtual {p0}, Lcom/obric/cae/libs/useraware/ICaeUserAware$Stub;->cleanBssidsToAvoidRomingScan()V
    ...
    invoke-virtual {p0, v1}, Lcom/obric/cae/libs/useraware/ICaeUserAware$Stub;->removeBssidsToAvoidRomingScan(Ljava/util/List;)V
    ...
    .line 583
    invoke-virtual {p0}, Lcom/obric/cae/libs/useraware/ICaeUserAware$Stub;->getBssidsToAvoidRomingScan()Ljava/util/List;
    ...
    .line 576
    .local v1, "_arg0":Ljava/util/List;, "Ljava/util/List<Ljava/lang/String;>;"
    invoke-virtual {p0, v1}, Lcom/obric/cae/libs/useraware/ICaeUserAware$Stub;->addBssidsToAvoidRomingScan(Ljava/util/List;)V
    ...
    .line 566
    invoke-virtual {p0}, Lcom/obric/cae/libs/useraware/ICaeUserAware$Stub;->isAudioRecordEnabled()Z
    ...
    .line 559
    invoke-virtual {p0}, Lcom/obric/cae/libs/useraware/ICaeUserAware$Stub;->pauseAudioRecording()V
    ...
    .line 552
    invoke-virtual {p0}, Lcom/obric/cae/libs/useraware/ICaeUserAware$Stub;->resumeRecording()V
    ...
    .line 545
    invoke-virtual {p0}, Lcom/obric/cae/libs/useraware/ICaeUserAware$Stub;->stopAudioRecording()V
    ...
    invoke-virtual {p0, v1}, Lcom/obric/cae/libs/useraware/ICaeUserAware$Stub;->startAudioRecording(Ljava/lang/String;)V
    ...
    .line 522
    .local v3, "_arg0":B
    invoke-virtual {p0, v3}, Lcom/obric/cae/libs/useraware/ICaeUserAware$Stub;->getGeofenceStatusByGeoType(B)Lcom/obric/cae/libs/location/geofence/StarGeofence;
    ...
    .line 512
    invoke-virtual {p0}, Lcom/obric/cae/libs/useraware/ICaeUserAware$Stub;->getLocationStateValue()Ljava/lang/String;
    ...
    .line 498
    invoke-virtual {p0}, Lcom/obric/cae/libs/useraware/ICaeUserAware$Stub;->getGnssScanInfo()Lcom/obric/cae/libs/useraware/GnssSvAwareInfo;
    ...
    .line 484
    invoke-virtual {p0}, Lcom/obric/cae/libs/useraware/ICaeUserAware$Stub;->getLocationScanInfo()Lcom/obric/cae/libs/useraware/LocationAwareInfo;
    ...
    .line 477
    .local v3, "_arg1":I
    invoke-virtual {p0, v1, v3}, Lcom/obric/cae/libs/useraware/ICaeUserAware$Stub;->startLocationScan(ZI)V
    ...
    .line 465
    invoke-virtual {p0}, Lcom/obric/cae/libs/useraware/ICaeUserAware$Stub;->getBtScanInfo()Ljava/util/List;
    ...
    .line 458
    invoke-virtual {p0}, Lcom/obric/cae/libs/useraware/ICaeUserAware$Stub;->clearAllRssiDropThresholds()V
    ...
    .line 450
    invoke-virtual {p0}, Lcom/obric/cae/libs/useraware/ICaeUserAware$Stub;->getRssiDropThresholds()Ljava/util/List;
    ...
    invoke-virtual {p0, v1}, Lcom/obric/cae/libs/useraware/ICaeUserAware$Stub;->setRssiDropThresholds(Ljava/util/List;)V
    ...
    .line 434
    invoke-virtual {p0}, Lcom/obric/cae/libs/useraware/ICaeUserAware$Stub;->clearAllRssiThresholds()V
    ...
    .line 426
    invoke-virtual {p0}, Lcom/obric/cae/libs/useraware/ICaeUserAware$Stub;->getRssiThresholds()Ljava/util/List;
    ...
    invoke-virtual {p0, v1}, Lcom/obric/cae/libs/useraware/ICaeUserAware$Stub;->setRssiThresholds(Ljava/util/List;)V
    ...
    .line 409
    invoke-virtual {p0}, Lcom/obric/cae/libs/useraware/ICaeUserAware$Stub;->isFastWifiScanEnabled()Z
    ...
    .local v1, "_arg0":Z
    :cond_4
    invoke-virtual {p0, v1}, Lcom/obric/cae/libs/useraware/ICaeUserAware$Stub;->setFastWifiScanEnabled(Z)V
    ...
    .line 393
    .local v1, "_arg0":I
    invoke-virtual {p0, v1}, Lcom/obric/cae/libs/useraware/ICaeUserAware$Stub;->notifyGeofenceChanged(I)V
    ...
    invoke-virtual {p0, v1}, Lcom/obric/cae/libs/useraware/ICaeUserAware$Stub;->notifyRoomChangedPredicted(I)V
    ...
    .line 374
    invoke-virtual {p0}, Lcom/obric/cae/libs/useraware/ICaeUserAware$Stub;->isTrainingMode()Z
    ...
    .local v1, "_arg0":Z
    :cond_5
    invoke-virtual {p0, v1}, Lcom/obric/cae/libs/useraware/ICaeUserAware$Stub;->setTrainingMode(Z)V
    ...
    .line 358
    invoke-virtual {p0}, Lcom/obric/cae/libs/useraware/ICaeUserAware$Stub;->clearHomeWifiBssids()V
    ...
    .line 350
    invoke-virtual {p0}, Lcom/obric/cae/libs/useraware/ICaeUserAware$Stub;->getHomeWifiBssids()Ljava/util/List;
    ...
    .line 342
    .local v1, "_arg0":Ljava/lang/String;
    invoke-virtual {p0, v1}, Lcom/obric/cae/libs/useraware/ICaeUserAware$Stub;->isHomeWifiBssid(Ljava/lang/String;)Z
    ...
    .line 333
    .local v1, "_arg0":Ljava/util/List;, "Ljava/util/List<Ljava/lang/String;>;"
    invoke-virtual {p0, v1}, Lcom/obric/cae/libs/useraware/ICaeUserAware$Stub;->removeHomeWifiBssids(Ljava/util/List;)V
    ...
    invoke-virtual {p0, v1}, Lcom/obric/cae/libs/useraware/ICaeUserAware$Stub;->addHomeWifiBssids(Ljava/util/List;)V
    ...
    .line 314
    invoke-virtual {p0}, Lcom/obric/cae/libs/useraware/ICaeUserAware$Stub;->getWifiRomingChanged()Ljava/util/List;
    ...
    .line 300
    invoke-virtual {p0}, Lcom/obric/cae/libs/useraware/ICaeUserAware$Stub;->getWifiConnectInfo()Lcom/obric/cae/libs/useraware/WifiStandardData;
    ...
    .line 292
    invoke-virtual {p0}, Lcom/obric/cae/libs/useraware/ICaeUserAware$Stub;->getWifiScanNeighborAp()Ljava/util/List;
    ...
    .line 284
    invoke-virtual {p0}, Lcom/obric/cae/libs/useraware/ICaeUserAware$Stub;->getWifiScanInfo()Ljava/util/List;
    ...
    .line 276
    invoke-virtual {p0}, Lcom/obric/cae/libs/useraware/ICaeUserAware$Stub;->getNeighourCellInfo()Ljava/util/List;
    ...
    .line 262
    invoke-virtual {p0}, Lcom/obric/cae/libs/useraware/ICaeUserAware$Stub;->getCurrentCellInfo()Lcom/obric/cae/libs/useraware/CellAwareInfo;
    ...
    .line 254
    .local v5, "_arg3":I
    invoke-virtual {p0, v1, v3, v4, v5}, Lcom/obric/cae/libs/useraware/ICaeUserAware$Stub;->recordNearbyInfo(ZLjava/lang/String;II)Z
    ...
    invoke-virtual {p0, v1}, Lcom/obric/cae/libs/useraware/ICaeUserAware$Stub;->unregisterCallback(Lcom/obric/cae/libs/useraware/ICaeUserAwareCallback;)V
    ...
    invoke-virtual {p0, v1}, Lcom/obric/cae/libs/useraware/ICaeUserAware$Stub;->registerCallback(Lcom/obric/cae/libs/useraware/ICaeUserAwareCallback;)V
