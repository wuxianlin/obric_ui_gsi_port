...
# direct methods
.method public static synthetic $r8$lambda$FFwcNbMVSXJThPPXJdK-vJWnXb4(Lcom/obric/livecard/media/pipeline/MediaSessionsPipeline;Landroid/media/session/MediaController;)Lkotlin/Unit;
    .locals 0

    invoke-static {p0, p1}, Lcom/obric/livecard/media/pipeline/MediaSessionsPipeline;->getLastController$lambda$7$lambda$6(Lcom/obric/livecard/media/pipeline/MediaSessionsPipeline;Landroid/media/session/MediaController;)Lkotlin/Unit;
...
.method private final getLastController(Ljava/util/List;)Landroid/media/session/MediaController;
    ...
    new-instance v3, Lcom/obric/livecard/media/pipeline/MediaSessionsPipeline$getLastController$$inlined$sortedByDescending$1;

    invoke-direct {v3, p0}, Lcom/obric/livecard/media/pipeline/MediaSessionsPipeline$getLastController$$inlined$sortedByDescending$1;-><init>(Lcom/obric/livecard/media/pipeline/MediaSessionsPipeline;)V
    ...
    .line 110
    .local v2, "$i$a$-let-MediaSessionsPipeline$getLastController$2":I
    move-object v3, v1
    ...
    .line 110
    .local v8, "$i$a$-find-MediaSessionsPipeline$getLastController$2$1":I
    ...
    .end local v8    # "$i$a$-find-MediaSessionsPipeline$getLastController$2$1":I
    :goto_0
    if-eqz v7, :cond_0
    ...
    .line 125
    .restart local v7    # "it":Landroid/media/session/MediaController;
    const/4 v8, 0x0

    .line 111
    .local v8, "$i$a$-find-MediaSessionsPipeline$getLastController$2$2":I
    invoke-virtual {v7}, Landroid/media/session/MediaController;->getPlaybackState()Landroid/media/session/PlaybackState;
    ...
    invoke-direct {p0, v7}, Lcom/obric/livecard/media/pipeline/MediaSessionsPipeline;->isLastPlayingController(Landroid/media/session/MediaController;)Z
    ...
    .end local v7    # "it":Landroid/media/session/MediaController;
    .end local v8    # "$i$a$-find-MediaSessionsPipeline$getLastController$2$2":I
    :goto_3
    if-eqz v7, :cond_3
    ...
    .end local v2    # "$i$a$-let-MediaSessionsPipeline$getLastController$2":I
    goto :goto_5
    ...
    .line 113
    .local v1, "$i$a$-let-MediaSessionsPipeline$getLastController$3":I
    new-instance v2, Lcom/obric/livecard/media/pipeline/MediaSessionsPipeline$$ExternalSyntheticLambda0;

    invoke-direct {v2, p0, v0}, Lcom/obric/livecard/media/pipeline/MediaSessionsPipeline$$ExternalSyntheticLambda0;-><init>(Lcom/obric/livecard/media/pipeline/MediaSessionsPipeline;Landroid/media/session/MediaController;)V

    invoke-static {v2}, Lcom/obric/livecard/ThreadUtilsKt;->runOnMainThreadBlock(Lkotlin/jvm/functions/Function0;)Ljava/lang/Object;

    .line 114
    invoke-direct {p0, v0}, Lcom/obric/livecard/media/pipeline/MediaSessionsPipeline;->isLastPlayingController(Landroid/media/session/MediaController;)Z
    ...
    .end local v1    # "$i$a$-let-MediaSessionsPipeline$getLastController$3":I
    :cond_9
    nop
...
.method private static final getLastController$lambda$7$lambda$6(Lcom/obric/livecard/media/pipeline/MediaSessionsPipeline;Landroid/media/session/MediaController;)Lkotlin/Unit;
    .locals 5
