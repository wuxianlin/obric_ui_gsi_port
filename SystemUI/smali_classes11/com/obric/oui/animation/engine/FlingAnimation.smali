...
.method public constructor <init>(Lcom/obric/oui/animation/engine/FloatValueHolder;)V
    ...
    .line 40
    new-instance v0, Lcom/obric/oui/animation/engine/FlingAnimation$DragForce;

    invoke-direct {v0}, Lcom/obric/oui/animation/engine/FlingAnimation$DragForce;-><init>()V

    iput-object v0, p0, Lcom/obric/oui/animation/engine/FlingAnimation;->mFlingForce:Lcom/obric/oui/animation/engine/FlingAnimation$DragForce;
    ...
    invoke-virtual {v0, v1}, Lcom/obric/oui/animation/engine/FlingAnimation$DragForce;->setValueThreshold(F)V
...
.method getAcceleration(FF)F
    ...
    invoke-virtual {v0, p1, p2}, Lcom/obric/oui/animation/engine/FlingAnimation$DragForce;->getAcceleration(FF)F
...
.method public getFriction()F
    ...
    invoke-virtual {v0}, Lcom/obric/oui/animation/engine/FlingAnimation$DragForce;->getFrictionScalar()F
...
.method isAtEquilibrium(FF)Z
    ...
    .line 182
    invoke-virtual {v0, p1, p2}, Lcom/obric/oui/animation/engine/FlingAnimation$DragForce;->isAtEquilibrium(FF)Z
...
.method setValueThreshold(F)V
    ...
    invoke-virtual {v0, p1}, Lcom/obric/oui/animation/engine/FlingAnimation$DragForce;->setValueThreshold(F)V
...
.method updateValueAndVelocity(J)Z
    ...
    .line 154
    .local v0, "state":Lcom/obric/oui/animation/engine/DynamicAnimation$MassState;
    iget v1, v0, Lcom/obric/oui/animation/engine/DynamicAnimation$MassState;->mValue:F

    iput v1, p0, Lcom/obric/oui/animation/engine/FlingAnimation;->mValue:F

    .line 155
    iget v1, v0, Lcom/obric/oui/animation/engine/DynamicAnimation$MassState;->mVelocity:F

    iput v1, p0, Lcom/obric/oui/animation/engine/FlingAnimation;->mVelocity:F

    .line 158
    iget v1, p0, Lcom/obric/oui/animation/engine/FlingAnimation;->mValue:F

    iget v2, p0, Lcom/obric/oui/animation/engine/FlingAnimation;->mMinValue:F
    ...
    .line 159
    iget v1, p0, Lcom/obric/oui/animation/engine/FlingAnimation;->mMinValue:F
    ...
    iget v3, p0, Lcom/obric/oui/animation/engine/FlingAnimation;->mMaxValue:F
    ...
    .line 163
    iget v1, p0, Lcom/obric/oui/animation/engine/FlingAnimation;->mMaxValue:F
    ...
    iget v3, p0, Lcom/obric/oui/animation/engine/FlingAnimation;->mVelocity:F

    invoke-virtual {p0, v1, v3}, Lcom/obric/oui/animation/engine/FlingAnimation;->isAtEquilibrium(FF)Z
