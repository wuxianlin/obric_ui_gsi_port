...
.method public constructor <init>(Lcom/obric/oui/animation/engine/FloatValueHolder;)V
    ...
    iput v0, p0, Lcom/obric/oui/animation/engine/SpringAnimation;->mPendingPosition:F
...
.method public constructor <init>(Ljava/lang/Object;Lcom/obric/oui/animation/engine/FloatPropertyCompat;F)V
    ...
    invoke-direct {v0, p3}, Lcom/obric/oui/animation/engine/SpringForce;-><init>(F)V
...
.method private sanityCheck()V
    ...
    .line 203
    iget v2, p0, Lcom/obric/oui/animation/engine/SpringAnimation;->mMinValue:F
...
.method public canSkipToEnd()Z
    ...
    iget-wide v0, v0, Lcom/obric/oui/animation/engine/SpringForce;->mDampingRatio:D
...
.method getAcceleration(FF)F
    ...
    invoke-virtual {v0, p1, p2}, Lcom/obric/oui/animation/engine/SpringForce;->getAcceleration(FF)F
...
.method isAtEquilibrium(FF)Z
    ...
    invoke-virtual {v0, p1, p2}, Lcom/obric/oui/animation/engine/SpringForce;->isAtEquilibrium(FF)Z
...
.method public setSpring(Lcom/obric/oui/animation/engine/SpringForce;)Lcom/obric/oui/animation/engine/SpringAnimation;
    .locals 0
    .param p1, "force"    # Lcom/obric/oui/animation/engine/SpringForce;
...
.method updateValueAndVelocity(J)Z
    ...
    iget v3, v0, Lcom/obric/oui/animation/engine/SpringAnimation;->mPendingPosition:F

    invoke-virtual {v1, v3}, Lcom/obric/oui/animation/engine/SpringForce;->setFinalPosition(F)Lcom/obric/oui/animation/engine/SpringForce;

    .line 216
    iput v2, v0, Lcom/obric/oui/animation/engine/SpringAnimation;->mPendingPosition:F
    ...
    .line 219
    iput v10, v0, Lcom/obric/oui/animation/engine/SpringAnimation;->mVelocity:F

    .line 220
    iput-boolean v9, v0, Lcom/obric/oui/animation/engine/SpringAnimation;->mEndRequested:Z
    ...
    iget-object v11, v0, Lcom/obric/oui/animation/engine/SpringAnimation;->mSpring:Lcom/obric/oui/animation/engine/SpringForce;
    ...
    invoke-virtual/range {v11 .. v17}, Lcom/obric/oui/animation/engine/SpringForce;->updateValues(DDJ)Lcom/obric/oui/animation/engine/DynamicAnimation$MassState;

    move-result-object v1

    .line 229
    .local v1, "massState":Lcom/obric/oui/animation/engine/DynamicAnimation$MassState;
    iget-object v7, v0, Lcom/obric/oui/animation/engine/SpringAnimation;->mSpring:Lcom/obric/oui/animation/engine/SpringForce;

    iget v11, v0, Lcom/obric/oui/animation/engine/SpringAnimation;->mPendingPosition:F

    invoke-virtual {v7, v11}, Lcom/obric/oui/animation/engine/SpringForce;->setFinalPosition(F)Lcom/obric/oui/animation/engine/SpringForce;

    .line 230
    iput v2, v0, Lcom/obric/oui/animation/engine/SpringAnimation;->mPendingPosition:F

    .line 232
    iget-object v12, v0, Lcom/obric/oui/animation/engine/SpringAnimation;->mSpring:Lcom/obric/oui/animation/engine/SpringForce;

    iget v2, v1, Lcom/obric/oui/animation/engine/DynamicAnimation$MassState;->mValue:F

    float-to-double v13, v2

    iget v2, v1, Lcom/obric/oui/animation/engine/DynamicAnimation$MassState;->mVelocity:F
    ...
    invoke-virtual/range {v12 .. v18}, Lcom/obric/oui/animation/engine/SpringForce;->updateValues(DDJ)Lcom/obric/oui/animation/engine/DynamicAnimation$MassState;
    ...
    iput v2, v0, Lcom/obric/oui/animation/engine/SpringAnimation;->mValue:F

    .line 234
    iget v2, v1, Lcom/obric/oui/animation/engine/DynamicAnimation$MassState;->mVelocity:F

    iput v2, v0, Lcom/obric/oui/animation/engine/SpringAnimation;->mVelocity:F

    .line 236
    .end local v1    # "massState":Lcom/obric/oui/animation/engine/DynamicAnimation$MassState;
    ...
    iget v2, v0, Lcom/obric/oui/animation/engine/SpringAnimation;->mValue:F

    float-to-double v2, v2

    iget v4, v0, Lcom/obric/oui/animation/engine/SpringAnimation;->mVelocity:F

    float-to-double v4, v4

    move-wide/from16 v6, p1

    invoke-virtual/range {v1 .. v7}, Lcom/obric/oui/animation/engine/SpringForce;->updateValues(DDJ)Lcom/obric/oui/animation/engine/DynamicAnimation$MassState;

    move-result-object v1

    .line 238
    .restart local v1    # "massState":Lcom/obric/oui/animation/engine/DynamicAnimation$MassState;
    iget v2, v1, Lcom/obric/oui/animation/engine/DynamicAnimation$MassState;->mValue:F
    ...
    iget v2, v0, Lcom/obric/oui/animation/engine/SpringAnimation;->mMinValue:F
    ...
    iget v2, v0, Lcom/obric/oui/animation/engine/SpringAnimation;->mMaxValue:F
    ...
    iget v2, v0, Lcom/obric/oui/animation/engine/SpringAnimation;->mVelocity:F

    invoke-virtual {v0, v1, v2}, Lcom/obric/oui/animation/engine/SpringAnimation;->isAtEquilibrium(FF)Z
