...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;IZ)V
    ...
    iput-boolean v0, p0, Lcom/obric/oui/radio/ORadio;->adaptForCSR:Z
    ...
    .line 25
    sget-object v1, Lcom/obric/common/oui/R$styleable;->ORadio:[I
    ...
    const-string v3, "context.obtainStyledAttr\u2026.ORadio, defStyleAttr, 0)"

    invoke-static {v1, v3}, Lkotlin/jvm/internal/Intrinsics;->checkNotNullExpressionValue(Ljava/lang/Object;Ljava/lang/String;)V

    .line 26
    .local v1, "array":Landroid/content/res/TypedArray;
    sget v3, Lcom/obric/common/oui/R$styleable;->ORadio_oui_fitOld:I

    iget-boolean v4, p0, Lcom/obric/oui/radio/ORadio;->isFitOld:Z

    invoke-virtual {v1, v3, v4}, Landroid/content/res/TypedArray;->getBoolean(IZ)Z

    move-result v3

    iput-boolean v3, p0, Lcom/obric/oui/radio/ORadio;->isFitOld:Z

    .line 27
    sget v3, Lcom/obric/common/oui/R$styleable;->ORadio_oui_radioStyle:I

    invoke-virtual {v1, v3, v2}, Landroid/content/res/TypedArray;->getInt(II)I

    move-result v3

    iput v3, p0, Lcom/obric/oui/radio/ORadio;->style:I

    .line 28
    sget v3, Lcom/obric/common/oui/R$styleable;->ORadio_oui_adapt_for_csr:I

    invoke-virtual {v1, v3, v0}, Landroid/content/res/TypedArray;->getBoolean(IZ)Z

    move-result v3

    iput-boolean v3, p0, Lcom/obric/oui/radio/ORadio;->adaptForCSR:Z

    .line 29
    sget v3, Lcom/obric/common/oui/R$styleable;->ORadio_oui_radioAlwaysLight:I

    invoke-virtual {v1, v3, v2}, Landroid/content/res/TypedArray;->getBoolean(IZ)Z

    move-result v2

    iput-boolean v2, p0, Lcom/obric/oui/radio/ORadio;->alwaysLight:Z
    ...
    :cond_0
    iget-boolean v1, p0, Lcom/obric/oui/radio/ORadio;->isFitOld:Z
    ...
    .line 35
    :cond_1
    invoke-virtual {p0, v0}, Lcom/obric/oui/radio/ORadio;->setClickable(Z)V
...
.method public setChecked(Z)V
    ...
    :goto_0
    invoke-virtual {p0, v0}, Lcom/obric/oui/radio/ORadio;->setVisibility(I)V
