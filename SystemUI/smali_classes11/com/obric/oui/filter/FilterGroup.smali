...
.method private final addAllFilters(Landroid/view/ViewGroup;)V
    ...
    invoke-direct {p0, v3}, Lcom/obric/oui/filter/FilterGroup;->addAllFilters(Landroid/view/ViewGroup;)V
    ...
    check-cast v3, Lcom/obric/oui/filter/OFilter;

    const/4 v4, 0x1

    invoke-virtual {p0, v3, v4}, Lcom/obric/oui/filter/FilterGroup;->add(Lcom/obric/oui/filter/OFilter;Z)V
...
.method private final setSelected(Lcom/obric/oui/filter/OFilter;)V
    .locals 1
    .param p1, "btn"    # Lcom/obric/oui/filter/OFilter;
    ...
    .line 61
    iget-object v0, p0, Lcom/obric/oui/filter/FilterGroup;->listener:Lcom/obric/oui/filter/FilterGroup$onItemSelectedListener;

    if-eqz v0, :cond_0

    invoke-interface {v0, p1}, Lcom/obric/oui/filter/FilterGroup$onItemSelectedListener;->onItemSelected(Lcom/obric/oui/filter/OFilter;)V
...
.method public final add(Lcom/obric/oui/filter/OFilter;Z)V
    .locals 1
    .param p1, "btn"    # Lcom/obric/oui/filter/OFilter;
    .param p2, "autoSelectWhenClick"    # Z
    ...
    .line 45
    new-instance v0, Lcom/obric/oui/filter/FilterGroup$add$1;

    invoke-direct {v0, p0}, Lcom/obric/oui/filter/FilterGroup$add$1;-><init>(Lcom/obric/oui/filter/FilterGroup;)V

    check-cast v0, Landroid/view/View$OnClickListener;

    invoke-virtual {p1, v0}, Lcom/obric/oui/filter/OFilter;->setOnClickListener(Landroid/view/View$OnClickListener;)V
...
.method public final disableAll()V
    ...
    .line 122
    .local v5, "$i$a$-forEach-FilterGroup$disableAll$1":I
    const/4 v6, 0x1

    invoke-virtual {p0, v4, v6}, Lcom/obric/oui/filter/FilterGroup;->setDisabled(Lcom/obric/oui/filter/OFilter;Z)V
    ...
    .end local v5    # "$i$a$-forEach-FilterGroup$disableAll$1":I
    goto :goto_0
...
.method public final dismiss(Lcom/obric/oui/filter/OFilter;)V
    ...
    .line 93
    .local v5, "$i$a$-forEach-FilterGroup$dismiss$1":I
    move-object v6, v4

    check-cast v6, Landroid/view/View;

    invoke-static {v6}, Lcom/obric/oui/common/util/ViewExtensionsKt;->isVisibile(Landroid/view/View;)Z

    move-result v6

    if-eqz v6, :cond_0

    invoke-virtual {v4}, Lcom/obric/oui/filter/OFilter;->isEnabled()Z
    ...
    invoke-virtual {p0, v2}, Lcom/obric/oui/filter/FilterGroup;->select(Landroid/view/View;)V
    ...
    .end local v3    # "element$iv":Ljava/lang/Object;
    .end local v4    # "it":Lcom/obric/oui/filter/OFilter;
    .end local v5    # "$i$a$-forEach-FilterGroup$dismiss$1":I
    goto :goto_0
...
.method public final enable(Lcom/obric/oui/filter/OFilter;)V
    ...
    invoke-virtual {p1, v0}, Lcom/obric/oui/filter/OFilter;->setEnabled(Z)V
...
.method public final enableAll()V
    ...
    .line 116
    .local v5, "$i$a$-forEach-FilterGroup$enableAll$1":I
    const/4 v6, 0x1

    invoke-virtual {v4, v6}, Lcom/obric/oui/filter/OFilter;->setEnabled(Z)V
    ...
    .end local v3    # "element$iv":Ljava/lang/Object;
    .end local v4    # "it":Lcom/obric/oui/filter/OFilter;
    .end local v5    # "$i$a$-forEach-FilterGroup$enableAll$1":I
    goto :goto_0
...
.method public final getSelected()Lcom/obric/oui/filter/OFilter;
    ...
    .line 19
    iget-object v0, p0, Lcom/obric/oui/filter/FilterGroup;->selected:Lcom/obric/oui/filter/OFilter;
...
.method public final registerContainer(Landroid/view/ViewGroup;Z)V
    ...
    invoke-virtual {p0, v0}, Lcom/obric/oui/filter/FilterGroup;->select(Landroid/view/View;)V
...
.method public final registerItemSelectedListener(Lcom/obric/oui/filter/FilterGroup$onItemSelectedListener;)V
    .locals 1
    .param p1, "listener"    # Lcom/obric/oui/filter/FilterGroup$onItemSelectedListener;
...
.method public final select(Landroid/view/View;)V
    ...
    .line 53
    .local v5, "$i$a$-forEach-FilterGroup$select$1":I
    ...
    invoke-direct {p0, v4}, Lcom/obric/oui/filter/FilterGroup;->setUnselected(Lcom/obric/oui/filter/OFilter;)V
    ...
    .end local v3    # "element$iv":Ljava/lang/Object;
    .end local v4    # "it":Lcom/obric/oui/filter/OFilter;
    .end local v5    # "$i$a$-forEach-FilterGroup$select$1":I
    goto :goto_0
    ...
    invoke-direct {p0, v0}, Lcom/obric/oui/filter/FilterGroup;->setSelected(Lcom/obric/oui/filter/OFilter;)V
...
.method public final selectFirstEnabledItem()V
    ...
    .line 83
    .local v1, "child":Lcom/obric/oui/filter/OFilter;
    ...
    invoke-static {v2}, Lcom/obric/oui/common/util/ViewExtensionsKt;->isVisibile(Landroid/view/View;)Z
    ...
    .line 82
    .end local v1    # "child":Lcom/obric/oui/filter/OFilter;
    :cond_0
    goto :goto_0
...
.method public final showAll()V
    ...
    .line 110
    .local v5, "$i$a$-forEach-FilterGroup$showAll$1":I
    move-object v6, v4

    check-cast v6, Landroid/view/View;

    invoke-static {v6}, Lcom/obric/oui/common/util/ViewExtensionsKt;->makeVisible(Landroid/view/View;)V
    ...
    .end local v3    # "element$iv":Ljava/lang/Object;
    .end local v4    # "it":Lcom/obric/oui/filter/OFilter;
    .end local v5    # "$i$a$-forEach-FilterGroup$showAll$1":I
    goto :goto_0
