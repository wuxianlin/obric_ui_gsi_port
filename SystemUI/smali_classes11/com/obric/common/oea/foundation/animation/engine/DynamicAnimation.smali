...
.method constructor <init>(Lcom/obric/common/oea/foundation/animation/engine/FloatValueHolder;)V
    ...
    .line 329
    .local p0, "this":Lcom/obric/common/oea/foundation/animation/engine/DynamicAnimation;, "Lcom/obric/common/oea/foundation/animation/engine/DynamicAnimation<TT;>;"
...
.method constructor <init>(Ljava/lang/Object;Lcom/obric/common/oea/foundation/animation/engine/FloatPropertyCompat;)V
    ...
    sget-object v1, Lcom/obric/common/oea/foundation/animation/engine/DynamicAnimation;->ROTATION:Lcom/obric/common/oea/foundation/animation/engine/DynamicAnimation$ViewProperty;

    if-eq v0, v1, :cond_4

    iget-object v0, p0, Lcom/obric/common/oea/foundation/animation/engine/DynamicAnimation;->mProperty:Lcom/obric/common/oea/foundation/animation/engine/FloatPropertyCompat;

    sget-object v1, Lcom/obric/common/oea/foundation/animation/engine/DynamicAnimation;->ROTATION_X:Lcom/obric/common/oea/foundation/animation/engine/DynamicAnimation$ViewProperty;

    if-eq v0, v1, :cond_4

    iget-object v0, p0, Lcom/obric/common/oea/foundation/animation/engine/DynamicAnimation;->mProperty:Lcom/obric/common/oea/foundation/animation/engine/FloatPropertyCompat;

    sget-object v1, Lcom/obric/common/oea/foundation/animation/engine/DynamicAnimation;->ROTATION_Y:Lcom/obric/common/oea/foundation/animation/engine/DynamicAnimation$ViewProperty;
    ...
    sget-object v1, Lcom/obric/common/oea/foundation/animation/engine/DynamicAnimation;->ALPHA:Lcom/obric/common/oea/foundation/animation/engine/DynamicAnimation$ViewProperty;
    ...
    .line 359
    iput v2, p0, Lcom/obric/common/oea/foundation/animation/engine/DynamicAnimation;->mMinVisibleChange:F
    ...
    sget-object v1, Lcom/obric/common/oea/foundation/animation/engine/DynamicAnimation;->SCALE_X:Lcom/obric/common/oea/foundation/animation/engine/DynamicAnimation$ViewProperty;
...
.method private endAnimationInternal(Z)V
    ...
    invoke-static {v0}, Lcom/obric/common/oea/foundation/animation/engine/DynamicAnimation;->removeNullEntries(Ljava/util/ArrayList;)V
...
.method private getPropertyValue()F
    ...
    invoke-virtual {v0, v1}, Lcom/obric/common/oea/foundation/animation/engine/FloatPropertyCompat;->getValue(Ljava/lang/Object;)F
...
.method public doAnimationFrame(J)Z
    ...
    invoke-virtual {p0, v0}, Lcom/obric/common/oea/foundation/animation/engine/DynamicAnimation;->setPropertyValue(F)V
    ...
    .line 643
    :cond_0
    iget-wide v2, p0, Lcom/obric/common/oea/foundation/animation/engine/DynamicAnimation;->mLastFrameTime:J
    ...
    .line 645
    invoke-virtual {p0, v2, v3}, Lcom/obric/common/oea/foundation/animation/engine/DynamicAnimation;->updateValueAndVelocity(J)Z

    move-result v0

    .line 647
    .local v0, "finished":Z
    iget v4, p0, Lcom/obric/common/oea/foundation/animation/engine/DynamicAnimation;->mValue:F

    iget v5, p0, Lcom/obric/common/oea/foundation/animation/engine/DynamicAnimation;->mMaxValue:F

    invoke-static {v4, v5}, Ljava/lang/Math;->min(FF)F

    move-result v4

    iput v4, p0, Lcom/obric/common/oea/foundation/animation/engine/DynamicAnimation;->mValue:F

    .line 648
    iget v4, p0, Lcom/obric/common/oea/foundation/animation/engine/DynamicAnimation;->mValue:F

    iget v5, p0, Lcom/obric/common/oea/foundation/animation/engine/DynamicAnimation;->mMinValue:F
    ...
    invoke-virtual {p0, v4}, Lcom/obric/common/oea/foundation/animation/engine/DynamicAnimation;->setPropertyValue(F)V

    .line 652
    if-eqz v0, :cond_1

    .line 653
    invoke-direct {p0, v1}, Lcom/obric/common/oea/foundation/animation/engine/DynamicAnimation;->endAnimationInternal(Z)V
...
.method public getMinimumVisibleChange()F
    ...
    .line 534
    .local p0, "this":Lcom/obric/common/oea/foundation/animation/engine/DynamicAnimation;, "Lcom/obric/common/oea/foundation/animation/engine/DynamicAnimation<TT;>;"
    iget v0, p0, Lcom/obric/common/oea/foundation/animation/engine/DynamicAnimation;->mMinVisibleChange:F
...
.method public removeEndListener(Lcom/obric/common/oea/foundation/animation/engine/DynamicAnimation$OnAnimationEndListener;)V
    ...
    invoke-static {v0, p1}, Lcom/obric/common/oea/foundation/animation/engine/DynamicAnimation;->removeEntry(Ljava/util/ArrayList;Ljava/lang/Object;)V
...
.method public setMinimumVisibleChange(F)Lcom/obric/common/oea/foundation/animation/engine/DynamicAnimation;
    ...
    invoke-virtual {p0, v0}, Lcom/obric/common/oea/foundation/animation/engine/DynamicAnimation;->setValueThreshold(F)V
...
.method setPropertyValue(F)V
    ...
    .local v0, "i":I
    :goto_0
    iget-object v1, p0, Lcom/obric/common/oea/foundation/animation/engine/DynamicAnimation;->mUpdateListeners:Ljava/util/ArrayList;
    ...
    invoke-interface {v1, p0, v2, v3}, Lcom/obric/common/oea/foundation/animation/engine/DynamicAnimation$OnAnimationUpdateListener;->onAnimationUpdate(Lcom/obric/common/oea/foundation/animation/engine/DynamicAnimation;FF)V
