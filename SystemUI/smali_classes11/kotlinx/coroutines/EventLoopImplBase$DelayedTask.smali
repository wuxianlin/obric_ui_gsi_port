...
.method public final scheduleTask(JLkotlinx/coroutines/EventLoopImplBase$DelayedTaskQueue;Lkotlinx/coroutines/EventLoopImplBase;)I
    ...
    .line 438
    .local v8, "$i$a$-synchronized-EventLoopImplBase$DelayedTask$scheduleTask$1":I
    :try_start_0
    ...
    .end local v8    # "$i$a$-synchronized-EventLoopImplBase$DelayedTask$scheduleTask$1":I
    monitor-exit p0
    ...
    .restart local v8    # "$i$a$-synchronized-EventLoopImplBase$DelayedTask$scheduleTask$1":I
    :cond_0
    :try_start_1
    move-object v0, v4
    ...
    .local v9, "this_$iv":Lkotlinx/coroutines/internal/ThreadSafeHeap;
    const/4 v10, 0x0

    .line 549
    .local v10, "$i$f$addLastIf":I
    const/4 v11, 0x0
    ...
    .line 554
    .local v12, "$i$f$synchronizedImpl":I
    monitor-enter v9
    :try_end_1
    ...
    :try_start_2
    invoke-virtual {v9}, Lkotlinx/coroutines/internal/ThreadSafeHeap;->firstImpl()Lkotlinx/coroutines/internal/ThreadSafeHeapNode;

    move-result-object v13

    check-cast v13, Lkotlinx/coroutines/EventLoopImplBase$DelayedTask;

    .local v13, "firstTask":Lkotlinx/coroutines/EventLoopImplBase$DelayedTask;
    const/4 v14, 0x0

    .line 440
    .local v14, "$i$a$-addLastIf-EventLoopImplBase$DelayedTask$scheduleTask$1$1":I
    ...
    .end local v9    # "this_$iv":Lkotlinx/coroutines/internal/ThreadSafeHeap;
    .end local v10    # "$i$f$addLastIf":I
    .end local v11    # "$i$f$synchronized":I
    .end local v12    # "$i$f$synchronizedImpl":I
    .end local v13    # "firstTask":Lkotlinx/coroutines/EventLoopImplBase$DelayedTask;
    .end local v14    # "$i$a$-addLastIf-EventLoopImplBase$DelayedTask$scheduleTask$1$1":I
    :try_start_3
    monitor-exit v9
    :try_end_3
    ...
    .restart local v8    # "$i$a$-synchronized-EventLoopImplBase$DelayedTask$scheduleTask$1":I
    .restart local v9    # "this_$iv":Lkotlinx/coroutines/internal/ThreadSafeHeap;
    .restart local v10    # "$i$f$addLastIf":I
    .restart local v11    # "$i$f$synchronized":I
    .restart local v12    # "$i$f$synchronizedImpl":I
    .restart local v13    # "firstTask":Lkotlinx/coroutines/EventLoopImplBase$DelayedTask;
    .restart local v14    # "$i$a$-addLastIf-EventLoopImplBase$DelayedTask$scheduleTask$1$1":I
    :cond_1
    ...
    :try_start_5
    iget-wide v5, v13, Lkotlinx/coroutines/EventLoopImplBase$DelayedTask;->nanoTime:J
    ...
    invoke-virtual {v9, v2}, Lkotlinx/coroutines/internal/ThreadSafeHeap;->addImpl(Lkotlinx/coroutines/internal/ThreadSafeHeapNode;)V
    :try_end_5
