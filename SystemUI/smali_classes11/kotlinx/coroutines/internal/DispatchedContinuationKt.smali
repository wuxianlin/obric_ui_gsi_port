...
.method private static final executeUnconfined(Lkotlinx/coroutines/internal/DispatchedContinuation;Ljava/lang/Object;IZLkotlin/jvm/functions/Function0;)Z
    ...
    :try_start_1
    invoke-virtual {v4, v6, v7}, Lkotlinx/coroutines/DispatchedTask;->handleFatalException$external__kotlinx_coroutines__linux_glibc_common__kotlinx_coroutines_host(Ljava/lang/Throwable;Ljava/lang/Throwable;)V
    :try_end_1
...
.method static synthetic executeUnconfined$default(Lkotlinx/coroutines/internal/DispatchedContinuation;Ljava/lang/Object;IZLkotlin/jvm/functions/Function0;ILjava/lang/Object;)Z
    ...
    invoke-virtual {p6}, Lkotlinx/coroutines/ThreadLocalEventLoop;->getEventLoop$external__kotlinx_coroutines__linux_glibc_common__kotlinx_coroutines_host()Lkotlinx/coroutines/EventLoop;
    ...
    :try_start_1
    invoke-virtual {v2, v4, v5}, Lkotlinx/coroutines/DispatchedTask;->handleFatalException$external__kotlinx_coroutines__linux_glibc_common__kotlinx_coroutines_host(Ljava/lang/Throwable;Ljava/lang/Throwable;)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_1
...
.method public static final resumeCancellableWith(Lkotlin/coroutines/Continuation;Ljava/lang/Object;Lkotlin/jvm/functions/Function1;)V
    ...
    .line 318
    .local v3, "$i$f$resumeCancellableWith$external__kotlinx_coroutines__linux_glibc_common__kotlinx_coroutines_host":I
    ...
    .line 347
    .local v14, "$i$f$resumeCancelled$external__kotlinx_coroutines__linux_glibc_common__kotlinx_coroutines_host":I
    :try_start_0
    ...
    invoke-virtual {v0, v4, v1}, Lkotlinx/coroutines/internal/DispatchedContinuation;->cancelCompletedResult$external__kotlinx_coroutines__linux_glibc_common__kotlinx_coroutines_host(Ljava/lang/Object;Ljava/lang/Throwable;)V
    ...
    .end local v14    # "$i$f$resumeCancelled$external__kotlinx_coroutines__linux_glibc_common__kotlinx_coroutines_host":I
    ...
    .restart local v14    # "$i$f$resumeCancelled$external__kotlinx_coroutines__linux_glibc_common__kotlinx_coroutines_host":I
    :cond_3
    move-object/from16 v17, v0
    ...
    .line 356
    .local v5, "$i$f$resumeUndispatchedWith$external__kotlinx_coroutines__linux_glibc_common__kotlinx_coroutines_host":I
    :try_start_2
    ...
    .end local v5    # "$i$f$resumeUndispatchedWith$external__kotlinx_coroutines__linux_glibc_common__kotlinx_coroutines_host":I
    .end local v13    # "$i$a$-executeUnconfined$default-DispatchedContinuation$resumeCancellableWith$1$iv":I
    ...
    .restart local v5    # "$i$f$resumeUndispatchedWith$external__kotlinx_coroutines__linux_glibc_common__kotlinx_coroutines_host":I
    .restart local v13    # "$i$a$-executeUnconfined$default-DispatchedContinuation$resumeCancellableWith$1$iv":I
    ...
    .end local v3    # "$i$f$resumeCancellableWith$external__kotlinx_coroutines__linux_glibc_common__kotlinx_coroutines_host":I
    ...
    .end local v19    # "$i$f$resumeCancellableWith$external__kotlinx_coroutines__linux_glibc_common__kotlinx_coroutines_host":I
    .local v2, "this_$iv":Lkotlinx/coroutines/internal/DispatchedContinuation;
    .restart local v3    # "$i$f$resumeCancellableWith$external__kotlinx_coroutines__linux_glibc_common__kotlinx_coroutines_host":I
    .restart local v13    # "$i$a$-executeUnconfined$default-DispatchedContinuation$resumeCancellableWith$1$iv":I
    :cond_9
    move-object/from16 v1, p1
    ...
    :try_start_8
    invoke-virtual {v11, v0, v2}, Lkotlinx/coroutines/DispatchedTask;->handleFatalException$external__kotlinx_coroutines__linux_glibc_common__kotlinx_coroutines_host(Ljava/lang/Throwable;Ljava/lang/Throwable;)V
    :try_end_8
...
.method public static final yieldUndispatched(Lkotlinx/coroutines/internal/DispatchedContinuation;)Z
    ...
    invoke-virtual {v5}, Lkotlinx/coroutines/ThreadLocalEventLoop;->getEventLoop$external__kotlinx_coroutines__linux_glibc_common__kotlinx_coroutines_host()Lkotlinx/coroutines/EventLoop;
    ...
    :try_start_1
    invoke-virtual {v6, v10, v11}, Lkotlinx/coroutines/DispatchedTask;->handleFatalException$external__kotlinx_coroutines__linux_glibc_common__kotlinx_coroutines_host(Ljava/lang/Throwable;Ljava/lang/Throwable;)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_1
