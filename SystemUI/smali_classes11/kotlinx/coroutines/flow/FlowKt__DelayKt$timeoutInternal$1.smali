...
.method public final invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .local v1, "this":Lkotlinx/coroutines/flow/FlowKt__DelayKt$timeoutInternal$1;
    ...
    .local v6, "$i$a$-run-SelectKt$select$3$iv$iv":I
    iget-wide v7, v1, Lkotlinx/coroutines/flow/FlowKt__DelayKt$timeoutInternal$1;->J$0:J

    iget-object v9, v1, Lkotlinx/coroutines/flow/FlowKt__DelayKt$timeoutInternal$1;->L$1:Ljava/lang/Object;

    check-cast v9, Lkotlinx/coroutines/channels/ReceiveChannel;

    .local v9, "values":Lkotlinx/coroutines/channels/ReceiveChannel;
    iget-object v10, v1, Lkotlinx/coroutines/flow/FlowKt__DelayKt$timeoutInternal$1;->L$0:Ljava/lang/Object;
    ...
    .end local v1    # "this":Lkotlinx/coroutines/flow/FlowKt__DelayKt$timeoutInternal$1;
    .end local v2    # "$result":Ljava/lang/Object;
    .end local v4    # "$i$f$whileSelect":I
    .end local v5    # "$i$f$select":I
    .end local v6    # "$i$a$-run-SelectKt$select$3$iv$iv":I
    ...
    .restart local v1    # "this":Lkotlinx/coroutines/flow/FlowKt__DelayKt$timeoutInternal$1;
    move-object/from16 v2, p1

    .restart local v2    # "$result":Ljava/lang/Object;
    iget-object v4, v1, Lkotlinx/coroutines/flow/FlowKt__DelayKt$timeoutInternal$1;->L$0:Ljava/lang/Object;

    check-cast v4, Lkotlinx/coroutines/CoroutineScope;

    .local v4, "$this$scopedFlow":Lkotlinx/coroutines/CoroutineScope;
    iget-object v5, v1, Lkotlinx/coroutines/flow/FlowKt__DelayKt$timeoutInternal$1;->L$1:Ljava/lang/Object;

    check-cast v5, Lkotlinx/coroutines/flow/FlowCollector;

    .line 389
    .local v5, "downStream":Lkotlinx/coroutines/flow/FlowCollector;
    iget-wide v6, v1, Lkotlinx/coroutines/flow/FlowKt__DelayKt$timeoutInternal$1;->$timeout:J
    ...
    .line 390
    iget-object v6, v1, Lkotlinx/coroutines/flow/FlowKt__DelayKt$timeoutInternal$1;->$this_timeoutInternal:Lkotlinx/coroutines/flow/Flow;
    ...
    .line 406
    .end local v5    # "downStream":Lkotlinx/coroutines/flow/FlowCollector;
    .local v4, "$i$f$whileSelect":I
    ...
    .local v6, "$this$select_u24lambda_u241$iv$iv":Lkotlinx/coroutines/selects/SelectImplementation;
    const/4 v11, 0x0

    .line 411
    .local v11, "$i$a$-run-SelectKt$select$3$iv$iv":I
    move-object v12, v6
    ...
    .line 392
    .local v13, "$i$a$-whileSelect-FlowKt__DelayKt$timeoutInternal$1$1":I
    ...
    new-instance v15, Lkotlinx/coroutines/flow/FlowKt__DelayKt$timeoutInternal$1$1$1;

    invoke-direct {v15, v10, v3}, Lkotlinx/coroutines/flow/FlowKt__DelayKt$timeoutInternal$1$1$1;-><init>(Lkotlinx/coroutines/flow/FlowCollector;Lkotlin/coroutines/Continuation;)V
    ...
    .line 400
    new-instance v14, Lkotlinx/coroutines/flow/FlowKt__DelayKt$timeoutInternal$1$1$2;

    invoke-direct {v14, v7, v8, v3}, Lkotlinx/coroutines/flow/FlowKt__DelayKt$timeoutInternal$1$1$2;-><init>(JLkotlin/coroutines/Continuation;)V

    check-cast v14, Lkotlin/jvm/functions/Function1;

    invoke-static {v12, v7, v8, v14}, Lkotlinx/coroutines/selects/OnTimeoutKt;->onTimeout-8Mi8wO0(Lkotlinx/coroutines/selects/SelectBuilder;JLkotlin/jvm/functions/Function1;)V
    ...
    .end local v13    # "$i$a$-whileSelect-FlowKt__DelayKt$timeoutInternal$1$1":I
    nop

    .line 414
    iput-object v10, v1, Lkotlinx/coroutines/flow/FlowKt__DelayKt$timeoutInternal$1;->L$0:Ljava/lang/Object;

    iput-object v9, v1, Lkotlinx/coroutines/flow/FlowKt__DelayKt$timeoutInternal$1;->L$1:Ljava/lang/Object;

    iput-wide v7, v1, Lkotlinx/coroutines/flow/FlowKt__DelayKt$timeoutInternal$1;->J$0:J

    const/4 v12, 0x1

    iput v12, v1, Lkotlinx/coroutines/flow/FlowKt__DelayKt$timeoutInternal$1;->label:I
    ...
    .end local v6    # "$this$select_u24lambda_u241$iv$iv":Lkotlinx/coroutines/selects/SelectImplementation;
    if-ne v6, v0, :cond_0
    ...
    .line 410
    .end local v11    # "$i$a$-run-SelectKt$select$3$iv$iv":I
    nop
    ...
    const-string v3, "Timed out immediately"

    invoke-direct {v0, v3}, Lkotlinx/coroutines/TimeoutCancellationException;-><init>(Ljava/lang/String;)V
