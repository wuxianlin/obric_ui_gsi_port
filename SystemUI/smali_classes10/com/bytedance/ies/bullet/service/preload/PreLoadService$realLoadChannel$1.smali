.class final Lcom/bytedance/ies/bullet/service/preload/PreLoadService$realLoadChannel$1;
...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lcom/bytedance/ies/bullet/service/preload/PreLoadService;->realLoadChannel(ZLjava/lang/String;Ljava/util/List;)V
.end annotation
...
# instance fields
.field final synthetic $geckoChannel:Ljava/lang/String;
...
.method constructor <init>(Lcom/bytedance/ies/bullet/service/preload/PreLoadService;Ljava/lang/String;Ljava/util/List;)V
    ...
    iput-object p1, p0, Lcom/bytedance/ies/bullet/service/preload/PreLoadService$realLoadChannel$1;->this$0:Lcom/bytedance/ies/bullet/service/preload/PreLoadService;

    iput-object p2, p0, Lcom/bytedance/ies/bullet/service/preload/PreLoadService$realLoadChannel$1;->$geckoChannel:Ljava/lang/String;

    iput-object p3, p0, Lcom/bytedance/ies/bullet/service/preload/PreLoadService$realLoadChannel$1;->$resourceInfoList:Ljava/util/List;
...
.method public final invoke()Lkotlin/Unit;
    ...
    .line 615
    .local v7, "$i$a$-apply-PreLoadService$realLoadChannel$1$1":I
    new-instance v8, Lcom/bytedance/ies/bullet/service/base/resourceloader/config/CustomLoaderConfig;

    const/4 v9, 0x0

    invoke-direct {v8, v9}, Lcom/bytedance/ies/bullet/service/base/resourceloader/config/CustomLoaderConfig;-><init>(Z)V

    move-object v10, v8

    .local v10, "$this$invoke_u24lambda_u241_u24lambda_u240":Lcom/bytedance/ies/bullet/service/base/resourceloader/config/CustomLoaderConfig;
    const/4 v11, 0x0

    .line 616
    .local v11, "$i$a$-apply-PreLoadService$realLoadChannel$1$1$1":I
    ...
    .line 617
    invoke-virtual {v6, v5}, Lcom/bytedance/ies/bullet/service/base/resourceloader/config/TaskConfig;->setChannel(Ljava/lang/String;)V
    ...
    .line 615
    .end local v10    # "$this$invoke_u24lambda_u241_u24lambda_u240":Lcom/bytedance/ies/bullet/service/base/resourceloader/config/CustomLoaderConfig;
    .end local v11    # "$i$a$-apply-PreLoadService$realLoadChannel$1$1$1":I
    invoke-virtual {v6, v8}, Lcom/bytedance/ies/bullet/service/base/resourceloader/config/TaskConfig;->setLoaderConfig(Lcom/bytedance/ies/bullet/service/base/resourceloader/config/CustomLoaderConfig;)V

    .line 620
    nop

    .end local v6    # "$this$invoke_u24lambda_u241":Lcom/bytedance/ies/bullet/service/base/resourceloader/config/TaskConfig;
    .end local v7    # "$i$a$-apply-PreLoadService$realLoadChannel$1$1":I
    ...
    .line 621
    .local v5, "$i$a$-let-PreLoadService$realLoadChannel$1$2":I
    ...
    const-string v3, "download gecko "
    ...
    .end local v5    # "$i$a$-let-PreLoadService$realLoadChannel$1$2":I
