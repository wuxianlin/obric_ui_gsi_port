.class public final Lcom/bytedance/ai/bridge/method/floating/CloseFloatingWindowMethod;
.super Lcom/bytedance/ai/bridge/floating/AbsCloseFloatingWindowMethodIDL;
.source "CloseFloatingWindowMethod.kt"
...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        "Lcom/bytedance/ai/bridge/method/floating/CloseFloatingWindowMethod;",
...
.method public constructor <init>()V
    ...
    .line 11
    invoke-direct {p0}, Lcom/bytedance/ai/bridge/floating/AbsCloseFloatingWindowMethodIDL;-><init>()V
...
.method public bridge synthetic handle(Lcom/bytedance/ai/bridge/context/IAIBridgeContext;Lcom/bytedance/ai/bridge/core/model/idl/ParamModel;Lcom/bytedance/ai/bridge/core/CompletionBlock;)V
    ...
    check-cast v0, Lcom/bytedance/ai/bridge/floating/AbsCloseFloatingWindowMethodIDL$CloseFloatingWindowParamModel;

    invoke-virtual {p0, p1, v0, p3}, Lcom/bytedance/ai/bridge/method/floating/CloseFloatingWindowMethod;->handle(Lcom/bytedance/ai/bridge/context/IAIBridgeContext;Lcom/bytedance/ai/bridge/floating/AbsCloseFloatingWindowMethodIDL$CloseFloatingWindowParamModel;Lcom/bytedance/ai/bridge/core/CompletionBlock;)V

    return-void
.end method

.method public handle(Lcom/bytedance/ai/bridge/context/IAIBridgeContext;Lcom/bytedance/ai/bridge/floating/AbsCloseFloatingWindowMethodIDL$CloseFloatingWindowParamModel;Lcom/bytedance/ai/bridge/core/CompletionBlock;)V
    .locals 8
    .param p1, "bridgeContext"    # Lcom/bytedance/ai/bridge/context/IAIBridgeContext;
    .param p2, "params"    # Lcom/bytedance/ai/bridge/floating/AbsCloseFloatingWindowMethodIDL$CloseFloatingWindowParamModel;
    .param p3, "callback"    # Lcom/bytedance/ai/bridge/core/CompletionBlock;
    ...
    const-string v2, "closeFloating "

    invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v1

    invoke-interface {p2}, Lcom/bytedance/ai/bridge/floating/AbsCloseFloatingWindowMethodIDL$CloseFloatingWindowParamModel;->getViewId()Ljava/lang/String;
    ...
    .line 21
    .local v4, "$i$a$-let-CloseFloatingWindowMethod$handle$1":I
    ...
    invoke-interface {v5, v3}, Lcom/bytedance/ai/api/model/floating/IFloatingViewManager;->closeFloatingWidget(Ljava/lang/String;)Z
    ...
    .line 23
    .local v6, "$i$a$-let-CloseFloatingWindowMethod$handle$1$1":I
    if-eqz v5, :cond_3

    .line 24
    const-class v7, Lcom/bytedance/ai/bridge/floating/AbsCloseFloatingWindowMethodIDL$EmptyMessageModel;
    ...
    .line 26
    :cond_3
    const-string v7, "closeFloatingWidget failed"
    ...
    .end local v6    # "$i$a$-let-CloseFloatingWindowMethod$handle$1$1":I
    nop
    ...
    .end local v4    # "$i$a$-let-CloseFloatingWindowMethod$handle$1":I
    :cond_4
