...
.method public final emit(Ljava/lang/Object;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    iget-object v0, p2, Lcom/android/systemui/volume/panel/component/mediaoutput/domain/interactor/MediaOutputInteractor$special$$inlined$map$3$2$1;->result:Ljava/lang/Object;
    ...
    .line 0
    iget v2, p2, Lcom/android/systemui/volume/panel/component/mediaoutput/domain/interactor/MediaOutputInteractor$special$$inlined$map$3$2$1;->label:I
    ...
    .local v2, "$i$a$-map-MediaOutputInteractor$defaultActiveMediaSession$1":I
    iget-object v4, p2, Lcom/android/systemui/volume/panel/component/mediaoutput/domain/interactor/MediaOutputInteractor$special$$inlined$map$3$2$1;->L$0:Ljava/lang/Object;
    ...
    .end local v2    # "$i$a$-map-MediaOutputInteractor$defaultActiveMediaSession$1":I
    .end local p1    # "$i$a$-unsafeTransform-FlowKt__TransformKt$map$1":I
    :pswitch_2
    invoke-static {v0}, Lkotlin/ResultKt;->throwOnFailure(Ljava/lang/Object;)V
    ...
    .line 53
    .local v2, "this":Lcom/android/systemui/volume/panel/component/mediaoutput/domain/interactor/MediaOutputInteractor$special$$inlined$map$3$2;
    .local p1, "value":Ljava/lang/Object;
    iget-object v4, v2, Lcom/android/systemui/volume/panel/component/mediaoutput/domain/interactor/MediaOutputInteractor$special$$inlined$map$3$2;->$this_unsafeFlow:Lkotlinx/coroutines/flow/FlowCollector;
    ...
    .local p1, "it":Lcom/android/systemui/volume/panel/component/mediaoutput/domain/interactor/MediaOutputInteractor$MediaControllers;
    const/4 v6, 0x0

    .line 224
    .local v6, "$i$a$-map-MediaOutputInteractor$defaultActiveMediaSession$1":I
    nop
    ...
    invoke-virtual {v7}, Landroid/media/session/PlaybackState;->isActive()Z
    ...
    iget-object v7, v2, Lcom/android/systemui/volume/panel/component/mediaoutput/domain/interactor/MediaOutputInteractor$special$$inlined$map$3$2;->this$0:Lcom/android/systemui/volume/panel/component/mediaoutput/domain/interactor/MediaOutputInteractor;

    invoke-virtual {p1}, Lcom/android/systemui/volume/panel/component/mediaoutput/domain/interactor/MediaOutputInteractor$MediaControllers;->getLocal()Landroid/media/session/MediaController;

    move-result-object v8

    iput-object v4, p2, Lcom/android/systemui/volume/panel/component/mediaoutput/domain/interactor/MediaOutputInteractor$special$$inlined$map$3$2$1;->L$0:Ljava/lang/Object;

    iput v9, p2, Lcom/android/systemui/volume/panel/component/mediaoutput/domain/interactor/MediaOutputInteractor$special$$inlined$map$3$2$1;->label:I

    invoke-static {v7, v8, p2}, Lcom/android/systemui/volume/panel/component/mediaoutput/domain/interactor/MediaOutputInteractor;->access$mediaDeviceSession(Lcom/android/systemui/volume/panel/component/mediaoutput/domain/interactor/MediaOutputInteractor;Landroid/media/session/MediaController;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;

    move-result-object p1

    .end local v2    # "this":Lcom/android/systemui/volume/panel/component/mediaoutput/domain/interactor/MediaOutputInteractor$special$$inlined$map$3$2;
    .end local p1    # "it":Lcom/android/systemui/volume/panel/component/mediaoutput/domain/interactor/MediaOutputInteractor$MediaControllers;
    if-ne p1, v1, :cond_2
    ...
    .line 230
    .end local v6    # "$i$a$-map-MediaOutputInteractor$defaultActiveMediaSession$1":I
    .local v2, "$i$a$-map-MediaOutputInteractor$defaultActiveMediaSession$1":I
    :goto_2
    goto :goto_3
    ...
    .line 226
    .local v2, "this":Lcom/android/systemui/volume/panel/component/mediaoutput/domain/interactor/MediaOutputInteractor$special$$inlined$map$3$2;
    .restart local v6    # "$i$a$-map-MediaOutputInteractor$defaultActiveMediaSession$1":I
    .restart local p1    # "it":Lcom/android/systemui/volume/panel/component/mediaoutput/domain/interactor/MediaOutputInteractor$MediaControllers;
    :cond_3
    ...
    .line 227
    .restart local v2    # "this":Lcom/android/systemui/volume/panel/component/mediaoutput/domain/interactor/MediaOutputInteractor$special$$inlined$map$3$2;
    .restart local p1    # "it":Lcom/android/systemui/volume/panel/component/mediaoutput/domain/interactor/MediaOutputInteractor$MediaControllers;
    :cond_6
    invoke-virtual {p1}, Lcom/android/systemui/volume/panel/component/mediaoutput/domain/interactor/MediaOutputInteractor$MediaControllers;->getLocal()Landroid/media/session/MediaController;
    ...
    .end local v6    # "$i$a$-map-MediaOutputInteractor$defaultActiveMediaSession$1":I
    :goto_3
    iput-object v3, p2, Lcom/android/systemui/volume/panel/component/mediaoutput/domain/interactor/MediaOutputInteractor$special$$inlined$map$3$2$1;->L$0:Ljava/lang/Object;

    const/4 v2, 0x4

    iput v2, p2, Lcom/android/systemui/volume/panel/component/mediaoutput/domain/interactor/MediaOutputInteractor$special$$inlined$map$3$2$1;->label:I
