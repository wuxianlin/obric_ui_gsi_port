...
# direct methods
.method public static synthetic $r8$lambda$21TSw5wmwYdWl-EFlyzZ9nizRY4(Lcom/android/wm/shell/pip2/phone/PipDismissTargetHandler;Landroid/view/View;Landroid/view/WindowInsets;)Landroid/view/WindowInsets;
    .locals 0

    invoke-direct {p0, p1, p2}, Lcom/android/wm/shell/pip2/phone/PipDismissTargetHandler;->lambda$init$0(Landroid/view/View;Landroid/view/WindowInsets;)Landroid/view/WindowInsets;
...
.method public static synthetic $r8$lambda$Qjh_JuAHDYvAGjZ98MRCMfv7-UA(Lcom/android/wm/shell/pip2/phone/PipDismissTargetHandler;Lcom/android/wm/shell/common/magnetictarget/MagnetizedObject$MagneticTarget;Ljava/lang/Float;Ljava/lang/Float;Ljava/lang/Boolean;Lkotlin/jvm/functions/Function0;)Lkotlin/Unit;
    .locals 0

    invoke-direct/range {p0 .. p5}, Lcom/android/wm/shell/pip2/phone/PipDismissTargetHandler;->lambda$init$1(Lcom/android/wm/shell/common/magnetictarget/MagnetizedObject$MagneticTarget;Ljava/lang/Float;Ljava/lang/Float;Ljava/lang/Boolean;Lkotlin/jvm/functions/Function0;)Lkotlin/Unit;
...
.method static bridge synthetic -$$Nest$fgetmEnableDismissDragToEdge(Lcom/android/wm/shell/pip2/phone/PipDismissTargetHandler;)Z
    .locals 0
...
.method static bridge synthetic -$$Nest$fgetmMainExecutor(Lcom/android/wm/shell/pip2/phone/PipDismissTargetHandler;)Lcom/android/wm/shell/common/ShellExecutor;
    .locals 0
...
.method static bridge synthetic -$$Nest$fgetmMotionHelper(Lcom/android/wm/shell/pip2/phone/PipDismissTargetHandler;)Lcom/android/wm/shell/pip2/phone/PipMotionHelper;
    .locals 0
...
.method static bridge synthetic -$$Nest$fgetmPipUiEventLogger(Lcom/android/wm/shell/pip2/phone/PipDismissTargetHandler;)Lcom/android/wm/shell/common/pip/PipUiEventLogger;
    .locals 0
...
.method public constructor <init>(Landroid/content/Context;Lcom/android/wm/shell/common/pip/PipUiEventLogger;Lcom/android/wm/shell/pip2/phone/PipMotionHelper;Lcom/android/wm/shell/common/ShellExecutor;)V
    ...
    .param p3, "motionHelper"    # Lcom/android/wm/shell/pip2/phone/PipMotionHelper;
    ...
    iput-object v0, p0, Lcom/android/wm/shell/pip2/phone/PipDismissTargetHandler;->mWindowManager:Landroid/view/WindowManager;
...
.method private getDismissTargetLayoutParams()Landroid/view/WindowManager$LayoutParams;
    ...
    iget v2, p0, Lcom/android/wm/shell/pip2/phone/PipDismissTargetHandler;->mDismissAreaHeight:I
...
.method private synthetic lambda$init$0(Landroid/view/View;Landroid/view/WindowInsets;)Landroid/view/WindowInsets;
    ...
    .line 113
    iget-object v0, p0, Lcom/android/wm/shell/pip2/phone/PipDismissTargetHandler;->mWindowInsets:Landroid/view/WindowInsets;
...
.method private updateDismissTargetLayer()V
    ...
    iget-object v2, p0, Lcom/android/wm/shell/pip2/phone/PipDismissTargetHandler;->mTaskLeash:Landroid/view/SurfaceControl;
...
.method init()V
    ...
    iput v1, p0, Lcom/android/wm/shell/pip2/phone/PipDismissTargetHandler;->mDismissAreaHeight:I
    ...
    iput-object v1, p0, Lcom/android/wm/shell/pip2/phone/PipDismissTargetHandler;->mTargetViewContainer:Lcom/android/wm/shell/common/bubbles/DismissView;
    ...
    iput-object v1, p0, Lcom/android/wm/shell/pip2/phone/PipDismissTargetHandler;->mTargetView:Lcom/android/wm/shell/common/bubbles/DismissCircleView;
    ...
    invoke-direct {v2, p0}, Lcom/android/wm/shell/pip2/phone/PipDismissTargetHandler$$ExternalSyntheticLambda0;-><init>(Lcom/android/wm/shell/pip2/phone/PipDismissTargetHandler;)V
    ...
    invoke-virtual {v1}, Lcom/android/wm/shell/pip2/phone/PipMotionHelper;->getMagnetizedPip()Lcom/android/wm/shell/common/magnetictarget/MagnetizedObject;

    move-result-object v1

    iput-object v1, p0, Lcom/android/wm/shell/pip2/phone/PipDismissTargetHandler;->mMagnetizedPip:Lcom/android/wm/shell/common/magnetictarget/MagnetizedObject;

    .line 121
    iget-object v1, p0, Lcom/android/wm/shell/pip2/phone/PipDismissTargetHandler;->mMagnetizedPip:Lcom/android/wm/shell/common/magnetictarget/MagnetizedObject;
    ...
    iget-object v2, p0, Lcom/android/wm/shell/pip2/phone/PipDismissTargetHandler;->mTargetView:Lcom/android/wm/shell/common/bubbles/DismissCircleView;
    ...
    iput-object v1, p0, Lcom/android/wm/shell/pip2/phone/PipDismissTargetHandler;->mMagneticTarget:Lcom/android/wm/shell/common/magnetictarget/MagnetizedObject$MagneticTarget;
    ...
    invoke-direct {v2, p0}, Lcom/android/wm/shell/pip2/phone/PipDismissTargetHandler$$ExternalSyntheticLambda1;-><init>(Lcom/android/wm/shell/pip2/phone/PipDismissTargetHandler;)V
    ...
    invoke-direct {v2, p0}, Lcom/android/wm/shell/pip2/phone/PipDismissTargetHandler$1;-><init>(Lcom/android/wm/shell/pip2/phone/PipDismissTargetHandler;)V
...
.method public setMagneticFieldRadiusPercent(F)V
    ...
    iget v1, p0, Lcom/android/wm/shell/pip2/phone/PipDismissTargetHandler;->mMagneticFieldRadiusPercent:F

    iget v2, p0, Lcom/android/wm/shell/pip2/phone/PipDismissTargetHandler;->mTargetSize:I
...
.method public updateMagneticTargetSize()V
    ...
    invoke-virtual {p0, v1}, Lcom/android/wm/shell/pip2/phone/PipDismissTargetHandler;->setMagneticFieldRadiusPercent(F)V
