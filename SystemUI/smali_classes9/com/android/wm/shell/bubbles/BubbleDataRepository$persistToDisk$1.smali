...
# direct methods
.method constructor <init>(Lkotlinx/coroutines/Job;Lcom/android/wm/shell/bubbles/BubbleDataRepository;Landroid/util/SparseArray;Lkotlin/coroutines/Continuation;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public final create(Ljava/lang/Object;Lkotlin/coroutines/Continuation;)Lkotlin/coroutines/Continuation;
    ...
    iget-object v2, p0, Lcom/android/wm/shell/bubbles/BubbleDataRepository$persistToDisk$1;->this$0:Lcom/android/wm/shell/bubbles/BubbleDataRepository;

    iget-object v3, p0, Lcom/android/wm/shell/bubbles/BubbleDataRepository$persistToDisk$1;->$entitiesByUser:Landroid/util/SparseArray;

    invoke-direct {v0, v1, v2, v3, p2}, Lcom/android/wm/shell/bubbles/BubbleDataRepository$persistToDisk$1;-><init>(Lkotlinx/coroutines/Job;Lcom/android/wm/shell/bubbles/BubbleDataRepository;Landroid/util/SparseArray;Lkotlin/coroutines/Continuation;)V
...
.method public final invoke(Lkotlinx/coroutines/CoroutineScope;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    check-cast v0, Lcom/android/wm/shell/bubbles/BubbleDataRepository$persistToDisk$1;

    sget-object v1, Lkotlin/Unit;->INSTANCE:Lkotlin/Unit;

    invoke-virtual {v0, v1}, Lcom/android/wm/shell/bubbles/BubbleDataRepository$persistToDisk$1;->invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
...
.method public final invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .local v0, "this":Lcom/android/wm/shell/bubbles/BubbleDataRepository$persistToDisk$1;
    .local p1, "$result":Ljava/lang/Object;
    invoke-static {p1}, Lkotlin/ResultKt;->throwOnFailure(Ljava/lang/Object;)V

    goto :goto_1

    .end local v0    # "this":Lcom/android/wm/shell/bubbles/BubbleDataRepository$persistToDisk$1;
    .end local p1    # "$result":Ljava/lang/Object;
    :pswitch_1
    move-object v1, p0

    .local v1, "this":Lcom/android/wm/shell/bubbles/BubbleDataRepository$persistToDisk$1;
    .restart local p1    # "$result":Ljava/lang/Object;
    invoke-static {p1}, Lkotlin/ResultKt;->throwOnFailure(Ljava/lang/Object;)V

    goto :goto_0

    .end local v1    # "this":Lcom/android/wm/shell/bubbles/BubbleDataRepository$persistToDisk$1;
    .end local p1    # "$result":Ljava/lang/Object;
    :pswitch_2
    invoke-static {p1}, Lkotlin/ResultKt;->throwOnFailure(Ljava/lang/Object;)V
    ...
    .line 178
    .restart local v1    # "this":Lcom/android/wm/shell/bubbles/BubbleDataRepository$persistToDisk$1;
    .restart local p1    # "$result":Ljava/lang/Object;
    iget-object v2, v1, Lcom/android/wm/shell/bubbles/BubbleDataRepository$persistToDisk$1;->$prev:Lkotlinx/coroutines/Job;
    ...
    iput v4, v1, Lcom/android/wm/shell/bubbles/BubbleDataRepository$persistToDisk$1;->label:I
    ...
    iput v3, v1, Lcom/android/wm/shell/bubbles/BubbleDataRepository$persistToDisk$1;->label:I
    ...
    .line 182
    .end local v1    # "this":Lcom/android/wm/shell/bubbles/BubbleDataRepository$persistToDisk$1;
    .restart local v0    # "this":Lcom/android/wm/shell/bubbles/BubbleDataRepository$persistToDisk$1;
    :goto_1
    iget-object v1, v0, Lcom/android/wm/shell/bubbles/BubbleDataRepository$persistToDisk$1;->this$0:Lcom/android/wm/shell/bubbles/BubbleDataRepository;
    ...
    iget-object v2, v0, Lcom/android/wm/shell/bubbles/BubbleDataRepository$persistToDisk$1;->$entitiesByUser:Landroid/util/SparseArray;

    invoke-virtual {v1, v2}, Lcom/android/wm/shell/bubbles/storage/BubblePersistentRepository;->persistsToDisk(Landroid/util/SparseArray;)Z
