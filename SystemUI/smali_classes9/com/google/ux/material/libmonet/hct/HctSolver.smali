.class public Lcom/google/ux/material/libmonet/hct/HctSolver;
...
.method static areInCyclicOrder(DDD)Z
    ...
    invoke-static {v0, v1}, Lcom/google/ux/material/libmonet/hct/HctSolver;->sanitizeRadians(D)D
    ...
    invoke-static {v2, v3}, Lcom/google/ux/material/libmonet/hct/HctSolver;->sanitizeRadians(D)D
...
.method static bisectToLimit(DD)[D
    ...
    .line 520
    invoke-static/range {p0 .. p3}, Lcom/google/ux/material/libmonet/hct/HctSolver;->bisectToSegment(DD)[[D
    ...
    invoke-static {v9, v10}, Lcom/google/ux/material/libmonet/hct/HctSolver;->criticalPlaneBelow(D)I
    ...
    invoke-static {v9, v10}, Lcom/google/ux/material/libmonet/hct/HctSolver;->criticalPlaneAbove(D)I
    ...
    .line 540
    .local v11, "mPlane":I
    sget-object v7, Lcom/google/ux/material/libmonet/hct/HctSolver;->CRITICAL_PLANES:[D

    aget-wide v9, v7, v11

    .line 541
    .local v9, "midPlaneCoordinate":D
    invoke-static {v1, v9, v10, v5, v6}, Lcom/google/ux/material/libmonet/hct/HctSolver;->setCoordinate([DD[DI)[D

    move-result-object v16

    .line 542
    .local v16, "mid":[D
    invoke-static/range {v16 .. v16}, Lcom/google/ux/material/libmonet/hct/HctSolver;->hueOf([D)D
    ...
    invoke-static/range {v7 .. v12}, Lcom/google/ux/material/libmonet/hct/HctSolver;->areInCyclicOrder(DDD)Z
    ...
    .end local v6    # "axis":I
    :cond_4
    invoke-static {v1, v5}, Lcom/google/ux/material/libmonet/hct/HctSolver;->midpoint([D[D)[D
...
.method static bisectToSegment(DD)[[D
    ...
    invoke-static {v6, v7, v14}, Lcom/google/ux/material/libmonet/hct/HctSolver;->nthVertex(DI)[D
    ...
    .line 475
    :cond_0
    invoke-static {v15}, Lcom/google/ux/material/libmonet/hct/HctSolver;->hueOf([D)D
    ...
    invoke-static/range {v2 .. v7}, Lcom/google/ux/material/libmonet/hct/HctSolver;->areInCyclicOrder(DDD)Z
...
.method static chromaticAdaptation(D)D
    ...
    .line 344
    .local v0, "af":D
    invoke-static {p0, p1}, Lcom/google/ux/material/libmonet/utils/MathUtils;->signum(D)I
...
.method static findResultByJ(DDD)I
    ...
    .line 579
    .local v4, "viewingConditions":Lcom/google/ux/material/libmonet/hct/ViewingConditions;
    const-wide v5, 0x3fd28f5c28f5c28fL    # 0.29

    invoke-virtual {v4}, Lcom/google/ux/material/libmonet/hct/ViewingConditions;->getN()D
    ...
    invoke-virtual {v4}, Lcom/google/ux/material/libmonet/hct/ViewingConditions;->getNc()D

    move-result-wide v15

    mul-double/2addr v13, v15

    invoke-virtual {v4}, Lcom/google/ux/material/libmonet/hct/ViewingConditions;->getNcb()D
    ...
    .line 592
    invoke-virtual {v4}, Lcom/google/ux/material/libmonet/hct/ViewingConditions;->getAw()D

    move-result-wide v7

    .line 593
    invoke-virtual {v4}, Lcom/google/ux/material/libmonet/hct/ViewingConditions;->getC()D
    ...
    invoke-virtual {v4}, Lcom/google/ux/material/libmonet/hct/ViewingConditions;->getZ()D
    ...
    .line 594
    .local v7, "ac":D
    invoke-virtual {v4}, Lcom/google/ux/material/libmonet/hct/ViewingConditions;->getNbb()D
    ...
    invoke-static/range {v46 .. v47}, Lcom/google/ux/material/libmonet/hct/HctSolver;->inverseChromaticAdaptation(D)D
    ...
    sget-object v2, Lcom/google/ux/material/libmonet/hct/HctSolver;->LINRGB_FROM_SCALED_DISCOUNT:[[D

    .line 605
    invoke-static {v12, v2}, Lcom/google/ux/material/libmonet/utils/MathUtils;->matrixMultiply([D[[D)[D
    ...
    .line 613
    :cond_2
    sget-object v3, Lcom/google/ux/material/libmonet/hct/HctSolver;->Y_FROM_LINRGB:[D
    ...
    .line 624
    :cond_6
    invoke-static {v2}, Lcom/google/ux/material/libmonet/utils/ColorUtils;->argbFromLinrgb([D)I
...
.method static hueOf([D)D
    ...
    invoke-static {v1, v2}, Lcom/google/ux/material/libmonet/hct/HctSolver;->chromaticAdaptation(D)D
    ...
    invoke-static {v3, v4}, Lcom/google/ux/material/libmonet/hct/HctSolver;->chromaticAdaptation(D)D
    ...
    invoke-static {v5, v6}, Lcom/google/ux/material/libmonet/hct/HctSolver;->chromaticAdaptation(D)D
...
.method static nthVertex(DI)[D
    ...
    sget-object v1, Lcom/google/ux/material/libmonet/hct/HctSolver;->Y_FROM_LINRGB:[D
    ...
    .line 429
    .local v19, "r":D
    invoke-static/range {v19 .. v20}, Lcom/google/ux/material/libmonet/hct/HctSolver;->isBounded(D)Z
...
.method static setCoordinate([DD[DI)[D
    ...
    invoke-static/range {v0 .. v5}, Lcom/google/ux/material/libmonet/hct/HctSolver;->intercept(DDD)D

    move-result-wide v0

    .line 403
    .local v0, "t":D
    invoke-static {p0, v0, v1, p3}, Lcom/google/ux/material/libmonet/hct/HctSolver;->lerpPoint([DD[D)[D
...
.method public static solveToCam(DDD)Lcom/google/ux/material/libmonet/hct/Cam16;
    .locals 1
...
.method public static solveToInt(DDD)I
    ...
    invoke-static {p4, p5}, Lcom/google/ux/material/libmonet/utils/ColorUtils;->yFromLstar(D)D
    ...
    invoke-static/range {v4 .. v9}, Lcom/google/ux/material/libmonet/hct/HctSolver;->findResultByJ(DDD)I
    ...
    .line 654
    :cond_1
    invoke-static {v2, v3, v0, v1}, Lcom/google/ux/material/libmonet/hct/HctSolver;->bisectToLimit(DD)[D

    move-result-object v5

    .line 655
    .local v5, "linrgb":[D
    invoke-static {v5}, Lcom/google/ux/material/libmonet/utils/ColorUtils;->argbFromLinrgb([D)I
    ...
    :cond_2
    :goto_0
    invoke-static {p4, p5}, Lcom/google/ux/material/libmonet/utils/ColorUtils;->argbFromLstar(D)I
