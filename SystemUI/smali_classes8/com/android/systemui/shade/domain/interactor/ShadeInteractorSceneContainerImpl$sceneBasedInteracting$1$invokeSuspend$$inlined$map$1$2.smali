...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lcom/android/systemui/shade/domain/interactor/ShadeInteractorSceneContainerImpl$sceneBasedInteracting$1$invokeSuspend$$inlined$map$1;->collect(Lkotlinx/coroutines/flow/FlowCollector;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
.end annotation
...
# instance fields
.field final synthetic $state$inlined:Lcom/android/compose/animation/scene/ObservableTransitionState;
...
.method public final emit(Ljava/lang/Object;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    iget p2, v0, Lcom/android/systemui/shade/domain/interactor/ShadeInteractorSceneContainerImpl$sceneBasedInteracting$1$invokeSuspend$$inlined$map$1$2$1;->label:I

    sub-int/2addr p2, v2

    iput p2, v0, Lcom/android/systemui/shade/domain/interactor/ShadeInteractorSceneContainerImpl$sceneBasedInteracting$1$invokeSuspend$$inlined$map$1$2$1;->label:I
    ...
    iget-object v0, p2, Lcom/android/systemui/shade/domain/interactor/ShadeInteractorSceneContainerImpl$sceneBasedInteracting$1$invokeSuspend$$inlined$map$1$2$1;->result:Ljava/lang/Object;
    ...
    .line 0
    iget v2, p2, Lcom/android/systemui/shade/domain/interactor/ShadeInteractorSceneContainerImpl$sceneBasedInteracting$1$invokeSuspend$$inlined$map$1$2$1;->label:I
    ...
    .line 53
    .local v2, "this":Lcom/android/systemui/shade/domain/interactor/ShadeInteractorSceneContainerImpl$sceneBasedInteracting$1$invokeSuspend$$inlined$map$1$2;
    .local p1, "value":Ljava/lang/Object;
    iget-object v3, v2, Lcom/android/systemui/shade/domain/interactor/ShadeInteractorSceneContainerImpl$sceneBasedInteracting$1$invokeSuspend$$inlined$map$1$2;->$this_unsafeFlow:Lkotlinx/coroutines/flow/FlowCollector;
    ...
    .local p1, "resolvedSceneKey":Lcom/android/compose/animation/scene/SceneKey;
    const/4 v5, 0x0

    .line 224
    .local v5, "$i$a$-map-ShadeInteractorSceneContainerImpl$sceneBasedInteracting$1$1":I
    iget-object v6, v2, Lcom/android/systemui/shade/domain/interactor/ShadeInteractorSceneContainerImpl$sceneBasedInteracting$1$invokeSuspend$$inlined$map$1$2;->$state$inlined:Lcom/android/compose/animation/scene/ObservableTransitionState;

    check-cast v6, Lcom/android/compose/animation/scene/ObservableTransitionState$Transition;

    invoke-virtual {v6}, Lcom/android/compose/animation/scene/ObservableTransitionState$Transition;->isInitiatedByUserInput()Z
    ...
    .end local v2    # "this":Lcom/android/systemui/shade/domain/interactor/ShadeInteractorSceneContainerImpl$sceneBasedInteracting$1$invokeSuspend$$inlined$map$1$2;
    .end local p1    # "resolvedSceneKey":Lcom/android/compose/animation/scene/SceneKey;
    :cond_1
    move p1, v7
    ...
    .line 223
    .end local v5    # "$i$a$-map-ShadeInteractorSceneContainerImpl$sceneBasedInteracting$1$1":I
    iput v7, p2, Lcom/android/systemui/shade/domain/interactor/ShadeInteractorSceneContainerImpl$sceneBasedInteracting$1$invokeSuspend$$inlined$map$1$2$1;->label:I
