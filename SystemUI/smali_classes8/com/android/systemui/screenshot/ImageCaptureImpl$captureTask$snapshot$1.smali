...
.method public final create(Ljava/lang/Object;Lkotlin/coroutines/Continuation;)Lkotlin/coroutines/Continuation;
    ...
    new-instance v0, Lcom/android/systemui/screenshot/ImageCaptureImpl$captureTask$snapshot$1;

    iget-object v1, p0, Lcom/android/systemui/screenshot/ImageCaptureImpl$captureTask$snapshot$1;->this$0:Lcom/android/systemui/screenshot/ImageCaptureImpl;

    iget v2, p0, Lcom/android/systemui/screenshot/ImageCaptureImpl$captureTask$snapshot$1;->$taskId:I

    invoke-direct {v0, v1, v2, p2}, Lcom/android/systemui/screenshot/ImageCaptureImpl$captureTask$snapshot$1;-><init>(Lcom/android/systemui/screenshot/ImageCaptureImpl;ILkotlin/coroutines/Continuation;)V
...
.method public final invoke(Lkotlinx/coroutines/CoroutineScope;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    check-cast v0, Lcom/android/systemui/screenshot/ImageCaptureImpl$captureTask$snapshot$1;

    sget-object v1, Lkotlin/Unit;->INSTANCE:Lkotlin/Unit;

    invoke-virtual {v0, v1}, Lcom/android/systemui/screenshot/ImageCaptureImpl$captureTask$snapshot$1;->invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
...
.method public final invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 52
    .local v0, "this":Lcom/android/systemui/screenshot/ImageCaptureImpl$captureTask$snapshot$1;
    .local p1, "$result":Ljava/lang/Object;
    iget-object v1, v0, Lcom/android/systemui/screenshot/ImageCaptureImpl$captureTask$snapshot$1;->this$0:Lcom/android/systemui/screenshot/ImageCaptureImpl;

    invoke-static {v1}, Lcom/android/systemui/screenshot/ImageCaptureImpl;->access$getAtmService$p(Lcom/android/systemui/screenshot/ImageCaptureImpl;)Landroid/app/IActivityTaskManager;

    move-result-object v1

    iget v2, v0, Lcom/android/systemui/screenshot/ImageCaptureImpl$captureTask$snapshot$1;->$taskId:I

    const/4 v3, 0x0

    invoke-interface {v1, v2, v3}, Landroid/app/IActivityTaskManager;->takeTaskSnapshot(IZ)Landroid/window/TaskSnapshot;
