...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lcom/android/systemui/screenshot/ActionIntentExecutor;->launchIntentAsync(Landroid/content/Intent;Landroid/os/UserHandle;ZLandroid/app/ActivityOptions;Landroid/app/ExitTransitionCoordinator;)V
.end annotation
...
.annotation runtime Lkotlin/coroutines/jvm/internal/DebugMetadata;
    c = "com.android.systemui.screenshot.ActionIntentExecutor$launchIntentAsync$$inlined$launch$default$1"
...
.method public bridge synthetic invoke(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1, p2}, Lcom/android/systemui/screenshot/ActionIntentExecutor$launchIntentAsync$$inlined$launch$default$1;->invoke(Lkotlinx/coroutines/CoroutineScope;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
...
.method public final invoke(Lkotlinx/coroutines/CoroutineScope;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    check-cast v0, Lcom/android/systemui/screenshot/ActionIntentExecutor$launchIntentAsync$$inlined$launch$default$1;

    sget-object v1, Lkotlin/Unit;->INSTANCE:Lkotlin/Unit;

    invoke-virtual {v0, v1}, Lcom/android/systemui/screenshot/ActionIntentExecutor$launchIntentAsync$$inlined$launch$default$1;->invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
...
.method public final invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iget v2, v1, Lcom/android/systemui/screenshot/ActionIntentExecutor$launchIntentAsync$$inlined$launch$default$1;->label:I
    ...
    .local v1, "this":Lcom/android/systemui/screenshot/ActionIntentExecutor$launchIntentAsync$$inlined$launch$default$1;
    ...
    .local v6, "$i$a$-launch$default-ActionIntentExecutor$launchIntentAsync$1":I
    iget v7, v1, Lcom/android/systemui/screenshot/ActionIntentExecutor$launchIntentAsync$$inlined$launch$default$1;->I$0:I

    .local v7, "cookie$iv$iv":I
    iget-boolean v8, v1, Lcom/android/systemui/screenshot/ActionIntentExecutor$launchIntentAsync$$inlined$launch$default$1;->Z$0:Z

    .local v8, "asyncTracingEnabled$iv$iv":Z
    iget-object v9, v1, Lcom/android/systemui/screenshot/ActionIntentExecutor$launchIntentAsync$$inlined$launch$default$1;->L$1:Ljava/lang/Object;

    check-cast v9, Ljava/lang/String;

    .local v9, "spanString$iv$iv":Ljava/lang/String;
    iget-object v10, v1, Lcom/android/systemui/screenshot/ActionIntentExecutor$launchIntentAsync$$inlined$launch$default$1;->L$0:Ljava/lang/Object;
    ...
    .end local v6    # "$i$a$-launch$default-ActionIntentExecutor$launchIntentAsync$1":I
    :catchall_0
    move-exception v0
    ...
    .line 0
    .end local v1    # "this":Lcom/android/systemui/screenshot/ActionIntentExecutor$launchIntentAsync$$inlined$launch$default$1;
    ...
    .restart local v1    # "this":Lcom/android/systemui/screenshot/ActionIntentExecutor$launchIntentAsync$$inlined$launch$default$1;
    move-object/from16 v2, p1

    .restart local v2    # "$result":Ljava/lang/Object;
    iget-object v4, v1, Lcom/android/systemui/screenshot/ActionIntentExecutor$launchIntentAsync$$inlined$launch$default$1;->L$0:Ljava/lang/Object;

    check-cast v4, Lkotlinx/coroutines/CoroutineScope;

    .line 62
    .local v4, "$this$launch":Lkotlinx/coroutines/CoroutineScope;
    iget-object v5, v1, Lcom/android/systemui/screenshot/ActionIntentExecutor$launchIntentAsync$$inlined$launch$default$1;->$spanName:Ljava/lang/String;
    ...
    .line 62
    .local v18, "$i$a$-traceCoroutine-CoroutineTracingKt$launch$2$1":I
    :try_start_1
    move-object v11, v1
    ...
    .line 224
    .local v4, "$i$a$-launch$default-ActionIntentExecutor$launchIntentAsync$1":I
    iget-object v11, v1, Lcom/android/systemui/screenshot/ActionIntentExecutor$launchIntentAsync$$inlined$launch$default$1;->this$0:Lcom/android/systemui/screenshot/ActionIntentExecutor;

    iget-object v12, v1, Lcom/android/systemui/screenshot/ActionIntentExecutor$launchIntentAsync$$inlined$launch$default$1;->$intent$inlined:Landroid/content/Intent;

    iget-object v13, v1, Lcom/android/systemui/screenshot/ActionIntentExecutor$launchIntentAsync$$inlined$launch$default$1;->$user$inlined:Landroid/os/UserHandle;

    iget-boolean v14, v1, Lcom/android/systemui/screenshot/ActionIntentExecutor$launchIntentAsync$$inlined$launch$default$1;->$overrideTransition$inlined:Z

    iget-object v15, v1, Lcom/android/systemui/screenshot/ActionIntentExecutor$launchIntentAsync$$inlined$launch$default$1;->$options$inlined:Landroid/app/ActivityOptions;
    :try_end_1
    ...
    :try_start_2
    iget-object v2, v1, Lcom/android/systemui/screenshot/ActionIntentExecutor$launchIntentAsync$$inlined$launch$default$1;->$transitionCoordinator$inlined:Landroid/app/ExitTransitionCoordinator;

    iput-object v10, v1, Lcom/android/systemui/screenshot/ActionIntentExecutor$launchIntentAsync$$inlined$launch$default$1;->L$0:Ljava/lang/Object;

    iput-object v9, v1, Lcom/android/systemui/screenshot/ActionIntentExecutor$launchIntentAsync$$inlined$launch$default$1;->L$1:Ljava/lang/Object;

    iput-boolean v8, v1, Lcom/android/systemui/screenshot/ActionIntentExecutor$launchIntentAsync$$inlined$launch$default$1;->Z$0:Z

    iput v5, v1, Lcom/android/systemui/screenshot/ActionIntentExecutor$launchIntentAsync$$inlined$launch$default$1;->I$0:I

    move/from16 p1, v4

    .end local v4    # "$i$a$-launch$default-ActionIntentExecutor$launchIntentAsync$1":I
    .local p1, "$i$a$-launch$default-ActionIntentExecutor$launchIntentAsync$1":I
    const/4 v4, 0x1

    iput v4, v1, Lcom/android/systemui/screenshot/ActionIntentExecutor$launchIntentAsync$$inlined$launch$default$1;->label:I

    move-object/from16 v16, v2

    move-object/from16 v17, v1

    invoke-virtual/range {v11 .. v17}, Lcom/android/systemui/screenshot/ActionIntentExecutor;->launchIntent(Landroid/content/Intent;Landroid/os/UserHandle;ZLandroid/app/ActivityOptions;Landroid/app/ExitTransitionCoordinator;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    .line 225
    .end local v18    # "$i$a$-traceCoroutine-CoroutineTracingKt$launch$2$1":I
    .end local p0    # "$result":Ljava/lang/Object;
    .end local p1    # "$i$a$-launch$default-ActionIntentExecutor$launchIntentAsync$1":I
