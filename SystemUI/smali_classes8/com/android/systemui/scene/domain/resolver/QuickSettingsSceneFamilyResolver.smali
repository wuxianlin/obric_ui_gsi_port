...
.annotation system Ldalvik/annotation/SourceDebugExtension;
    value = "SMAP\nQuickSettingsSceneFamilyResolver.kt\nKotlin\n*S Kotlin\n*F\n+ 1 QuickSettingsSceneFamilyResolver.kt\ncom/android/systemui/scene/domain/resolver/QuickSettingsSceneFamilyResolver\n+ 2 Transform.kt\nkotlinx/coroutines/flow/FlowKt__TransformKt\n+ 3 Emitters.kt\nkotlinx/coroutines/flow/FlowKt__EmittersKt\n+ 4 SafeCollector.common.kt\nkotlinx/coroutines/flow/internal/SafeCollector_commonKt\n*L\n1#1,77:1\n53#2:78\n55#2:82\n50#3:79\n55#3:81\n106#4:80\n*S KotlinDebug\n*F\n+ 1 QuickSettingsSceneFamilyResolver.kt\ncom/android/systemui/scene/domain/resolver/QuickSettingsSceneFamilyResolver\n*L\n47#1:78\n47#1:82\n47#1:79\n47#1:81\n47#1:80\n*E\n"
.end annotation
...
.field public static final Companion:Lcom/android/systemui/scene/domain/resolver/QuickSettingsSceneFamilyResolver$Companion;

.field private static final quickSettingsScenes:Ljava/util/Set;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/systemui/scene/domain/resolver/QuickSettingsSceneFamilyResolver;->Companion:Lcom/android/systemui/scene/domain/resolver/QuickSettingsSceneFamilyResolver$Companion;

    const/16 v0, 0x8

    sput v0, Lcom/android/systemui/scene/domain/resolver/QuickSettingsSceneFamilyResolver;->$stable:I
...
.method public constructor <init>(Lkotlinx/coroutines/CoroutineScope;Lcom/android/systemui/shade/domain/interactor/ShadeInteractor;)V
    ...
    new-instance v5, Lcom/android/systemui/scene/domain/resolver/QuickSettingsSceneFamilyResolver$special$$inlined$map$1;

    invoke-direct {v5, v2, p0}, Lcom/android/systemui/scene/domain/resolver/QuickSettingsSceneFamilyResolver$special$$inlined$map$1;-><init>(Lkotlinx/coroutines/flow/Flow;Lcom/android/systemui/scene/domain/resolver/QuickSettingsSceneFamilyResolver;)V
    ...
    invoke-direct {p0, v1}, Lcom/android/systemui/scene/domain/resolver/QuickSettingsSceneFamilyResolver;->quickSettingsScene(Lcom/android/systemui/shade/shared/model/ShadeMode;)Lcom/android/compose/animation/scene/SceneKey;
    ...
    iput-object v0, p0, Lcom/android/systemui/scene/domain/resolver/QuickSettingsSceneFamilyResolver;->resolvedScene:Lkotlinx/coroutines/flow/StateFlow;

    .line 39
    return-void
.end method

.method public static final synthetic access$getQuickSettingsScenes$cp()Ljava/util/Set;
    .locals 1

    .line 36
    sget-object v0, Lcom/android/systemui/scene/domain/resolver/QuickSettingsSceneFamilyResolver;->quickSettingsScenes:Ljava/util/Set;

    return-object v0
.end method

.method public static final synthetic access$quickSettingsScene(Lcom/android/systemui/scene/domain/resolver/QuickSettingsSceneFamilyResolver;Lcom/android/systemui/shade/shared/model/ShadeMode;)Lcom/android/compose/animation/scene/SceneKey;
    .locals 1
    .param p0, "$this"    # Lcom/android/systemui/scene/domain/resolver/QuickSettingsSceneFamilyResolver;
    .param p1, "shadeMode"    # Lcom/android/systemui/shade/shared/model/ShadeMode;

    .line 36
    invoke-direct {p0, p1}, Lcom/android/systemui/scene/domain/resolver/QuickSettingsSceneFamilyResolver;->quickSettingsScene(Lcom/android/systemui/shade/shared/model/ShadeMode;)Lcom/android/compose/animation/scene/SceneKey;
...
.method private final quickSettingsScene(Lcom/android/systemui/shade/shared/model/ShadeMode;)Lcom/android/compose/animation/scene/SceneKey;
    .locals 1
    .param p1, "shadeMode"    # Lcom/android/systemui/shade/shared/model/ShadeMode;
...
.method public getResolvedScene()Lkotlinx/coroutines/flow/StateFlow;
    ...
    .line 45
    iget-object v0, p0, Lcom/android/systemui/scene/domain/resolver/QuickSettingsSceneFamilyResolver;->resolvedScene:Lkotlinx/coroutines/flow/StateFlow;
...
.method public getTargetFamily()Lcom/android/compose/animation/scene/SceneKey;
    ...
    .line 43
    iget-object v0, p0, Lcom/android/systemui/scene/domain/resolver/QuickSettingsSceneFamilyResolver;->targetFamily:Lcom/android/compose/animation/scene/SceneKey;
