...
.method public final invoke(Lkotlinx/coroutines/flow/FlowCollector;Ljava/lang/Object;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    invoke-direct {v0, p3, v1}, Lcom/android/systemui/scene/domain/startable/SceneContainerStartable$hydrateInteractionState$1$invokeSuspend$$inlined$flatMapLatest$1;-><init>(Lkotlin/coroutines/Continuation;Lcom/android/systemui/scene/domain/startable/SceneContainerStartable;)V
    ...
    invoke-virtual {v0, v1}, Lcom/android/systemui/scene/domain/startable/SceneContainerStartable$hydrateInteractionState$1$invokeSuspend$$inlined$flatMapLatest$1;->invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
...
.method public final invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .local v0, "this":Lcom/android/systemui/scene/domain/startable/SceneContainerStartable$hydrateInteractionState$1$invokeSuspend$$inlined$flatMapLatest$1;
    .local p1, "$result":Ljava/lang/Object;
    invoke-static {p1}, Lkotlin/ResultKt;->throwOnFailure(Ljava/lang/Object;)V

    goto :goto_1

    .end local v0    # "this":Lcom/android/systemui/scene/domain/startable/SceneContainerStartable$hydrateInteractionState$1$invokeSuspend$$inlined$flatMapLatest$1;
    ...
    .local v1, "this":Lcom/android/systemui/scene/domain/startable/SceneContainerStartable$hydrateInteractionState$1$invokeSuspend$$inlined$flatMapLatest$1;
    .restart local p1    # "$result":Ljava/lang/Object;
    iget-object v2, v1, Lcom/android/systemui/scene/domain/startable/SceneContainerStartable$hydrateInteractionState$1$invokeSuspend$$inlined$flatMapLatest$1;->L$0:Ljava/lang/Object;

    check-cast v2, Lkotlinx/coroutines/flow/FlowCollector;

    .local v2, "$this$transformLatest":Lkotlinx/coroutines/flow/FlowCollector;
    iget-object v3, v1, Lcom/android/systemui/scene/domain/startable/SceneContainerStartable$hydrateInteractionState$1$invokeSuspend$$inlined$flatMapLatest$1;->L$1:Ljava/lang/Object;
    ...
    .local v3, "isDeviceLocked":Z
    const/4 v4, 0x0

    .line 219
    .local v4, "$i$a$-flatMapLatest-SceneContainerStartable$hydrateInteractionState$1$2":I
    nop

    .end local v3    # "isDeviceLocked":Z
    if-eqz v3, :cond_0

    .line 220
    iget-object v3, v1, Lcom/android/systemui/scene/domain/startable/SceneContainerStartable$hydrateInteractionState$1$invokeSuspend$$inlined$flatMapLatest$1;->this$0:Lcom/android/systemui/scene/domain/startable/SceneContainerStartable;
    ...
    new-instance v9, Lcom/android/systemui/scene/domain/startable/SceneContainerStartable$hydrateInteractionState$1$invokeSuspend$lambda$4$$inlined$mapNotNull$1;

    invoke-direct {v9, v6}, Lcom/android/systemui/scene/domain/startable/SceneContainerStartable$hydrateInteractionState$1$invokeSuspend$lambda$4$$inlined$mapNotNull$1;-><init>(Lkotlinx/coroutines/flow/Flow;)V
    ...
    new-instance v9, Lcom/android/systemui/scene/domain/startable/SceneContainerStartable$hydrateInteractionState$1$invokeSuspend$lambda$4$$inlined$map$1;

    invoke-direct {v9, v6}, Lcom/android/systemui/scene/domain/startable/SceneContainerStartable$hydrateInteractionState$1$invokeSuspend$lambda$4$$inlined$map$1;-><init>(Lkotlinx/coroutines/flow/Flow;)V
    ...
    .line 237
    .restart local v8    # "$i$f$unsafeFlow":I
    new-instance v9, Lcom/android/systemui/scene/domain/startable/SceneContainerStartable$hydrateInteractionState$1$invokeSuspend$lambda$4$$inlined$map$2;

    invoke-direct {v9, v6}, Lcom/android/systemui/scene/domain/startable/SceneContainerStartable$hydrateInteractionState$1$invokeSuspend$lambda$4$$inlined$map$2;-><init>(Lkotlinx/coroutines/flow/Flow;)V
    ...
    .line 193
    .end local v4    # "$i$a$-flatMapLatest-SceneContainerStartable$hydrateInteractionState$1$2":I
    move-object v3, v1
    ...
    iput v4, v1, Lcom/android/systemui/scene/domain/startable/SceneContainerStartable$hydrateInteractionState$1$invokeSuspend$$inlined$flatMapLatest$1;->label:I
    ...
    .end local v1    # "this":Lcom/android/systemui/scene/domain/startable/SceneContainerStartable$hydrateInteractionState$1$invokeSuspend$$inlined$flatMapLatest$1;
    .restart local v0    # "this":Lcom/android/systemui/scene/domain/startable/SceneContainerStartable$hydrateInteractionState$1$invokeSuspend$$inlined$flatMapLatest$1;
    :goto_1
    sget-object v1, Lkotlin/Unit;->INSTANCE:Lkotlin/Unit;
