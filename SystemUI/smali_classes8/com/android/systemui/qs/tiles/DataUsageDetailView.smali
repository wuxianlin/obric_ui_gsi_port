...
.method public bind(Lcom/android/settingslib/net/DataUsageController$DataUsageInfo;)V
    ...
    .line 71
    .local v3, "usageColorState":Landroid/content/res/ColorStateList;
    const/4 v4, 0x0
    ...
    .line 80
    sget v5, Lcom/android/systemui/res/R$string;->quick_settings_cellular_detail_remaining_data:I
    ...
    .line 82
    .local v8, "bytes":J
    sget v10, Lcom/android/systemui/res/R$string;->quick_settings_cellular_detail_data_used:I
    ...
    .line 84
    .local v10, "top":Ljava/lang/String;
    sget v11, Lcom/android/systemui/res/R$string;->quick_settings_cellular_detail_data_limit:I
    ...
    .end local v8    # "bytes":J
    .end local v10    # "top":Ljava/lang/String;
    :cond_1
    sget v5, Lcom/android/systemui/res/R$string;->quick_settings_cellular_detail_over_limit:I
    ...
    .line 92
    .restart local v10    # "top":Ljava/lang/String;
    sget v11, Lcom/android/systemui/res/R$string;->quick_settings_cellular_detail_data_limit:I
    ...
    .line 94
    iget-object v11, v0, Lcom/android/systemui/qs/tiles/DataUsageDetailView;->mContext:Landroid/content/Context;

    invoke-static {v11}, Lcom/android/settingslib/Utils;->getColorError(Landroid/content/Context;)Landroid/content/res/ColorStateList;
    ...
    :cond_2
    :goto_0
    sget v5, Lcom/android/systemui/res/R$string;->quick_settings_cellular_detail_data_usage:I
    ...
    .line 76
    .restart local v8    # "bytes":J
    sget v10, Lcom/android/systemui/res/R$string;->quick_settings_cellular_detail_data_warning:I

    iget-wide v11, v1, Lcom/android/settingslib/net/DataUsageController$DataUsageInfo;->warningLevel:J
    ...
    .line 103
    sget v12, Lcom/android/systemui/res/R$id;->usage_text:I

    invoke-virtual {v0, v12}, Lcom/android/systemui/qs/tiles/DataUsageDetailView;->findViewById(I)Landroid/view/View;
    ...
    .line 104
    .local v12, "usage":Landroid/widget/TextView;
    ...
    .line 106
    sget v13, Lcom/android/systemui/res/R$id;->usage_graph:I

    invoke-virtual {v0, v13}, Lcom/android/systemui/qs/tiles/DataUsageDetailView;->findViewById(I)Landroid/view/View;

    move-result-object v13

    check-cast v13, Lcom/android/systemui/qs/DataUsageGraph;

    .line 107
    .local v13, "graph":Lcom/android/systemui/qs/DataUsageGraph;
    ...
    .end local v3    # "usageColorState":Landroid/content/res/ColorStateList;
    .local v21, "res":Landroid/content/res/Resources;
    .local v22, "usageColorState":Landroid/content/res/ColorStateList;
    ...
    invoke-virtual/range {v14 .. v20}, Lcom/android/systemui/qs/DataUsageGraph;->setLevels(JJJ)V

    .line 108
    sget v2, Lcom/android/systemui/res/R$id;->usage_carrier_text:I
    ...
    .line 110
    sget v3, Lcom/android/systemui/res/R$id;->usage_period_text:I
    ...
    .line 113
    .local v6, "infoTop":Landroid/widget/TextView;
    if-eqz v10, :cond_4
    ...
    .line 115
    sget v15, Lcom/android/systemui/res/R$id;->usage_info_bottom_text:I

    invoke-virtual {v0, v15}, Lcom/android/systemui/qs/tiles/DataUsageDetailView;->findViewById(I)Landroid/view/View;
    ...
    .line 116
    .local v15, "infoBottom":Landroid/widget/TextView;
    if-eqz v4, :cond_5
    ...
    .end local v15    # "infoBottom":Landroid/widget/TextView;
    .local v17, "infoBottom":Landroid/widget/TextView;
    ...
    :goto_6
    invoke-virtual {v13, v15}, Lcom/android/systemui/qs/DataUsageGraph;->setVisibility(I)V
...
.method protected onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    sget v1, Lcom/android/systemui/res/R$dimen;->qs_data_usage_text_size:I

    invoke-static {p0, v0, v1}, Lcom/android/systemui/FontSizeUtils;->updateFontSize(Landroid/view/View;II)V

    .line 55
    sget v0, Lcom/android/systemui/res/R$id;->usage_text:I

    sget v1, Lcom/android/systemui/res/R$dimen;->qs_data_usage_usage_text_size:I

    invoke-static {p0, v0, v1}, Lcom/android/systemui/FontSizeUtils;->updateFontSize(Landroid/view/View;II)V

    .line 56
    sget v0, Lcom/android/systemui/res/R$id;->usage_carrier_text:I
    ...
    .line 58
    sget v0, Lcom/android/systemui/res/R$id;->usage_info_top_text:I
    ...
    .line 60
    sget v0, Lcom/android/systemui/res/R$id;->usage_period_text:I
    ...
    .line 61
    sget v0, Lcom/android/systemui/res/R$id;->usage_info_bottom_text:I
