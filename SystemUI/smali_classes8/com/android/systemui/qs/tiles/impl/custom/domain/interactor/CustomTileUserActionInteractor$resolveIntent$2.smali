...
.method public final create(Ljava/lang/Object;Lkotlin/coroutines/Continuation;)Lkotlin/coroutines/Continuation;
    ...
    new-instance v0, Lcom/android/systemui/qs/tiles/impl/custom/domain/interactor/CustomTileUserActionInteractor$resolveIntent$2;

    iget-object v1, p0, Lcom/android/systemui/qs/tiles/impl/custom/domain/interactor/CustomTileUserActionInteractor$resolveIntent$2;->this$0:Lcom/android/systemui/qs/tiles/impl/custom/domain/interactor/CustomTileUserActionInteractor;

    iget-object v2, p0, Lcom/android/systemui/qs/tiles/impl/custom/domain/interactor/CustomTileUserActionInteractor$resolveIntent$2;->$intent:Landroid/content/Intent;

    iget-object v3, p0, Lcom/android/systemui/qs/tiles/impl/custom/domain/interactor/CustomTileUserActionInteractor$resolveIntent$2;->$user:Landroid/os/UserHandle;

    invoke-direct {v0, v1, v2, v3, p2}, Lcom/android/systemui/qs/tiles/impl/custom/domain/interactor/CustomTileUserActionInteractor$resolveIntent$2;-><init>(Lcom/android/systemui/qs/tiles/impl/custom/domain/interactor/CustomTileUserActionInteractor;Landroid/content/Intent;Landroid/os/UserHandle;Lkotlin/coroutines/Continuation;)V
...
.method public final invoke(Lkotlinx/coroutines/CoroutineScope;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    check-cast v0, Lcom/android/systemui/qs/tiles/impl/custom/domain/interactor/CustomTileUserActionInteractor$resolveIntent$2;

    sget-object v1, Lkotlin/Unit;->INSTANCE:Lkotlin/Unit;

    invoke-virtual {v0, v1}, Lcom/android/systemui/qs/tiles/impl/custom/domain/interactor/CustomTileUserActionInteractor$resolveIntent$2;->invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
...
.method public final invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 183
    .local v0, "this":Lcom/android/systemui/qs/tiles/impl/custom/domain/interactor/CustomTileUserActionInteractor$resolveIntent$2;
    .local p1, "$result":Ljava/lang/Object;
    nop

    .line 181
    iget-object v1, v0, Lcom/android/systemui/qs/tiles/impl/custom/domain/interactor/CustomTileUserActionInteractor$resolveIntent$2;->this$0:Lcom/android/systemui/qs/tiles/impl/custom/domain/interactor/CustomTileUserActionInteractor;

    invoke-static {v1}, Lcom/android/systemui/qs/tiles/impl/custom/domain/interactor/CustomTileUserActionInteractor;->access$getContext$p(Lcom/android/systemui/qs/tiles/impl/custom/domain/interactor/CustomTileUserActionInteractor;)Landroid/content/Context;
    ...
    .line 182
    iget-object v2, v0, Lcom/android/systemui/qs/tiles/impl/custom/domain/interactor/CustomTileUserActionInteractor$resolveIntent$2;->$intent:Landroid/content/Intent;

    iget-object v3, v0, Lcom/android/systemui/qs/tiles/impl/custom/domain/interactor/CustomTileUserActionInteractor$resolveIntent$2;->$user:Landroid/os/UserHandle;
    ...
    .local v2, "$this$invokeSuspend_u24lambda_u241":Landroid/content/pm/ActivityInfo;
    const/4 v3, 0x0

    .line 186
    .local v3, "$i$a$-with-CustomTileUserActionInteractor$resolveIntent$2$1":I
    new-instance v4, Landroid/content/Intent;

    const-string v5, "android.service.quicksettings.action.QS_TILE_PREFERENCES"

    invoke-direct {v4, v5}, Landroid/content/Intent;-><init>(Ljava/lang/String;)V

    move-object v5, v4

    .local v5, "$this$invokeSuspend_u24lambda_u241_u24lambda_u240":Landroid/content/Intent;
    const/4 v6, 0x0

    .line 187
    .local v6, "$i$a$-apply-CustomTileUserActionInteractor$resolveIntent$2$1$1":I
    ...
    .line 186
    .end local v5    # "$this$invokeSuspend_u24lambda_u241_u24lambda_u240":Landroid/content/Intent;
    .end local v6    # "$i$a$-apply-CustomTileUserActionInteractor$resolveIntent$2$1$1":I
    nop

    .line 185
    .end local v2    # "$this$invokeSuspend_u24lambda_u241":Landroid/content/pm/ActivityInfo;
    .end local v3    # "$i$a$-with-CustomTileUserActionInteractor$resolveIntent$2$1":I
    return-object v4
