...
.method static constructor <clinit>()V
    ...
    sput v0, Lcom/android/systemui/qs/tiles/impl/location/domain/LocationTileMapper;->$stable:I
...
.method public static final synthetic access$getResources$p(Lcom/android/systemui/qs/tiles/impl/location/domain/LocationTileMapper;)Landroid/content/res/Resources;
    .locals 1
    .param p0, "$this"    # Lcom/android/systemui/qs/tiles/impl/location/domain/LocationTileMapper;
...
.method public static final synthetic access$getTheme$p(Lcom/android/systemui/qs/tiles/impl/location/domain/LocationTileMapper;)Landroid/content/res/Resources$Theme;
    .locals 1
    .param p0, "$this"    # Lcom/android/systemui/qs/tiles/impl/location/domain/LocationTileMapper;

    .line 31
    iget-object v0, p0, Lcom/android/systemui/qs/tiles/impl/location/domain/LocationTileMapper;->theme:Landroid/content/res/Resources$Theme;
...
.method public bridge synthetic map(Lcom/android/systemui/qs/tiles/viewmodel/QSTileConfig;Ljava/lang/Object;)Lcom/android/systemui/qs/tiles/viewmodel/QSTileState;
    ...
    check-cast v0, Lcom/android/systemui/qs/tiles/impl/location/domain/model/LocationTileModel;

    invoke-virtual {v0}, Lcom/android/systemui/qs/tiles/impl/location/domain/model/LocationTileModel;->unbox-impl()Z

    move-result v0

    invoke-virtual {p0, p1, v0}, Lcom/android/systemui/qs/tiles/impl/location/domain/LocationTileMapper;->map-8ub76aY(Lcom/android/systemui/qs/tiles/viewmodel/QSTileConfig;Z)Lcom/android/systemui/qs/tiles/viewmodel/QSTileState;
...
.method public map-8ub76aY(Lcom/android/systemui/qs/tiles/viewmodel/QSTileConfig;Z)Lcom/android/systemui/qs/tiles/viewmodel/QSTileState;
    .locals 5
    .param p1, "config"    # Lcom/android/systemui/qs/tiles/viewmodel/QSTileConfig;
    .param p2, "data"    # Z
    ...
    new-instance v4, Lcom/android/systemui/qs/tiles/impl/location/domain/LocationTileMapper$map$1;

    invoke-direct {v4, p2, p0}, Lcom/android/systemui/qs/tiles/impl/location/domain/LocationTileMapper$map$1;-><init>(ZLcom/android/systemui/qs/tiles/impl/location/domain/LocationTileMapper;)V
