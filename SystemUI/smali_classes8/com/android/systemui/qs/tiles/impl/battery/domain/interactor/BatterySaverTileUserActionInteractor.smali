...
.source "BatterySaverTileUserActionInteractor.kt"
...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "(Lcom/android/systemui/qs/tiles/base/actions/QSTileIntentUserInputHandler;Lcom/android/systemui/statusbar/policy/BatteryController;)V",
        "handleInput",
        "",
        "input",
...
.method static constructor <clinit>()V
    ...
    sput v0, Lcom/android/systemui/qs/tiles/impl/battery/domain/interactor/BatterySaverTileUserActionInteractor;->$stable:I
...
.method public handleInput(Lcom/android/systemui/qs/tiles/base/interactor/QSTileInput;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    .line 39
    .local v1, "$i$a$-with-BatterySaverTileUserActionInteractor$handleInput$2":I
    ...
    check-cast v2, Lcom/android/systemui/qs/tiles/impl/battery/domain/model/BatterySaverTileModel;

    invoke-interface {v2}, Lcom/android/systemui/qs/tiles/impl/battery/domain/model/BatterySaverTileModel;->isPluggedIn()Z
    ...
    .line 42
    iget-object v2, p0, Lcom/android/systemui/qs/tiles/impl/battery/domain/interactor/BatterySaverTileUserActionInteractor;->batteryController:Lcom/android/systemui/statusbar/policy/BatteryController;

    invoke-virtual {v0}, Lcom/android/systemui/qs/tiles/base/interactor/QSTileInput;->getData()Ljava/lang/Object;

    move-result-object v3

    check-cast v3, Lcom/android/systemui/qs/tiles/impl/battery/domain/model/BatterySaverTileModel;

    invoke-interface {v3}, Lcom/android/systemui/qs/tiles/impl/battery/domain/model/BatterySaverTileModel;->isPowerSaving()Z
    ...
    invoke-interface {v2, v3, v4}, Lcom/android/systemui/statusbar/policy/BatteryController;->setPowerSaveMode(ZLcom/android/systemui/animation/Expandable;)V
    ...
    .line 46
    iget-object v3, p0, Lcom/android/systemui/qs/tiles/impl/battery/domain/interactor/BatterySaverTileUserActionInteractor;->qsTileIntentUserActionHandler:Lcom/android/systemui/qs/tiles/base/actions/QSTileIntentUserInputHandler;
    ...
    .end local v1    # "$i$a$-with-BatterySaverTileUserActionInteractor$handleInput$2":I
