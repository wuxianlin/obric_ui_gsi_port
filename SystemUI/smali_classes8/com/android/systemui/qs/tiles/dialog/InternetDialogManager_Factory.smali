...
.method public constructor <init>(Ljavax/inject/Provider;Ljavax/inject/Provider;Ljavax/inject/Provider;)V
    ...
    .local p2, "dialogFactoryProvider":Ljavax/inject/Provider;, "Ljavax/inject/Provider<Lcom/android/systemui/qs/tiles/dialog/InternetDialogDelegate$Factory;>;"
...
.method public static create(Ljavax/inject/Provider;Ljavax/inject/Provider;Ljavax/inject/Provider;)Lcom/android/systemui/qs/tiles/dialog/InternetDialogManager_Factory;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .local p1, "dialogFactoryProvider":Ljavax/inject/Provider;, "Ljavax/inject/Provider<Lcom/android/systemui/qs/tiles/dialog/InternetDialogDelegate$Factory;>;"
    .local p2, "bgDispatcherProvider":Ljavax/inject/Provider;, "Ljavax/inject/Provider<Lkotlinx/coroutines/CoroutineDispatcher;>;"
    new-instance v0, Lcom/android/systemui/qs/tiles/dialog/InternetDialogManager_Factory;

    invoke-direct {v0, p0, p1, p2}, Lcom/android/systemui/qs/tiles/dialog/InternetDialogManager_Factory;-><init>(Ljavax/inject/Provider;Ljavax/inject/Provider;Ljavax/inject/Provider;)V

    return-object v0
.end method

.method public static newInstance(Lcom/android/systemui/animation/DialogTransitionAnimator;Lcom/android/systemui/qs/tiles/dialog/InternetDialogDelegate$Factory;Lkotlinx/coroutines/CoroutineDispatcher;)Lcom/android/systemui/qs/tiles/dialog/InternetDialogManager;
    .locals 1
    .param p0, "dialogTransitionAnimator"    # Lcom/android/systemui/animation/DialogTransitionAnimator;
    .param p1, "dialogFactory"    # Lcom/android/systemui/qs/tiles/dialog/InternetDialogDelegate$Factory;
    .param p2, "bgDispatcher"    # Lkotlinx/coroutines/CoroutineDispatcher;

    .line 56
    new-instance v0, Lcom/android/systemui/qs/tiles/dialog/InternetDialogManager;

    invoke-direct {v0, p0, p1, p2}, Lcom/android/systemui/qs/tiles/dialog/InternetDialogManager;-><init>(Lcom/android/systemui/animation/DialogTransitionAnimator;Lcom/android/systemui/qs/tiles/dialog/InternetDialogDelegate$Factory;Lkotlinx/coroutines/CoroutineDispatcher;)V
...
.method public get()Lcom/android/systemui/qs/tiles/dialog/InternetDialogManager;
    ...
    iget-object v1, p0, Lcom/android/systemui/qs/tiles/dialog/InternetDialogManager_Factory;->dialogFactoryProvider:Ljavax/inject/Provider;

    invoke-interface {v1}, Ljavax/inject/Provider;->get()Ljava/lang/Object;

    move-result-object v1

    check-cast v1, Lcom/android/systemui/qs/tiles/dialog/InternetDialogDelegate$Factory;

    iget-object v2, p0, Lcom/android/systemui/qs/tiles/dialog/InternetDialogManager_Factory;->bgDispatcherProvider:Ljavax/inject/Provider;
    ...
    invoke-static {v0, v1, v2}, Lcom/android/systemui/qs/tiles/dialog/InternetDialogManager_Factory;->newInstance(Lcom/android/systemui/animation/DialogTransitionAnimator;Lcom/android/systemui/qs/tiles/dialog/InternetDialogDelegate$Factory;Lkotlinx/coroutines/CoroutineDispatcher;)Lcom/android/systemui/qs/tiles/dialog/InternetDialogManager;
