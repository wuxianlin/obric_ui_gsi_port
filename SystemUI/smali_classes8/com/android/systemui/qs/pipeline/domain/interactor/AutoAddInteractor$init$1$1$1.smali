...
.method public final create(Ljava/lang/Object;Lkotlin/coroutines/Continuation;)Lkotlin/coroutines/Continuation;
    ...
    invoke-direct {v0, v1, v2, p2}, Lcom/android/systemui/qs/pipeline/domain/interactor/AutoAddInteractor$init$1$1$1;-><init>(Lcom/android/systemui/qs/pipeline/domain/interactor/AutoAddInteractor;ILkotlin/coroutines/Continuation;)V
...
.method public final invoke(Lkotlinx/coroutines/CoroutineScope;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    check-cast v0, Lcom/android/systemui/qs/pipeline/domain/interactor/AutoAddInteractor$init$1$1$1;

    sget-object v1, Lkotlin/Unit;->INSTANCE:Lkotlin/Unit;

    invoke-virtual {v0, v1}, Lcom/android/systemui/qs/pipeline/domain/interactor/AutoAddInteractor$init$1$1$1;->invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
...
.method public final invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .local v0, "this":Lcom/android/systemui/qs/pipeline/domain/interactor/AutoAddInteractor$init$1$1$1;
    .local p1, "$result":Ljava/lang/Object;
    iget-object v1, v0, Lcom/android/systemui/qs/pipeline/domain/interactor/AutoAddInteractor$init$1$1$1;->L$0:Ljava/lang/Object;

    check-cast v1, Lkotlinx/coroutines/CoroutineScope;

    .line 79
    .local v1, "$this$coroutineScope":Lkotlinx/coroutines/CoroutineScope;
    new-instance v2, Lcom/android/systemui/qs/pipeline/domain/interactor/AutoAddInteractor$init$1$1$1$1;

    iget-object v3, v0, Lcom/android/systemui/qs/pipeline/domain/interactor/AutoAddInteractor$init$1$1$1;->this$0:Lcom/android/systemui/qs/pipeline/domain/interactor/AutoAddInteractor;

    iget v4, v0, Lcom/android/systemui/qs/pipeline/domain/interactor/AutoAddInteractor$init$1$1$1;->$userId:I

    const/4 v8, 0x0

    invoke-direct {v2, v3, v4, v8}, Lcom/android/systemui/qs/pipeline/domain/interactor/AutoAddInteractor$init$1$1$1$1;-><init>(Lcom/android/systemui/qs/pipeline/domain/interactor/AutoAddInteractor;ILkotlin/coroutines/Continuation;)V
    ...
    .line 80
    new-instance v2, Lcom/android/systemui/qs/pipeline/domain/interactor/AutoAddInteractor$init$1$1$1$2;

    iget-object v3, v0, Lcom/android/systemui/qs/pipeline/domain/interactor/AutoAddInteractor$init$1$1$1;->this$0:Lcom/android/systemui/qs/pipeline/domain/interactor/AutoAddInteractor;

    iget v4, v0, Lcom/android/systemui/qs/pipeline/domain/interactor/AutoAddInteractor$init$1$1$1;->$userId:I

    invoke-direct {v2, v3, v4, v8}, Lcom/android/systemui/qs/pipeline/domain/interactor/AutoAddInteractor$init$1$1$1$2;-><init>(Lcom/android/systemui/qs/pipeline/domain/interactor/AutoAddInteractor;ILkotlin/coroutines/Continuation;)V
