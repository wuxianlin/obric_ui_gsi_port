...
.method public constructor <init>(Ljava/util/List;Landroid/content/Context;)V
    .locals 1
    .param p1, "currentTileSpecs"    # Ljava/util/List;
...
.method public final component2()Landroid/content/Context;
    ...
    iget-object v0, p0, Lcom/android/systemui/qs/pipeline/domain/interactor/AccessibilityTilesInteractor$Data;->userContext:Landroid/content/Context;
...
.method public final copy(Ljava/util/List;Landroid/content/Context;)Lcom/android/systemui/qs/pipeline/domain/interactor/AccessibilityTilesInteractor$Data;
    ...
    new-instance v0, Lcom/android/systemui/qs/pipeline/domain/interactor/AccessibilityTilesInteractor$Data;

    invoke-direct {v0, p1, p2}, Lcom/android/systemui/qs/pipeline/domain/interactor/AccessibilityTilesInteractor$Data;-><init>(Ljava/util/List;Landroid/content/Context;)V
...
.method public equals(Ljava/lang/Object;)Z
    ...
    check-cast v1, Lcom/android/systemui/qs/pipeline/domain/interactor/AccessibilityTilesInteractor$Data;

    iget-object v3, p0, Lcom/android/systemui/qs/pipeline/domain/interactor/AccessibilityTilesInteractor$Data;->currentTileSpecs:Ljava/util/List;

    iget-object v4, v1, Lcom/android/systemui/qs/pipeline/domain/interactor/AccessibilityTilesInteractor$Data;->currentTileSpecs:Ljava/util/List;
    ...
    :cond_2
    iget-object v3, p0, Lcom/android/systemui/qs/pipeline/domain/interactor/AccessibilityTilesInteractor$Data;->userContext:Landroid/content/Context;

    iget-object v1, v1, Lcom/android/systemui/qs/pipeline/domain/interactor/AccessibilityTilesInteractor$Data;->userContext:Landroid/content/Context;
...
.method public hashCode()I
    ...
    iget-object v2, p0, Lcom/android/systemui/qs/pipeline/domain/interactor/AccessibilityTilesInteractor$Data;->userContext:Landroid/content/Context;
...
.method public toString()Ljava/lang/String;
    ...
    iget-object v1, p0, Lcom/android/systemui/qs/pipeline/domain/interactor/AccessibilityTilesInteractor$Data;->userContext:Landroid/content/Context;

    new-instance v2, Ljava/lang/StringBuilder;

    invoke-direct {v2}, Ljava/lang/StringBuilder;-><init>()V

    const-string v3, "Data(currentTileSpecs="
