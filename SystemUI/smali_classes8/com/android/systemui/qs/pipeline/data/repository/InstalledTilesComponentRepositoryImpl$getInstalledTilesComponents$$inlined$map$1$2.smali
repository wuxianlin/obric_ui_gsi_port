...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lcom/android/systemui/qs/pipeline/data/repository/InstalledTilesComponentRepositoryImpl$getInstalledTilesComponents$$inlined$map$1;->collect(Lkotlinx/coroutines/flow/FlowCollector;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
.end annotation
...
.method public final emit(Ljava/lang/Object;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    iget p2, v0, Lcom/android/systemui/qs/pipeline/data/repository/InstalledTilesComponentRepositoryImpl$getInstalledTilesComponents$$inlined$map$1$2$1;->label:I

    sub-int/2addr p2, v2

    iput p2, v0, Lcom/android/systemui/qs/pipeline/data/repository/InstalledTilesComponentRepositoryImpl$getInstalledTilesComponents$$inlined$map$1$2$1;->label:I
    ...
    iget-object v0, p2, Lcom/android/systemui/qs/pipeline/data/repository/InstalledTilesComponentRepositoryImpl$getInstalledTilesComponents$$inlined$map$1$2$1;->result:Ljava/lang/Object;
    ...
    .line 0
    iget v2, p2, Lcom/android/systemui/qs/pipeline/data/repository/InstalledTilesComponentRepositoryImpl$getInstalledTilesComponents$$inlined$map$1$2$1;->label:I
    ...
    .line 53
    .local v2, "this":Lcom/android/systemui/qs/pipeline/data/repository/InstalledTilesComponentRepositoryImpl$getInstalledTilesComponents$$inlined$map$1$2;
    .local p1, "value":Ljava/lang/Object;
    iget-object v2, v2, Lcom/android/systemui/qs/pipeline/data/repository/InstalledTilesComponentRepositoryImpl$getInstalledTilesComponents$$inlined$map$1$2;->$this_unsafeFlow:Lkotlinx/coroutines/flow/FlowCollector;
    ...
    .line 224
    .local v4, "$i$a$-map-InstalledTilesComponentRepositoryImpl$getInstalledTilesComponents$2":I
    move-object v5, p1
    ...
    .local p1, "destination$iv":Ljava/util/Collection;
    const/4 v6, 0x0
    ...
    .line 224
    .local v9, "$i$a$-mapTo-InstalledTilesComponentRepositoryImpl$getInstalledTilesComponents$2$1":I
    ...
    .end local v9    # "$i$a$-mapTo-InstalledTilesComponentRepositoryImpl$getInstalledTilesComponents$2$1":I
    ...
    .end local p1    # "destination$iv":Ljava/util/Collection;
    nop

    .line 223
    .end local v4    # "$i$a$-map-InstalledTilesComponentRepositoryImpl$getInstalledTilesComponents$2":I
    const/4 v4, 0x1

    iput v4, p2, Lcom/android/systemui/qs/pipeline/data/repository/InstalledTilesComponentRepositoryImpl$getInstalledTilesComponents$$inlined$map$1$2$1;->label:I
