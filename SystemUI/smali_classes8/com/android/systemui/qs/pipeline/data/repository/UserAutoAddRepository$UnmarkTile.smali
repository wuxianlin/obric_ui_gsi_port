.class final Lcom/android/systemui/qs/pipeline/data/repository/UserAutoAddRepository$UnmarkTile;
...
.annotation system Ldalvik/annotation/SourceDebugExtension;
    value = "SMAP\nUserAutoAddRepository.kt\nKotlin\n*S Kotlin\n*F\n+ 1 UserAutoAddRepository.kt\ncom/android/systemui/qs/pipeline/data/repository/UserAutoAddRepository$UnmarkTile\n+ 2 fake.kt\nkotlin/jvm/internal/FakeKt\n*L\n1#1,186:1\n1#2:187\n*E\n"
.end annotation
...
.method public static synthetic copy$default(Lcom/android/systemui/qs/pipeline/data/repository/UserAutoAddRepository$UnmarkTile;Lcom/android/systemui/qs/pipeline/shared/TileSpec;ILjava/lang/Object;)Lcom/android/systemui/qs/pipeline/data/repository/UserAutoAddRepository$UnmarkTile;
    .locals 0
    ...
    iget-object p1, p0, Lcom/android/systemui/qs/pipeline/data/repository/UserAutoAddRepository$UnmarkTile;->tileSpec:Lcom/android/systemui/qs/pipeline/shared/TileSpec;

    :cond_0
    invoke-virtual {p0, p1}, Lcom/android/systemui/qs/pipeline/data/repository/UserAutoAddRepository$UnmarkTile;->copy(Lcom/android/systemui/qs/pipeline/shared/TileSpec;)Lcom/android/systemui/qs/pipeline/data/repository/UserAutoAddRepository$UnmarkTile;
...
.method public apply(Ljava/util/Set;)Ljava/util/Set;
    ...
    .line 159
    .local v2, "$i$a$-apply-UserAutoAddRepository$UnmarkTile$apply$1":I
    iget-object v3, p0, Lcom/android/systemui/qs/pipeline/data/repository/UserAutoAddRepository$UnmarkTile;->tileSpec:Lcom/android/systemui/qs/pipeline/shared/TileSpec;

    invoke-interface {v1, v3}, Ljava/util/Set;->remove(Ljava/lang/Object;)Z

    .end local v1    # "$this$apply_u24lambda_u240":Ljava/util/Set;
    .end local v2    # "$i$a$-apply-UserAutoAddRepository$UnmarkTile$apply$1":I
    return-object v0
.end method
...
.method public final component1()Lcom/android/systemui/qs/pipeline/shared/TileSpec;
    ...
    iget-object v0, p0, Lcom/android/systemui/qs/pipeline/data/repository/UserAutoAddRepository$UnmarkTile;->tileSpec:Lcom/android/systemui/qs/pipeline/shared/TileSpec;

    return-object v0
.end method

.method public final copy(Lcom/android/systemui/qs/pipeline/shared/TileSpec;)Lcom/android/systemui/qs/pipeline/data/repository/UserAutoAddRepository$UnmarkTile;
    .locals 1
...
.method public equals(Ljava/lang/Object;)Z
    ...
    check-cast v1, Lcom/android/systemui/qs/pipeline/data/repository/UserAutoAddRepository$UnmarkTile;

    iget-object v3, p0, Lcom/android/systemui/qs/pipeline/data/repository/UserAutoAddRepository$UnmarkTile;->tileSpec:Lcom/android/systemui/qs/pipeline/shared/TileSpec;

    iget-object v1, v1, Lcom/android/systemui/qs/pipeline/data/repository/UserAutoAddRepository$UnmarkTile;->tileSpec:Lcom/android/systemui/qs/pipeline/shared/TileSpec;
...
.method public toString()Ljava/lang/String;
    ...
    const-string v2, "UnmarkTile(tileSpec="
