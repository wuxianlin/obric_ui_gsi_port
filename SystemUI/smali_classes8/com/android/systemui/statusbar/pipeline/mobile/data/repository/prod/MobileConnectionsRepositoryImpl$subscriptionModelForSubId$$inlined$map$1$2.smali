...
.method public final emit(Ljava/lang/Object;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    iget-object v0, p2, Lcom/android/systemui/statusbar/pipeline/mobile/data/repository/prod/MobileConnectionsRepositoryImpl$subscriptionModelForSubId$$inlined$map$1$2$1;->result:Ljava/lang/Object;
    ...
    .line 0
    iget v2, p2, Lcom/android/systemui/statusbar/pipeline/mobile/data/repository/prod/MobileConnectionsRepositoryImpl$subscriptionModelForSubId$$inlined$map$1$2$1;->label:I
    ...
    .line 53
    .local v2, "this":Lcom/android/systemui/statusbar/pipeline/mobile/data/repository/prod/MobileConnectionsRepositoryImpl$subscriptionModelForSubId$$inlined$map$1$2;
    .local p1, "value":Ljava/lang/Object;
    iget-object v3, v2, Lcom/android/systemui/statusbar/pipeline/mobile/data/repository/prod/MobileConnectionsRepositoryImpl$subscriptionModelForSubId$$inlined$map$1$2;->$this_unsafeFlow:Lkotlinx/coroutines/flow/FlowCollector;
    ...
    .line 224
    .local v5, "$i$a$-map-MobileConnectionsRepositoryImpl$subscriptionModelForSubId$1":I
    ...
    .local v9, "model":Lcom/android/systemui/statusbar/pipeline/mobile/data/model/SubscriptionModel;
    const/4 v10, 0x0

    .line 224
    .local v10, "$i$a$-firstOrNull-MobileConnectionsRepositoryImpl$subscriptionModelForSubId$1$1":I
    invoke-virtual {v9}, Lcom/android/systemui/statusbar/pipeline/mobile/data/model/SubscriptionModel;->getSubscriptionId()I

    move-result v11

    iget v12, v2, Lcom/android/systemui/statusbar/pipeline/mobile/data/repository/prod/MobileConnectionsRepositoryImpl$subscriptionModelForSubId$$inlined$map$1$2;->$subId$inlined:I
    ...
    .end local v9    # "model":Lcom/android/systemui/statusbar/pipeline/mobile/data/model/SubscriptionModel;
    :cond_2
    const/4 v9, 0x0

    .line 225
    .end local v10    # "$i$a$-firstOrNull-MobileConnectionsRepositoryImpl$subscriptionModelForSubId$1$1":I
    :goto_1
    if-eqz v9, :cond_1
    ...
    .line 226
    .end local v2    # "this":Lcom/android/systemui/statusbar/pipeline/mobile/data/repository/prod/MobileConnectionsRepositoryImpl$subscriptionModelForSubId$$inlined$map$1$2;
    ...
    .line 223
    .end local v5    # "$i$a$-map-MobileConnectionsRepositoryImpl$subscriptionModelForSubId$1":I
    iput v8, p2, Lcom/android/systemui/statusbar/pipeline/mobile/data/repository/prod/MobileConnectionsRepositoryImpl$subscriptionModelForSubId$$inlined$map$1$2$1;->label:I
