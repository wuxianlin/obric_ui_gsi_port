...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lcom/android/systemui/statusbar/pipeline/mobile/data/repository/CarrierConfigRepository$special$$inlined$mapNotNull$1;->collect(Lkotlinx/coroutines/flow/FlowCollector;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
.end annotation
...
.method public final emit(Ljava/lang/Object;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    iget p2, v0, Lcom/android/systemui/statusbar/pipeline/mobile/data/repository/CarrierConfigRepository$special$$inlined$mapNotNull$1$2$1;->label:I

    sub-int/2addr p2, v2

    iput p2, v0, Lcom/android/systemui/statusbar/pipeline/mobile/data/repository/CarrierConfigRepository$special$$inlined$mapNotNull$1$2$1;->label:I
    ...
    iget-object v0, p2, Lcom/android/systemui/statusbar/pipeline/mobile/data/repository/CarrierConfigRepository$special$$inlined$mapNotNull$1$2$1;->result:Ljava/lang/Object;
    ...
    .line 0
    iget v2, p2, Lcom/android/systemui/statusbar/pipeline/mobile/data/repository/CarrierConfigRepository$special$$inlined$mapNotNull$1$2$1;->label:I
    ...
    .line 53
    .local v2, "this":Lcom/android/systemui/statusbar/pipeline/mobile/data/repository/CarrierConfigRepository$special$$inlined$mapNotNull$1$2;
    .local p1, "value":Ljava/lang/Object;
    iget-object v3, v2, Lcom/android/systemui/statusbar/pipeline/mobile/data/repository/CarrierConfigRepository$special$$inlined$mapNotNull$1$2;->$this_unsafeFlow:Lkotlinx/coroutines/flow/FlowCollector;
    ...
    .line 224
    .local v5, "$i$a$-mapNotNull-CarrierConfigRepository$carrierConfigStream$4":I
    iget-object v6, v2, Lcom/android/systemui/statusbar/pipeline/mobile/data/repository/CarrierConfigRepository$special$$inlined$mapNotNull$1$2;->this$0:Lcom/android/systemui/statusbar/pipeline/mobile/data/repository/CarrierConfigRepository;

    invoke-static {v6}, Lcom/android/systemui/statusbar/pipeline/mobile/data/repository/CarrierConfigRepository;->access$getCarrierConfigManager$p(Lcom/android/systemui/statusbar/pipeline/mobile/data/repository/CarrierConfigRepository;)Landroid/telephony/CarrierConfigManager;
    ...
    .end local v2    # "this":Lcom/android/systemui/statusbar/pipeline/mobile/data/repository/CarrierConfigRepository$special$$inlined$mapNotNull$1$2;
    :goto_1
    move-object v2, v6
    ...
    .line 226
    .local v2, "it":Landroid/os/PersistableBundle;
    const/4 v6, 0x0

    .line 225
    .local v6, "$i$a$-let-CarrierConfigRepository$carrierConfigStream$4$1":I
    ...
    .end local v2    # "it":Landroid/os/PersistableBundle;
    .end local v6    # "$i$a$-let-CarrierConfigRepository$carrierConfigStream$4$1":I
    .end local p1    # "subId":I
    nop

    .line 223
    .end local v5    # "$i$a$-mapNotNull-CarrierConfigRepository$carrierConfigStream$4":I
    :cond_2
    if-eqz v7, :cond_4
    ...
    iput v2, p2, Lcom/android/systemui/statusbar/pipeline/mobile/data/repository/CarrierConfigRepository$special$$inlined$mapNotNull$1$2$1;->label:I
