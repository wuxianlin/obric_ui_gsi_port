...
.method public final invoke(Lcom/android/systemui/statusbar/pipeline/wifi/shared/model/WifiNetworkModel;Ljava/util/List;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    iget-object v1, p0, Lcom/android/systemui/statusbar/pipeline/wifi/domain/interactor/WifiInteractorImpl$areNetworksAvailable$1;->this$0:Lcom/android/systemui/statusbar/pipeline/wifi/domain/interactor/WifiInteractorImpl;

    invoke-direct {v0, v1, p3}, Lcom/android/systemui/statusbar/pipeline/wifi/domain/interactor/WifiInteractorImpl$areNetworksAvailable$1;-><init>(Lcom/android/systemui/statusbar/pipeline/wifi/domain/interactor/WifiInteractorImpl;Lkotlin/coroutines/Continuation;)V
    ...
    invoke-virtual {v0, v1}, Lcom/android/systemui/statusbar/pipeline/wifi/domain/interactor/WifiInteractorImpl$areNetworksAvailable$1;->invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
...
.method public final invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .local v0, "this":Lcom/android/systemui/statusbar/pipeline/wifi/domain/interactor/WifiInteractorImpl$areNetworksAvailable$1;
    .local p1, "$result":Ljava/lang/Object;
    iget-object v1, v0, Lcom/android/systemui/statusbar/pipeline/wifi/domain/interactor/WifiInteractorImpl$areNetworksAvailable$1;->L$0:Ljava/lang/Object;

    check-cast v1, Lcom/android/systemui/statusbar/pipeline/wifi/shared/model/WifiNetworkModel;

    .local v1, "currentNetwork":Lcom/android/systemui/statusbar/pipeline/wifi/shared/model/WifiNetworkModel;
    iget-object v2, v0, Lcom/android/systemui/statusbar/pipeline/wifi/domain/interactor/WifiInteractorImpl$areNetworksAvailable$1;->L$1:Ljava/lang/Object;

    check-cast v2, Ljava/util/List;

    .line 120
    .local v2, "scanResults":Ljava/util/List;
    ...
    .line 121
    .end local v1    # "currentNetwork":Lcom/android/systemui/statusbar/pipeline/wifi/shared/model/WifiNetworkModel;
    .end local v2    # "scanResults":Ljava/util/List;
    const/4 v1, 0x0

    goto :goto_0

    .line 122
    .restart local v1    # "currentNetwork":Lcom/android/systemui/statusbar/pipeline/wifi/shared/model/WifiNetworkModel;
    .restart local v2    # "scanResults":Ljava/util/List;
    :cond_0
    ...
    .restart local v2    # "scanResults":Ljava/util/List;
    :cond_1
    iget-object v3, v0, Lcom/android/systemui/statusbar/pipeline/wifi/domain/interactor/WifiInteractorImpl$areNetworksAvailable$1;->this$0:Lcom/android/systemui/statusbar/pipeline/wifi/domain/interactor/WifiInteractorImpl;

    move-object v4, v1

    check-cast v4, Lcom/android/systemui/statusbar/pipeline/wifi/shared/model/WifiNetworkModel$Active;

    invoke-static {v3, v4, v2}, Lcom/android/systemui/statusbar/pipeline/wifi/domain/interactor/WifiInteractorImpl;->access$anyNonMatchingNetworkExists(Lcom/android/systemui/statusbar/pipeline/wifi/domain/interactor/WifiInteractorImpl;Lcom/android/systemui/statusbar/pipeline/wifi/shared/model/WifiNetworkModel$Active;Ljava/util/List;)Z
