...
.method static constructor <clinit>()V
    ...
    sput v0, Lcom/android/systemui/statusbar/notification/row/BigPictureIconManager$DrawableState$PlaceHolder;->$stable:I
...
.method public final component2()Landroid/util/Size;
    ...
    iget-object v0, p0, Lcom/android/systemui/statusbar/notification/row/BigPictureIconManager$DrawableState$PlaceHolder;->drawableSize:Landroid/util/Size;
...
.method public final copy(Landroid/graphics/drawable/Icon;Landroid/util/Size;)Lcom/android/systemui/statusbar/notification/row/BigPictureIconManager$DrawableState$PlaceHolder;
    ...
    new-instance v0, Lcom/android/systemui/statusbar/notification/row/BigPictureIconManager$DrawableState$PlaceHolder;

    invoke-direct {v0, p1, p2}, Lcom/android/systemui/statusbar/notification/row/BigPictureIconManager$DrawableState$PlaceHolder;-><init>(Landroid/graphics/drawable/Icon;Landroid/util/Size;)V
...
.method public equals(Ljava/lang/Object;)Z
    ...
    iget-object v3, p0, Lcom/android/systemui/statusbar/notification/row/BigPictureIconManager$DrawableState$PlaceHolder;->icon:Landroid/graphics/drawable/Icon;

    iget-object v4, v1, Lcom/android/systemui/statusbar/notification/row/BigPictureIconManager$DrawableState$PlaceHolder;->icon:Landroid/graphics/drawable/Icon;
    ...
    :cond_2
    iget-object v3, p0, Lcom/android/systemui/statusbar/notification/row/BigPictureIconManager$DrawableState$PlaceHolder;->drawableSize:Landroid/util/Size;

    iget-object v1, v1, Lcom/android/systemui/statusbar/notification/row/BigPictureIconManager$DrawableState$PlaceHolder;->drawableSize:Landroid/util/Size;
...
.method public hashCode()I
    ...
    iget-object v2, p0, Lcom/android/systemui/statusbar/notification/row/BigPictureIconManager$DrawableState$PlaceHolder;->drawableSize:Landroid/util/Size;
...
.method public toString()Ljava/lang/String;
    ...
    iget-object v1, p0, Lcom/android/systemui/statusbar/notification/row/BigPictureIconManager$DrawableState$PlaceHolder;->drawableSize:Landroid/util/Size;

    new-instance v2, Ljava/lang/StringBuilder;

    invoke-direct {v2}, Ljava/lang/StringBuilder;-><init>()V

    const-string v3, "PlaceHolder(icon="
