...
.method public onDisplayChanged(I)V
    ...
    .line 85
    iget-object v1, p0, Lcom/android/systemui/settings/DisplayTrackerImpl$displayBrightnessChangedListener$1;->this$0:Lcom/android/systemui/settings/DisplayTrackerImpl;
    ...
    .line 88
    .local v4, "$i$a$-traceSection-DisplayTrackerImpl$displayBrightnessChangedListener$1$onDisplayChanged$1":I
    :try_start_0
    invoke-static {v1}, Lcom/android/systemui/settings/DisplayTrackerImpl;->access$getBrightnessCallbacks$p(Lcom/android/systemui/settings/DisplayTrackerImpl;)Ljava/util/List;
    ...
    .line 88
    .local v6, "$i$a$-synchronized-DisplayTrackerImpl$displayBrightnessChangedListener$1$onDisplayChanged$1$list$1":I
    :try_start_1
    invoke-static {v1}, Lcom/android/systemui/settings/DisplayTrackerImpl;->access$getBrightnessCallbacks$p(Lcom/android/systemui/settings/DisplayTrackerImpl;)Ljava/util/List;
    ...
    .end local v6    # "$i$a$-synchronized-DisplayTrackerImpl$displayBrightnessChangedListener$1$onDisplayChanged$1$list$1":I
    :try_start_2
    monitor-exit v5
    ...
    .end local v4    # "$i$a$-traceSection-DisplayTrackerImpl$displayBrightnessChangedListener$1$onDisplayChanged$1":I
    ...
    .restart local v4    # "$i$a$-traceSection-DisplayTrackerImpl$displayBrightnessChangedListener$1$onDisplayChanged$1":I
    :catchall_0
    move-exception v1
    ...
    .end local v2    # "$i$f$traceSection":I
    .end local v3    # "tracingEnabled$iv":Z
    .end local p0    # "this":Lcom/android/systemui/settings/DisplayTrackerImpl$displayBrightnessChangedListener$1;
    ...
    .restart local v2    # "$i$f$traceSection":I
    .restart local v3    # "tracingEnabled$iv":Z
    .restart local p0    # "this":Lcom/android/systemui/settings/DisplayTrackerImpl$displayBrightnessChangedListener$1;
