...
.method public awaitLoad(Landroidx/compose/ui/text/font/Font;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    .line 57
    instance-of v3, p1, Landroidx/compose/ui/text/font/AndroidFont;

    if-eqz v3, :cond_2

    move-object v3, p1

    check-cast v3, Landroidx/compose/ui/text/font/AndroidFont;

    invoke-virtual {v3}, Landroidx/compose/ui/text/font/AndroidFont;->getTypefaceLoader()Landroidx/compose/ui/text/font/AndroidFont$TypefaceLoader;

    move-result-object v3

    iget-object v4, v2, Landroidx/compose/ui/text/font/AndroidFontLoader;->context:Landroid/content/Context;

    move-object v5, p1

    check-cast v5, Landroidx/compose/ui/text/font/AndroidFont;

    const/4 v6, 0x1

    iput v6, p2, Landroidx/compose/ui/text/font/AndroidFontLoader$awaitLoad$1;->label:I

    invoke-interface {v3, v4, v5, p2}, Landroidx/compose/ui/text/font/AndroidFont$TypefaceLoader;->awaitLoad(Landroid/content/Context;Landroidx/compose/ui/text/font/AndroidFont;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    .restart local p1    # "font":Landroidx/compose/ui/text/font/Font;
    :cond_2
    instance-of v3, p1, Landroidx/compose/ui/text/font/ResourceFont;
    ...
    iput v5, p2, Landroidx/compose/ui/text/font/AndroidFontLoader$awaitLoad$1;->label:I

    invoke-static {v3, v4, p2}, Landroidx/compose/ui/text/font/AndroidFontLoader_androidKt;->access$loadAsync(Landroidx/compose/ui/text/font/ResourceFont;Landroid/content/Context;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    iget-object v4, v1, Landroidx/compose/ui/text/font/AndroidFontLoader;->context:Landroid/content/Context;

    invoke-static {v3, v2, v4}, Landroidx/compose/ui/text/font/PlatformTypefaces_androidKt;->setFontVariationSettings(Landroid/graphics/Typeface;Landroidx/compose/ui/text/font/FontVariation$Settings;Landroid/content/Context;)Landroid/graphics/Typeface;
    ...
    const-string/jumbo v4, "Unknown font type: "
...
.method public loadBlocking(Landroidx/compose/ui/text/font/Font;)Landroid/graphics/Typeface;
    ...
    const-string/jumbo v1, "Unsupported Async font load path"
    ...
    const-string/jumbo v2, "Unknown loading type "
