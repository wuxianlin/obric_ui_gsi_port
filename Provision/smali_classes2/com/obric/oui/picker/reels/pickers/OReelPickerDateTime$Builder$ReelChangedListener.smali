...
.method private final notifyChange()V
    ...
    iget-object p0, p0, Lcom/obric/oui/picker/reels/pickers/OReelPickerDateTime$Builder$ReelChangedListener;->this$0:Lcom/obric/oui/picker/reels/pickers/OReelPickerDateTime$Builder;
    ...
    invoke-virtual {p0, v1}, Ljava/time/LocalDateTime;->withSecond(I)Ljava/time/LocalDateTime;
...
.method private final onDateChanged(I)V
    ...
    .line 64
    invoke-virtual {v0}, Lcom/obric/oui/picker/reels/pickers/OReelPickerDateTime$Builder;->getMSelectedTime$OUI_standardRelease()Ljava/time/LocalDateTime;
    ...
    invoke-virtual {v1, v2}, Ljava/time/LocalDateTime;->withYear(I)Ljava/time/LocalDateTime;
    ...
    invoke-virtual {v1, p1}, Ljava/time/LocalDateTime;->withDayOfYear(I)Ljava/time/LocalDateTime;

    move-result-object p1

    invoke-virtual {v0, p1}, Lcom/obric/oui/picker/reels/pickers/OReelPickerDateTime$Builder;->setMSelectedTime$OUI_standardRelease(Ljava/time/LocalDateTime;)V
...
.method private final onTimeChanged(II)V
    ...
    .line 74
    iget-object p1, p0, Lcom/obric/oui/picker/reels/pickers/OReelPickerDateTime$Builder$ReelChangedListener;->this$0:Lcom/obric/oui/picker/reels/pickers/OReelPickerDateTime$Builder;

    invoke-virtual {p1}, Lcom/obric/oui/picker/reels/pickers/OReelPickerDateTime$Builder;->getMSelectedTime$OUI_standardRelease()Ljava/time/LocalDateTime;

    move-result-object v0

    invoke-virtual {v0, p2}, Ljava/time/LocalDateTime;->withMinute(I)Ljava/time/LocalDateTime;

    move-result-object p2

    invoke-virtual {p1, p2}, Lcom/obric/oui/picker/reels/pickers/OReelPickerDateTime$Builder;->setMSelectedTime$OUI_standardRelease(Ljava/time/LocalDateTime;)V
...
.method public onReelChanged(II)V
    ...
    .line 86
    :cond_0
    invoke-static {p0, v1, p2, v3, v0}, Lcom/obric/oui/picker/reels/pickers/OReelPickerDateTime$Builder$ReelChangedListener;->onTimeChanged$default(Lcom/obric/oui/picker/reels/pickers/OReelPickerDateTime$Builder$ReelChangedListener;IIILjava/lang/Object;)V
