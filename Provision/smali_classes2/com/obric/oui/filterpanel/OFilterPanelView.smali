...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput-object p2, p0, Lcom/obric/oui/filterpanel/OFilterPanelView;->filterGroupViewList:Ljava/util/Set;

    const/4 p2, 0x1

    .line 51
    iput p2, p0, Lcom/obric/oui/filterpanel/OFilterPanelView;->maxSelectCount:I

    .line 54
    sget v0, Lcom/obric/common/oui/R$layout;->o_layout_filter_panel_view:I
    ...
    invoke-virtual {p0, p1}, Lcom/obric/oui/filterpanel/OFilterPanelView;->setLayoutParams(Landroid/view/ViewGroup$LayoutParams;)V

    .line 56
    sget p1, Lcom/obric/common/oui/R$id;->filter_group_container:I

    invoke-virtual {p0, p1}, Lcom/obric/oui/filterpanel/OFilterPanelView;->findViewById(I)Landroid/view/View;

    move-result-object p1

    const-string p2, "findViewById(R.id.filter_group_container)"

    invoke-static {p1, p2}, Lkotlin/jvm/internal/Intrinsics;->checkNotNullExpressionValue(Ljava/lang/Object;Ljava/lang/String;)V

    check-cast p1, Landroid/widget/LinearLayout;

    iput-object p1, p0, Lcom/obric/oui/filterpanel/OFilterPanelView;->filterGroupContainer:Landroid/widget/LinearLayout;
    ...
    iput-object p1, p0, Lcom/obric/oui/filterpanel/OFilterPanelView;->btnContainer:Landroid/widget/LinearLayout;

    .line 58
    sget p1, Lcom/obric/common/oui/R$id;->btn_reset:I

    invoke-virtual {p0, p1}, Lcom/obric/oui/filterpanel/OFilterPanelView;->findViewById(I)Landroid/view/View;

    move-result-object p1

    const-string p2, "findViewById(R.id.btn_reset)"

    invoke-static {p1, p2}, Lkotlin/jvm/internal/Intrinsics;->checkNotNullExpressionValue(Ljava/lang/Object;Ljava/lang/String;)V

    check-cast p1, Lcom/obric/oui/button/OButton;

    iput-object p1, p0, Lcom/obric/oui/filterpanel/OFilterPanelView;->btnReset:Lcom/obric/oui/button/OButton;

    .line 59
    sget p1, Lcom/obric/common/oui/R$id;->btn_confirm:I

    invoke-virtual {p0, p1}, Lcom/obric/oui/filterpanel/OFilterPanelView;->findViewById(I)Landroid/view/View;

    move-result-object p1

    const-string p2, "findViewById(R.id.btn_confirm)"

    invoke-static {p1, p2}, Lkotlin/jvm/internal/Intrinsics;->checkNotNullExpressionValue(Ljava/lang/Object;Ljava/lang/String;)V

    check-cast p1, Lcom/obric/oui/button/OButton;

    iput-object p1, p0, Lcom/obric/oui/filterpanel/OFilterPanelView;->btnConfirm:Lcom/obric/oui/button/OButton;
...
.method public final addFilterGroup(Lcom/obric/oui/filterpanel/OFilterGroupView$Config;)Lcom/obric/oui/filterpanel/OFilterGroupView;
    ...
    :cond_0
    iget v1, p0, Lcom/obric/oui/filterpanel/OFilterPanelView;->filterStyle:I

    :goto_0
    const/4 v4, 0x0

    invoke-static {v0, v1, v4, v3, v2}, Lcom/obric/oui/filterpanel/OFilterGroupView;->setFilterStyle$default(Lcom/obric/oui/filterpanel/OFilterGroupView;IZILjava/lang/Object;)V
    ...
    invoke-virtual {v0, v1}, Lcom/obric/oui/filterpanel/OFilterGroupView;->setTitle(Ljava/lang/CharSequence;)V
    ...
    :cond_1
    iget v1, p0, Lcom/obric/oui/filterpanel/OFilterPanelView;->maxSelectCount:I

    :goto_1
    invoke-virtual {v0, v1}, Lcom/obric/oui/filterpanel/OFilterGroupView;->setMaxSelectCount(I)V
    ...
    invoke-virtual {v0, v1, v2, v3}, Lcom/obric/oui/filterpanel/OFilterGroupView;->setFilterItems(Ljava/util/List;II)V
    ...
    invoke-virtual {v0, v1}, Lcom/obric/oui/filterpanel/OFilterGroupView;->select(I)Z
    ...
    invoke-virtual {v0, p1}, Lcom/obric/oui/filterpanel/OFilterGroupView;->setEnableClickWhenSelected(Z)V
...
.method public final addFilterGroup(Lcom/obric/oui/filterpanel/OFilterGroupView;)V
    ...
    .line 64
    iget-object p0, p0, Lcom/obric/oui/filterpanel/OFilterPanelView;->filterGroupViewList:Ljava/util/Set;
...
.method public final getConfirmBtn()Lcom/obric/oui/button/OButton;
    ...
    .line 95
    iget-object p0, p0, Lcom/obric/oui/filterpanel/OFilterPanelView;->btnConfirm:Lcom/obric/oui/button/OButton;
...
.method public final getFilterGroupContainer()Landroid/widget/LinearLayout;
    ...
    .line 99
    iget-object p0, p0, Lcom/obric/oui/filterpanel/OFilterPanelView;->filterGroupContainer:Landroid/widget/LinearLayout;
...
.method public final getResetBtn()Lcom/obric/oui/button/OButton;
    ...
    .line 93
    iget-object p0, p0, Lcom/obric/oui/filterpanel/OFilterPanelView;->btnReset:Lcom/obric/oui/button/OButton;
...
.method public final setFilterStyle(IZ)V
    ...
    check-cast v0, Lcom/obric/oui/filterpanel/OFilterGroupView;

    .line 85
    invoke-virtual {v0, p1, p2}, Lcom/obric/oui/filterpanel/OFilterGroupView;->setFilterStyle(IZ)V
