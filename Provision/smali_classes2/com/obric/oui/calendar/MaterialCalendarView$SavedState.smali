...
.method constructor <init>(Landroid/os/Parcelable;)V
    ...
    .line 1178
    iput p1, p0, Lcom/obric/oui/calendar/MaterialCalendarView$SavedState;->showOtherDates:I

    const/4 p1, 0x1

    .line 1179
    iput-boolean p1, p0, Lcom/obric/oui/calendar/MaterialCalendarView$SavedState;->allowClickDaysOutsideCurrentMonth:Z

    const/4 v0, 0x0

    .line 1180
    iput-object v0, p0, Lcom/obric/oui/calendar/MaterialCalendarView$SavedState;->minDate:Lcom/obric/oui/calendar/CalendarDay;

    .line 1181
    iput-object v0, p0, Lcom/obric/oui/calendar/MaterialCalendarView$SavedState;->maxDate:Lcom/obric/oui/calendar/CalendarDay;
    ...
    iput-object v1, p0, Lcom/obric/oui/calendar/MaterialCalendarView$SavedState;->selectedDates:Ljava/util/List;

    .line 1183
    iput-boolean p1, p0, Lcom/obric/oui/calendar/MaterialCalendarView$SavedState;->topbarVisible:Z

    .line 1184
    iput p1, p0, Lcom/obric/oui/calendar/MaterialCalendarView$SavedState;->selectionMode:I

    const/4 p1, 0x0

    .line 1185
    iput-boolean p1, p0, Lcom/obric/oui/calendar/MaterialCalendarView$SavedState;->dynamicHeightEnabled:Z

    .line 1186
    iput-object v0, p0, Lcom/obric/oui/calendar/MaterialCalendarView$SavedState;->currentMonth:Lcom/obric/oui/calendar/CalendarDay;
...
.method public writeToParcel(Landroid/os/Parcel;I)V
    ...
    .line 1196
    iget p2, p0, Lcom/obric/oui/calendar/MaterialCalendarView$SavedState;->showOtherDates:I

    invoke-virtual {p1, p2}, Landroid/os/Parcel;->writeInt(I)V

    .line 1197
    iget-boolean p2, p0, Lcom/obric/oui/calendar/MaterialCalendarView$SavedState;->allowClickDaysOutsideCurrentMonth:Z
    ...
    .line 1198
    iget-object p2, p0, Lcom/obric/oui/calendar/MaterialCalendarView$SavedState;->minDate:Lcom/obric/oui/calendar/CalendarDay;
    ...
    .line 1199
    iget-object p2, p0, Lcom/obric/oui/calendar/MaterialCalendarView$SavedState;->maxDate:Lcom/obric/oui/calendar/CalendarDay;

    invoke-virtual {p1, p2, v0}, Landroid/os/Parcel;->writeParcelable(Landroid/os/Parcelable;I)V

    .line 1200
    iget-object p2, p0, Lcom/obric/oui/calendar/MaterialCalendarView$SavedState;->selectedDates:Ljava/util/List;

    invoke-virtual {p1, p2}, Landroid/os/Parcel;->writeTypedList(Ljava/util/List;)V

    .line 1201
    iget-boolean p2, p0, Lcom/obric/oui/calendar/MaterialCalendarView$SavedState;->topbarVisible:Z

    invoke-virtual {p1, p2}, Landroid/os/Parcel;->writeInt(I)V

    .line 1202
    iget p2, p0, Lcom/obric/oui/calendar/MaterialCalendarView$SavedState;->selectionMode:I

    invoke-virtual {p1, p2}, Landroid/os/Parcel;->writeInt(I)V

    .line 1203
    iget-boolean p2, p0, Lcom/obric/oui/calendar/MaterialCalendarView$SavedState;->dynamicHeightEnabled:Z

    invoke-virtual {p1, p2}, Landroid/os/Parcel;->writeInt(I)V

    .line 1204
    iget-object p2, p0, Lcom/obric/oui/calendar/MaterialCalendarView$SavedState;->currentMonth:Lcom/obric/oui/calendar/CalendarDay;

    invoke-virtual {p1, p2, v0}, Landroid/os/Parcel;->writeParcelable(Landroid/os/Parcelable;I)V

    .line 1205
    iget-boolean p0, p0, Lcom/obric/oui/calendar/MaterialCalendarView$SavedState;->cacheCurrentPosition:Z
