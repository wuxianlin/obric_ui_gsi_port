...
.method public final build(Landroid/content/Context;)Lcom/obric/oui/dialog/OCommonDialog;
    ...
    .line 142
    iget-boolean p1, p0, Lcom/obric/oui/dialog/OCommonDialog$Builder;->mFloating:Z

    invoke-static {v0, p1}, Lcom/obric/oui/dialog/OCommonDialog;->access$setMFloating$p(Lcom/obric/oui/dialog/OCommonDialog;Z)V

    .line 143
    iget-boolean p1, p0, Lcom/obric/oui/dialog/OCommonDialog$Builder;->mCancelable:Z

    invoke-static {v0, p1}, Lcom/obric/oui/dialog/OCommonDialog;->access$setMCancelable$p(Lcom/obric/oui/dialog/OCommonDialog;Z)V

    .line 145
    iget-object p1, p0, Lcom/obric/oui/dialog/OCommonDialog$Builder;->mTitle:Ljava/lang/String;

    invoke-static {v0, p1}, Lcom/obric/oui/dialog/OCommonDialog;->access$setMTitle$p(Lcom/obric/oui/dialog/OCommonDialog;Ljava/lang/String;)V

    .line 146
    iget-boolean p1, p0, Lcom/obric/oui/dialog/OCommonDialog$Builder;->mShowMessage:Z

    invoke-static {v0, p1}, Lcom/obric/oui/dialog/OCommonDialog;->access$setMShowMessage$p(Lcom/obric/oui/dialog/OCommonDialog;Z)V

    .line 147
    iget-object p1, p0, Lcom/obric/oui/dialog/OCommonDialog$Builder;->mMessage:Ljava/lang/CharSequence;

    invoke-static {v0, p1}, Lcom/obric/oui/dialog/OCommonDialog;->access$setMMessage$p(Lcom/obric/oui/dialog/OCommonDialog;Ljava/lang/CharSequence;)V

    .line 149
    iget-object p1, p0, Lcom/obric/oui/dialog/OCommonDialog$Builder;->mConfirmText:Ljava/lang/String;

    invoke-static {v0, p1}, Lcom/obric/oui/dialog/OCommonDialog;->access$setMConfirmText$p(Lcom/obric/oui/dialog/OCommonDialog;Ljava/lang/String;)V

    .line 150
    iget-object p1, p0, Lcom/obric/oui/dialog/OCommonDialog$Builder;->mConfirmClickListener:Lcom/obric/oui/dialog/ConfirmClickListener;

    invoke-static {v0, p1}, Lcom/obric/oui/dialog/OCommonDialog;->access$setMConfirmClickListener$p(Lcom/obric/oui/dialog/OCommonDialog;Lcom/obric/oui/dialog/ConfirmClickListener;)V

    .line 152
    iget-object p1, p0, Lcom/obric/oui/dialog/OCommonDialog$Builder;->mCancelText:Ljava/lang/String;

    invoke-static {v0, p1}, Lcom/obric/oui/dialog/OCommonDialog;->access$setMCancelText$p(Lcom/obric/oui/dialog/OCommonDialog;Ljava/lang/String;)V

    .line 153
    iget-object p0, p0, Lcom/obric/oui/dialog/OCommonDialog$Builder;->mCancelClickListener:Lcom/obric/oui/dialog/CancelClickListener;

    invoke-static {v0, p0}, Lcom/obric/oui/dialog/OCommonDialog;->access$setMCancelClickListener$p(Lcom/obric/oui/dialog/OCommonDialog;Lcom/obric/oui/dialog/CancelClickListener;)V
