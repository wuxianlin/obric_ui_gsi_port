...
.method public final onAnimationUpdate(Lcom/obric/oui/animation/engine/DynamicAnimation;FF)V
    ...
    .line 43
    iget-object p1, p0, Lcom/obric/oui/animation/style/CommonStyleKt$windowBottomShow$$inlined$apply$lambda$1;->$window$inlined:Landroid/view/Window;

    iget p3, p0, Lcom/obric/oui/animation/style/CommonStyleKt$windowBottomShow$$inlined$apply$lambda$1;->$startAnimValue:F

    iget v0, p0, Lcom/obric/oui/animation/style/CommonStyleKt$windowBottomShow$$inlined$apply$lambda$1;->$endAnimValue:F

    invoke-static {p2, p3, v0}, Lcom/obric/oui/animation/style/CommonStyleKt;->access$getAnimFraction(FFF)F

    move-result p2

    const/4 p3, 0x0

    iget p0, p0, Lcom/obric/oui/animation/style/CommonStyleKt$windowBottomShow$$inlined$apply$lambda$1;->$targetDimAmount$inlined:F

    invoke-static {p1, p2, p3, p0}, Lcom/obric/oui/animation/style/CommonStyleKt;->access$updateWindowDimWithAnim(Landroid/view/Window;FFF)V
