...
.method constructor <init>(Ljava/lang/Object;Lcom/obric/oui/animation/engine/FloatPropertyCompat;)V
    ...
    .line 355
    sget-object p1, Lcom/obric/oui/animation/engine/DynamicAnimation;->ROTATION:Lcom/obric/oui/animation/engine/DynamicAnimation$ViewProperty;

    if-eq p2, p1, :cond_4

    sget-object p1, Lcom/obric/oui/animation/engine/DynamicAnimation;->ROTATION_X:Lcom/obric/oui/animation/engine/DynamicAnimation$ViewProperty;

    if-eq p2, p1, :cond_4

    sget-object p1, Lcom/obric/oui/animation/engine/DynamicAnimation;->ROTATION_Y:Lcom/obric/oui/animation/engine/DynamicAnimation$ViewProperty;
    ...
    .line 358
    :cond_0
    sget-object p1, Lcom/obric/oui/animation/engine/DynamicAnimation;->ALPHA:Lcom/obric/oui/animation/engine/DynamicAnimation$ViewProperty;
    ...
    .line 360
    :cond_1
    sget-object p1, Lcom/obric/oui/animation/engine/DynamicAnimation;->SCALE_X:Lcom/obric/oui/animation/engine/DynamicAnimation$ViewProperty;

    if-eq p2, p1, :cond_3

    sget-object p1, Lcom/obric/oui/animation/engine/DynamicAnimation;->SCALE_Y:Lcom/obric/oui/animation/engine/DynamicAnimation$ViewProperty;
...
.method private endAnimationInternal(Z)V
    ...
    .line 681
    :cond_1
    iget-object p0, p0, Lcom/obric/oui/animation/engine/DynamicAnimation;->mEndListeners:Ljava/util/ArrayList;

    invoke-static {p0}, Lcom/obric/oui/animation/engine/DynamicAnimation;->removeNullEntries(Ljava/util/ArrayList;)V
...
.method private getPropertyValue()F
    ...
    iget-object p0, p0, Lcom/obric/oui/animation/engine/DynamicAnimation;->mTarget:Ljava/lang/Object;

    invoke-virtual {v0, p0}, Lcom/obric/oui/animation/engine/FloatPropertyCompat;->getValue(Ljava/lang/Object;)F
...
.method public doAnimationFrame(J)Z
    ...
    .line 640
    iget p1, p0, Lcom/obric/oui/animation/engine/DynamicAnimation;->mValue:F

    invoke-virtual {p0, p1}, Lcom/obric/oui/animation/engine/DynamicAnimation;->setPropertyValue(F)V
    ...
    .line 645
    invoke-virtual {p0, v0, v1}, Lcom/obric/oui/animation/engine/DynamicAnimation;->updateValueAndVelocity(J)Z

    move-result p1

    .line 647
    iget p2, p0, Lcom/obric/oui/animation/engine/DynamicAnimation;->mValue:F
    ...
    iput p2, p0, Lcom/obric/oui/animation/engine/DynamicAnimation;->mValue:F

    .line 648
    iget v0, p0, Lcom/obric/oui/animation/engine/DynamicAnimation;->mMinValue:F
    ...
    .line 650
    invoke-virtual {p0, p2}, Lcom/obric/oui/animation/engine/DynamicAnimation;->setPropertyValue(F)V

    if-eqz p1, :cond_1

    .line 653
    invoke-direct {p0, v3}, Lcom/obric/oui/animation/engine/DynamicAnimation;->endAnimationInternal(Z)V
...
.method public getMinimumVisibleChange()F
    ...
    .line 534
    iget p0, p0, Lcom/obric/oui/animation/engine/DynamicAnimation;->mMinVisibleChange:F
...
.method public isRunning()Z
    ...
    .line 604
    iget-boolean p0, p0, Lcom/obric/oui/animation/engine/DynamicAnimation;->mRunning:Z
...
.method public removeEndListener(Lcom/obric/oui/animation/engine/DynamicAnimation$OnAnimationEndListener;)V
    ...
    invoke-static {p0, p1}, Lcom/obric/oui/animation/engine/DynamicAnimation;->removeEntry(Ljava/util/ArrayList;Ljava/lang/Object;)V
...
.method public removeUpdateListener(Lcom/obric/oui/animation/engine/DynamicAnimation$OnAnimationUpdateListener;)V
    ...
    .line 488
    iget-object p0, p0, Lcom/obric/oui/animation/engine/DynamicAnimation;->mUpdateListeners:Ljava/util/ArrayList;
...
.method public setMinimumVisibleChange(F)Lcom/obric/oui/animation/engine/DynamicAnimation;
    ...
    .line 523
    invoke-virtual {p0, p1}, Lcom/obric/oui/animation/engine/DynamicAnimation;->setValueThreshold(F)V
...
.method setPropertyValue(F)V
    ...
    iget v1, p0, Lcom/obric/oui/animation/engine/DynamicAnimation;->mValue:F

    iget v2, p0, Lcom/obric/oui/animation/engine/DynamicAnimation;->mVelocity:F

    invoke-interface {v0, p0, v1, v2}, Lcom/obric/oui/animation/engine/DynamicAnimation$OnAnimationUpdateListener;->onAnimationUpdate(Lcom/obric/oui/animation/engine/DynamicAnimation;FF)V
...
.method public setStartValue(F)Lcom/obric/oui/animation/engine/DynamicAnimation;
    ...
    .line 376
    iput-boolean p1, p0, Lcom/obric/oui/animation/engine/DynamicAnimation;->mStartValueIsSet:Z
