...
.field public static enableGetNetworkTypeOptimize:Z = false

.field private static lastAdjustTime:J = 0x0L

.field private static nqc:Lcom/bytedance/networkstackapplib/TTNetworkStackAPI; = null

.field private static volatile sInterval:J = 0x0L

.field private static sIsReceiverRegisted:Z = false

.field private static sNetworkType:Lcom/bytedance/common/utility/NetworkUtils$NetworkType; = null

.field private static sNetworkTypeInterceptor:Lcom/bytedance/common/utility/NetworkUtils$NetworkTypeInterceptor; = null
...
.method public static getActiveNetworkType(Landroid/content/Context;)Ljava/lang/String;
    ...
    .line 150
    sget-object v0, Lcom/bytedance/common/utility/NetworkUtils;->nqc:Lcom/bytedance/networkstackapplib/TTNetworkStackAPI;

    if-nez v0, :cond_0

    .line 151
    new-instance v0, Lcom/bytedance/networkstackapplib/TTNetworkStackAPI;

    invoke-direct {v0, p0}, Lcom/bytedance/networkstackapplib/TTNetworkStackAPI;-><init>(Landroid/content/Context;)V

    sput-object v0, Lcom/bytedance/common/utility/NetworkUtils;->nqc:Lcom/bytedance/networkstackapplib/TTNetworkStackAPI;

    .line 153
    :cond_0
    sget-object p0, Lcom/bytedance/common/utility/NetworkUtils;->nqc:Lcom/bytedance/networkstackapplib/TTNetworkStackAPI;

    invoke-virtual {p0}, Lcom/bytedance/networkstackapplib/TTNetworkStackAPI;->getNetworkType()Ljava/lang/String;
...
.method private static getNetworkTypeIntern(Landroid/content/Context;)Lcom/bytedance/common/utility/NetworkUtils$NetworkType;
    ...
    .line 439
    sget-boolean v0, Lcom/bytedance/common/utility/NetworkUtils;->enableGetNetworkTypeOptimize:Z

    if-eqz v0, :cond_0

    .line 440
    invoke-static {p0}, Lcom/bytedance/common/utility/NetworkUtils;->getNetworkTypeInternNew(Landroid/content/Context;)Lcom/bytedance/common/utility/NetworkUtils$NetworkType;
...
.method private static getNetworkTypeInternNew(Landroid/content/Context;)Lcom/bytedance/common/utility/NetworkUtils$NetworkType;
    .locals 6

    .line 366
    :try_start_0
    invoke-static {p0}, Lcom/bytedance/common/utility/NetworkUtils;->getActiveNetworkType(Landroid/content/Context;)Ljava/lang/String;

    move-result-object v0

    .line 367
    invoke-static {v0}, Lcom/bytedance/common/utility/NetworkUtils;->isNetworkStackAvailable(Ljava/lang/String;)Z
    ...
    .line 397
    :cond_5
    invoke-static {p0}, Lcom/bytedance/common/utility/NetworkUtils;->getSimNetworkType(Landroid/content/Context;)I
    ...
    .line 428
    sget-object p0, Lcom/bytedance/common/utility/NetworkUtils$NetworkType;->UNKNOWN:Lcom/bytedance/common/utility/NetworkUtils$NetworkType;
    ...
    .line 421
    :pswitch_1
    invoke-static {p0}, Lcom/bytedance/common/utility/NetworkUtils;->is5G(Landroid/content/Context;)Z
    ...
    .line 406
    :pswitch_3
    sget-object p0, Lcom/bytedance/common/utility/NetworkUtils$NetworkType;->MOBILE_2G:Lcom/bytedance/common/utility/NetworkUtils$NetworkType;
...
.method public static getSimNetworkType(Landroid/content/Context;)I
    .locals 1
    ...
    invoke-virtual {p0}, Lcom/bytedance/networkstackapplib/TTNetworkStackAPI;->getSimNetworkType()I
...
.method public static is5G(Landroid/content/Context;)Z
    ...
    invoke-virtual {p0}, Lcom/bytedance/networkstackapplib/TTNetworkStackAPI;->is5G()Z
...
.method private static isNetworkStackAvailable(Ljava/lang/String;)Z
    .locals 1
...
.method private static registerReceiver(Landroid/content/Context;)V
    ...
    new-instance v1, Lcom/bytedance/common/utility/NetworkConnectChangeReceiver;

    invoke-direct {v1}, Lcom/bytedance/common/utility/NetworkConnectChangeReceiver;-><init>()V
