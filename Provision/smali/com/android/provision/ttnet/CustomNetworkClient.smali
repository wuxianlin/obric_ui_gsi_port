.class Lcom/android/provision/ttnet/CustomNetworkClient;
.super Lcom/bytedance/common/utility/NetworkClient;
.source "CustomNetworkClient.java"
...
.method public get(Ljava/lang/String;Ljava/util/Map;Lcom/bytedance/common/utility/NetworkClient$ReqContext;)Ljava/lang/String;
    ...
    .line 80
    invoke-static {p1}, Lcom/android/provision/ttnet/CustomNetworkClient;->parseUrl(Ljava/lang/String;)Landroid/util/Pair;
    ...
    .line 84
    invoke-static {p2}, Lcom/android/provision/ttnet/CustomNetworkClient;->convertHeaders(Ljava/util/Map;)Ljava/util/List;
...
.method public post(Ljava/lang/String;Ljava/util/List;Ljava/util/Map;Lcom/bytedance/common/utility/NetworkClient$ReqContext;)Ljava/lang/String;
    ...
    .line 95
    invoke-static {p3}, Lcom/android/provision/ttnet/CustomNetworkClient;->convertHeaders(Ljava/util/Map;)Ljava/util/List;
...
.method public post(Ljava/lang/String;[BLjava/util/Map;Lcom/bytedance/common/utility/NetworkClient$ReqContext;)Ljava/lang/String;
    ...
    .line 140
    new-instance p0, Lcom/android/provision/ttnet/CustomHttpException;
    ...
    invoke-direct {p0, p3, p2, p1}, Lcom/android/provision/ttnet/CustomHttpException;-><init>(IILjava/lang/String;)V

    throw p0

    .line 142
    :cond_2
    new-instance p2, Lcom/android/provision/ttnet/CustomHttpException;

    invoke-virtual {p1}, Ljava/lang/Exception;->getMessage()Ljava/lang/String;

    move-result-object p1

    invoke-direct {p2, p0, p0, p1}, Lcom/android/provision/ttnet/CustomHttpException;-><init>(IILjava/lang/String;)V
    ...
    invoke-direct {p2, p3, p0, p1}, Lcom/android/provision/ttnet/CustomHttpException;-><init>(IILjava/lang/String;)V
