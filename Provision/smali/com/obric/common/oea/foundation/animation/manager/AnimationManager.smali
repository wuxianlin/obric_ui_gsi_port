...
.method private final internalRunAnimation(FLandroid/view/View;Lcom/obric/common/oea/foundation/animation/constants/RunMode;FLcom/obric/common/oea/foundation/animation/constants/RepeatMode;Ljava/util/List;Lkotlin/jvm/functions/Function3;Lkotlin/jvm/functions/Function2;)V
    ...
    .line 67
    iget-object p1, p0, Lcom/obric/common/oea/foundation/animation/manager/AnimationManager;->stateManager:Lcom/obric/common/oea/foundation/animation/manager/AnimatableStateManager;

    invoke-virtual {p1, p3}, Lcom/obric/common/oea/foundation/animation/manager/AnimatableStateManager;->setRunMode(Lcom/obric/common/oea/foundation/animation/constants/RunMode;)V

    .line 68
    iget-object p1, p0, Lcom/obric/common/oea/foundation/animation/manager/AnimationManager;->stateManager:Lcom/obric/common/oea/foundation/animation/manager/AnimatableStateManager;

    invoke-virtual {p1, p5}, Lcom/obric/common/oea/foundation/animation/manager/AnimatableStateManager;->setRepeatMode(Lcom/obric/common/oea/foundation/animation/constants/RepeatMode;)V

    .line 69
    iget-object p1, p0, Lcom/obric/common/oea/foundation/animation/manager/AnimationManager;->stateManager:Lcom/obric/common/oea/foundation/animation/manager/AnimatableStateManager;

    invoke-virtual {p1, p6}, Lcom/obric/common/oea/foundation/animation/manager/AnimatableStateManager;->setAnimationInfos(Ljava/util/List;)V

    .line 70
    iget-object p1, p0, Lcom/obric/common/oea/foundation/animation/manager/AnimationManager;->stateManager:Lcom/obric/common/oea/foundation/animation/manager/AnimatableStateManager;

    invoke-virtual {p1, p2}, Lcom/obric/common/oea/foundation/animation/manager/AnimatableStateManager;->setView(Landroid/view/View;)V

    .line 71
    iget-object p1, p0, Lcom/obric/common/oea/foundation/animation/manager/AnimationManager;->stateManager:Lcom/obric/common/oea/foundation/animation/manager/AnimatableStateManager;

    invoke-virtual {p1, p4}, Lcom/obric/common/oea/foundation/animation/manager/AnimatableStateManager;->setSpeed(F)V

    .line 73
    new-instance p1, Lcom/obric/common/oea/foundation/animation/manager/AnimatableRunner;

    iget-object p2, p0, Lcom/obric/common/oea/foundation/animation/manager/AnimationManager;->stateManager:Lcom/obric/common/oea/foundation/animation/manager/AnimatableStateManager;

    invoke-direct {p1, p2, p7, p8}, Lcom/obric/common/oea/foundation/animation/manager/AnimatableRunner;-><init>(Lcom/obric/common/oea/foundation/animation/manager/AnimatableStateManager;Lkotlin/jvm/functions/Function3;Lkotlin/jvm/functions/Function2;)V

    iput-object p1, p0, Lcom/obric/common/oea/foundation/animation/manager/AnimationManager;->runner:Lcom/obric/common/oea/foundation/animation/manager/AnimatableRunner;

    .line 74
    invoke-virtual {p1}, Lcom/obric/common/oea/foundation/animation/manager/AnimatableRunner;->startAnimation()V
...
.method public final cancelAnimation(Z)V
    ...
    .line 87
    iget-object p0, p0, Lcom/obric/common/oea/foundation/animation/manager/AnimationManager;->runner:Lcom/obric/common/oea/foundation/animation/manager/AnimatableRunner;
...
.method public final pause()V
    ...
    .line 78
    iget-object p0, p0, Lcom/obric/common/oea/foundation/animation/manager/AnimationManager;->stateManager:Lcom/obric/common/oea/foundation/animation/manager/AnimatableStateManager;

    invoke-virtual {p0}, Lcom/obric/common/oea/foundation/animation/manager/AnimatableStateManager;->pause()V
...
.method public final resume()V
    ...
    invoke-virtual {p0}, Lcom/obric/common/oea/foundation/animation/manager/AnimatableRunner;->startAnimation()V
...
.method public final runAnimation(FLandroid/view/View;Lcom/obric/common/oea/foundation/animation/constants/RunMode;FLcom/obric/common/oea/foundation/animation/constants/RepeatMode;Ljava/util/List;Lkotlin/jvm/functions/Function3;Lkotlin/jvm/functions/Function2;)V
    ...
    .line 30
    new-instance v11, Lcom/obric/common/oea/foundation/animation/manager/AnimationManager$runAnimation$1;
