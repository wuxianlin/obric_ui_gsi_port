...
.method public constructor <init>(Lcom/obric/common/oea/foundation/animation/engine/FloatValueHolder;)V
    ...
    .line 61
    iput-boolean p1, p0, Lcom/obric/common/oea/foundation/animation/engine/SpringAnimation;->mEndRequested:Z
...
.method public constructor <init>(Ljava/lang/Object;Lcom/obric/common/oea/foundation/animation/engine/FloatPropertyCompat;F)V
    ...
    .line 105
    new-instance p1, Lcom/obric/common/oea/foundation/animation/engine/SpringForce;

    invoke-direct {p1, p3}, Lcom/obric/common/oea/foundation/animation/engine/SpringForce;-><init>(F)V
...
.method private sanityCheck()V
    ...
    .line 203
    iget p0, p0, Lcom/obric/common/oea/foundation/animation/engine/SpringAnimation;->mMinValue:F
...
.method public canSkipToEnd()Z
    ...
    .line 189
    iget-object p0, p0, Lcom/obric/common/oea/foundation/animation/engine/SpringAnimation;->mSpring:Lcom/obric/common/oea/foundation/animation/engine/SpringForce;
...
.method getAcceleration(FF)F
    ...
    invoke-virtual {p0, p1, p2}, Lcom/obric/common/oea/foundation/animation/engine/SpringForce;->getAcceleration(FF)F
...
.method isAtEquilibrium(FF)Z
    ...
    invoke-virtual {p0, p1, p2}, Lcom/obric/common/oea/foundation/animation/engine/SpringForce;->isAtEquilibrium(FF)Z
...
.method updateValueAndVelocity(J)Z
    ...
    .line 215
    iget-object v6, v0, Lcom/obric/common/oea/foundation/animation/engine/SpringAnimation;->mSpring:Lcom/obric/common/oea/foundation/animation/engine/SpringForce;

    invoke-virtual {v6, v1}, Lcom/obric/common/oea/foundation/animation/engine/SpringForce;->setFinalPosition(F)Lcom/obric/common/oea/foundation/animation/engine/SpringForce;

    .line 216
    iput v5, v0, Lcom/obric/common/oea/foundation/animation/engine/SpringAnimation;->mPendingPosition:F
    ...
    .line 219
    iput v4, v0, Lcom/obric/common/oea/foundation/animation/engine/SpringAnimation;->mVelocity:F

    .line 220
    iput-boolean v3, v0, Lcom/obric/common/oea/foundation/animation/engine/SpringAnimation;->mEndRequested:Z
    ...
    invoke-virtual/range {v6 .. v12}, Lcom/obric/common/oea/foundation/animation/engine/SpringForce;->updateValues(DDJ)Lcom/obric/common/oea/foundation/animation/engine/DynamicAnimation$MassState;
    ...
    iget v7, v0, Lcom/obric/common/oea/foundation/animation/engine/SpringAnimation;->mPendingPosition:F

    invoke-virtual {v6, v7}, Lcom/obric/common/oea/foundation/animation/engine/SpringForce;->setFinalPosition(F)Lcom/obric/common/oea/foundation/animation/engine/SpringForce;

    .line 230
    iput v5, v0, Lcom/obric/common/oea/foundation/animation/engine/SpringAnimation;->mPendingPosition:F

    .line 232
    iget-object v13, v0, Lcom/obric/common/oea/foundation/animation/engine/SpringAnimation;->mSpring:Lcom/obric/common/oea/foundation/animation/engine/SpringForce;

    iget v5, v1, Lcom/obric/common/oea/foundation/animation/engine/DynamicAnimation$MassState;->mValue:F

    float-to-double v14, v5

    iget v1, v1, Lcom/obric/common/oea/foundation/animation/engine/DynamicAnimation$MassState;->mVelocity:F

    float-to-double v5, v1

    move-wide/from16 v16, v5

    invoke-virtual/range {v13 .. v19}, Lcom/obric/common/oea/foundation/animation/engine/SpringForce;->updateValues(DDJ)Lcom/obric/common/oea/foundation/animation/engine/DynamicAnimation$MassState;
    ...
    iput v5, v0, Lcom/obric/common/oea/foundation/animation/engine/SpringAnimation;->mValue:F

    .line 234
    iget v1, v1, Lcom/obric/common/oea/foundation/animation/engine/DynamicAnimation$MassState;->mVelocity:F

    iput v1, v0, Lcom/obric/common/oea/foundation/animation/engine/SpringAnimation;->mVelocity:F
    ...
    iget v5, v0, Lcom/obric/common/oea/foundation/animation/engine/SpringAnimation;->mMinValue:F
    ...
    iget v5, v0, Lcom/obric/common/oea/foundation/animation/engine/SpringAnimation;->mMaxValue:F
    ...
    iget v5, v0, Lcom/obric/common/oea/foundation/animation/engine/SpringAnimation;->mVelocity:F

    invoke-virtual {v0, v1, v5}, Lcom/obric/common/oea/foundation/animation/engine/SpringAnimation;->isAtEquilibrium(FF)Z
