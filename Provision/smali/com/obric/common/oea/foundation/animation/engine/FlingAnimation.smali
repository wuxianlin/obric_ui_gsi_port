...
.method public constructor <init>(Lcom/obric/common/oea/foundation/animation/engine/FloatValueHolder;)V
    ...
    .line 40
    new-instance p1, Lcom/obric/common/oea/foundation/animation/engine/FlingAnimation$DragForce;

    invoke-direct {p1}, Lcom/obric/common/oea/foundation/animation/engine/FlingAnimation$DragForce;-><init>()V

    iput-object p1, p0, Lcom/obric/common/oea/foundation/animation/engine/FlingAnimation;->mFlingForce:Lcom/obric/common/oea/foundation/animation/engine/FlingAnimation$DragForce;
    ...
    invoke-virtual {p1, p0}, Lcom/obric/common/oea/foundation/animation/engine/FlingAnimation$DragForce;->setValueThreshold(F)V
...
.method getAcceleration(FF)F
    ...
    .line 175
    iget-object p0, p0, Lcom/obric/common/oea/foundation/animation/engine/FlingAnimation;->mFlingForce:Lcom/obric/common/oea/foundation/animation/engine/FlingAnimation$DragForce;

    invoke-virtual {p0, p1, p2}, Lcom/obric/common/oea/foundation/animation/engine/FlingAnimation$DragForce;->getAcceleration(FF)F
...
.method public getFriction()F
    ...
    invoke-virtual {p0}, Lcom/obric/common/oea/foundation/animation/engine/FlingAnimation$DragForce;->getFrictionScalar()F
...
.method setValueThreshold(F)V
    ...
    invoke-virtual {p0, p1}, Lcom/obric/common/oea/foundation/animation/engine/FlingAnimation$DragForce;->setValueThreshold(F)V
...
.method updateValueAndVelocity(J)Z
    ...
    .line 154
    iget p2, p1, Lcom/obric/common/oea/foundation/animation/engine/DynamicAnimation$MassState;->mValue:F

    iput p2, p0, Lcom/obric/common/oea/foundation/animation/engine/FlingAnimation;->mValue:F

    .line 155
    iget p1, p1, Lcom/obric/common/oea/foundation/animation/engine/DynamicAnimation$MassState;->mVelocity:F

    iput p1, p0, Lcom/obric/common/oea/foundation/animation/engine/FlingAnimation;->mVelocity:F

    .line 158
    iget p1, p0, Lcom/obric/common/oea/foundation/animation/engine/FlingAnimation;->mValue:F

    iget p2, p0, Lcom/obric/common/oea/foundation/animation/engine/FlingAnimation;->mMinValue:F
    ...
    .line 159
    iget p1, p0, Lcom/obric/common/oea/foundation/animation/engine/FlingAnimation;->mMinValue:F

    iput p1, p0, Lcom/obric/common/oea/foundation/animation/engine/FlingAnimation;->mValue:F
    ...
    .line 163
    iget p1, p0, Lcom/obric/common/oea/foundation/animation/engine/FlingAnimation;->mMaxValue:F
    ...
    iget v0, p0, Lcom/obric/common/oea/foundation/animation/engine/FlingAnimation;->mVelocity:F

    invoke-virtual {p0, p1, v0}, Lcom/obric/common/oea/foundation/animation/engine/FlingAnimation;->isAtEquilibrium(FF)Z
